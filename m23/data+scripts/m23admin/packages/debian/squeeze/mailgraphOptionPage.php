...
";
$elem["mailgraph/ignore_localhost"]["descriptionde"]="Sollen eingehende Nachrichten als ausgehende gezählt werden?
 Wenn Sie eingehende Nachrichten als ausgehende zählen (was der Standard ist), werden die Nachrichten mehrmals gezählt, falls Sie einen Inhaltsfilter wie etwa »amavis« einsetzen, was zu falschen Werten führt. Falls Sie irgendeinen Inhaltsfilter einsetzen, sollten Sie diese Option abwählen.
";
