...
$elem["boxbackup-server/generateCertificate"]["descriptionde"]="Soll ein privater Server-Schlüssel und eine X.509-Zertifikatanfrage erzeugt werden?
 ...
 .
 Beides kann automatisch erzeugt werden. Sie müssen das Zertifikat mit Ihrem Wurzel-CA-Zertifikat signieren (siehe das Paket »boxbackup-utils«) und das signierte Zertifikat sowie das Wurzel-CA-Zertifikat in Ihrem Konfigurationsordner ablegen.
";
$elem["boxbackup-server/generateCertificate"]["descriptionfr"]="Faut-il créer une clef privée et une demande de certificat X.509 pour le serveur ?
 ...
 .
 Ces deux éléments peuvent être créés automatiquement. Vous aurez besoin de faire signer le certificat par votre autorité de certification principale (voir le paquet boxbackup-utils) et de placer le certificat signé accompagné du certificat du CA racine dans le répertoire de configuration.
";
