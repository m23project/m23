...
$params = PKG_OptionPageHeader2("exim4");

$elem["exim4/drec"]["type"]="error";
$elem["exim4/drec"]["description"]="Reconfigure exim4-config instead of this package
...
";
$elem["exim4/drec"]["descriptionde"]="Exim4-config anstelle dieses Pakets neu einrichten
...
";
$elem["exim4/drec"]["descriptionfr"]="Reconfiguration d'Exim avec exim4-config
