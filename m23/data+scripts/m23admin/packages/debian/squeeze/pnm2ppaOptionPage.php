...
$params = PKG_OptionPageHeader2("pnm2ppa");
...
$elem["pnm2ppa/printer_model"]["descriptionde"]="Welches Modell eines HP-Deskjet-Druckers benutzen Sie?
 Der verwendete Drucker-Filter in pnm2ppa hängt vom Typ des HP-Deskjets ab, den Sie einsetzen. Wählen Sie Ihr Druckermodell für die systemweite Konfigurationsdatei /etc/pnm2ppa.conf aus.
";
...
";
$elem["pnm2ppa/create_magicfilter"]["descriptionde"]="Soll debconf \"magicfilter\" erstellen?
 ...
 .
 Die Vorlage für den Filter befindet sich im Verzeichnis /usr/share/pnm2ppa/ als \"pnm2ppa-magicfilter.in\". Das Skript update-magicfilter nutzt 'sed', um @OPTIONS@ in der Vorlage zu ersetzen und legt den erstellten Filter im Verzeichnis /etc/magicfilter ab. Zusätzlich werden symbolische Links von den erstellten pnm2ppa-Filtern zu den pbm2ppa-Filtern (dem veralteten Vorgänger von pnm2ppa) angelegt.
 .
