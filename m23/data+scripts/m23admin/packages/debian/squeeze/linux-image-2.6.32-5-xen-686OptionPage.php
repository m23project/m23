...
$params = PKG_OptionPageHeader2("linux-image-2.6.32-5-xen-686");

$elem["linux-image-2.6.32-5-xen-686/postinst/depmod-error-initrd-2.6.32-5-xen-686"]["type"]="boolean";
$elem["linux-image-2.6.32-5-xen-686/postinst/depmod-error-initrd-2.6.32-5-xen-686"]["description"]="Abort installation after depmod error?
 The 'depmod' command exited with the exit code ${exit_value}
 (${SIGNAL}${CORE}).
 .
 Since this image uses initrd, the ${modules_base}/2.6.32-5-xen-686/modules.dep file
...
";
$elem["linux-image-2.6.32-5-xen-686/postinst/depmod-error-initrd-2.6.32-5-xen-686"]["descriptionde"]="Installation nach depmod-Fehler abbrechen?
 Der »depmod«-Befehl wurde beendet: Rückgabewert ${exit_value} (${SIGNAL}${CORE}).
 .
 Da dieses Image eine initrd verwendet, wird die Datei ${modules_base}/2.6.32-5-xen-686/modules.dep nicht gelöscht, obwohl sie ungültig sein könnte.
 .
...
";
$elem["linux-image-2.6.32-5-xen-686/postinst/depmod-error-initrd-2.6.32-5-xen-686"]["descriptionfr"]="Abandonner l'installation après l'erreur de depmod ?
 La commande depmod s'est terminée avec le code de sortie ${exit_value} (${SIGNAL} ${CORE}).
 .
 Puisque cette image du noyau utilise initrd, le fichier ${modules_base}/2.6.32-5-xen-686/modules.dep ne sera pas effacé, mais il peut ne pas être valable.
 .
...
";
$elem["linux-image-2.6.32-5-xen-686/postinst/depmod-error-initrd-2.6.32-5-xen-686"]["default"]="false";
$elem["linux-image-2.6.32-5-xen-686/prerm/removing-running-kernel-2.6.32-5-xen-686"]["type"]="boolean";
$elem["linux-image-2.6.32-5-xen-686/prerm/removing-running-kernel-2.6.32-5-xen-686"]["description"]="Abort kernel removal?
...
";
$elem["linux-image-2.6.32-5-xen-686/prerm/removing-running-kernel-2.6.32-5-xen-686"]["descriptionde"]="Entfernen des Kernels abbrechen?
...
";
$elem["linux-image-2.6.32-5-xen-686/prerm/removing-running-kernel-2.6.32-5-xen-686"]["descriptionfr"]="Abandonner la suppression du noyau ?
...
";
$elem["linux-image-2.6.32-5-xen-686/prerm/removing-running-kernel-2.6.32-5-xen-686"]["default"]="true";
$elem["linux-image-2.6.32-5-xen-686/postinst/missing-firmware-2.6.32-5-xen-686"]["type"]="note";
$elem["linux-image-2.6.32-5-xen-686/postinst/missing-firmware-2.6.32-5-xen-686"]["description"]="Required firmware files may be missing
 ...
 firmware files.
";
$elem["linux-image-2.6.32-5-xen-686/postinst/missing-firmware-2.6.32-5-xen-686"]["descriptionde"]="Benötigte Firmware-Dateien möglicherweise nicht vorhanden
...
";
$elem["linux-image-2.6.32-5-xen-686/postinst/missing-firmware-2.6.32-5-xen-686"]["descriptionfr"]="Microprogrammes (« firmwares ») probablement manquants
...
";
$elem["linux-image-2.6.32-5-xen-686/postinst/missing-firmware-2.6.32-5-xen-686"]["default"]="";
$elem["linux-image-2.6.32-5-xen-686/postinst/ignoring-do-bootloader-2.6.32-5-xen-686"]["type"]="error";
$elem["linux-image-2.6.32-5-xen-686/postinst/ignoring-do-bootloader-2.6.32-5-xen-686"]["description"]="Boot loader configuration must be updated
...
";
$elem["linux-image-2.6.32-5-xen-686/postinst/ignoring-do-bootloader-2.6.32-5-xen-686"]["descriptionde"]="Aktualisierung der Bootloader-Konfiguration erforderlich
...
";
$elem["linux-image-2.6.32-5-xen-686/postinst/ignoring-do-bootloader-2.6.32-5-xen-686"]["descriptionfr"]="Mise à jour indispensable de la configuration du programme d'amorçage
...
";
$elem["linux-image-2.6.32-5-xen-686/postinst/ignoring-do-bootloader-2.6.32-5-xen-686"]["default"]="";
