...
$elem["passwd/user-default-groups"]["default"]="audio cdrom dip floppy video plugdev netdev powerdev scanner bluetooth";
...
$elem["passwd/root-password"]["descriptionde"]="Root-Passwort:
 ...
 .
 Das Passwort für den Superuser root sollte nicht leer sein. Wenn Sie es leer lassen, wird der root-Zugang deaktiviert und der als erstes einrichtete Benutzer in diesem System erhält die nötigen Rechte, mittels »sudo«-Befehl zu root zu wechseln.
 .
...
$elem["passwd/username-bad"]["descriptionde"]="Ungültiger Benutzername
 Der Benutzername, den Sie eingegeben haben, ist ungültig. Hinweis: Der Benutzername sollte mit einem kleinen Buchstaben beginnen, gefolgt von einer Kombination aus Zahlen oder weiteren klein geschriebenen Buchstaben.
";
