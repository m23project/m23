...
$elem["virtuoso-opensource-6.1/check-remove-databases"]["descriptionde"]="Entfernen aller Virtuoso-Datenbanken?
 Das Verzeichnis /var/lib/virtuoso für die Speicherung der Virtuoso-Datenbanken steht davor, gelöscht zu werden.
 .
...
$elem["virtuoso-opensource-6.1/check-remove-databases"]["descriptionfr"]="Supprimer toutes les bases de données de Virtuoso ?
 Le répertoire /var/lib/virtuoso contenant les bases de données de Virtuoso va être supprimé.
 .
...
$elem["virtuoso-opensource-6.1/http-server-port"]["descriptionde"]="Port des HTTP-Servers:
 ...
 .
 Bitte beachten Sie, dass das Standard-Wurzelverzeichnis /var/lib/virtuoso/vsp für Web-Server leer sein wird, wenn Sie nicht auch das Paket mit der Standard-Startseite von Virtuoso installieren.
";
$elem["virtuoso-opensource-6.1/http-server-port"]["descriptionfr"]="Port du serveur HTTP :
 ...
 .
 Veuillez noter que le répertoire racine du serveur web est /var/lib/virtuoso/vsp et qu'il sera vide, à moins d'installer également le paquet contenant la page de démarrage par défaut de Virtuoso.
";
