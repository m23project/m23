...
$params = PKG_OptionPageHeader2("linux-image-3.2.0-4-amd64");

$elem["linux-image-3.2.0-4-amd64/postinst/depmod-error-initrd-3.2.0-4-amd64"]["type"]="boolean";
$elem["linux-image-3.2.0-4-amd64/postinst/depmod-error-initrd-3.2.0-4-amd64"]["description"]="Abort installation after depmod error?
 The 'depmod' command exited with the exit code ${exit_value}
 (${SIGNAL}${CORE}).
 .
 Since this image uses initrd, the ${modules_base}/3.2.0-4-amd64/modules.dep file
...
";
$elem["linux-image-3.2.0-4-amd64/postinst/depmod-error-initrd-3.2.0-4-amd64"]["descriptionde"]="Installation nach depmod-Fehler abbrechen?
...
";
$elem["linux-image-3.2.0-4-amd64/postinst/depmod-error-initrd-3.2.0-4-amd64"]["descriptionfr"]="Abandonner l'installation après l'erreur de depmod ?
...
";
$elem["linux-image-3.2.0-4-amd64/postinst/depmod-error-initrd-3.2.0-4-amd64"]["default"]="false";
$elem["linux-image-3.2.0-4-amd64/prerm/removing-running-kernel-3.2.0-4-amd64"]["type"]="boolean";
$elem["linux-image-3.2.0-4-amd64/prerm/removing-running-kernel-3.2.0-4-amd64"]["description"]="Abort kernel removal?
...
";
$elem["linux-image-3.2.0-4-amd64/prerm/removing-running-kernel-3.2.0-4-amd64"]["descriptionde"]="Entfernen des Kernels abbrechen?
...
";
$elem["linux-image-3.2.0-4-amd64/prerm/removing-running-kernel-3.2.0-4-amd64"]["descriptionfr"]="Abandonner la suppression du noyau ?
...
";
$elem["linux-image-3.2.0-4-amd64/prerm/removing-running-kernel-3.2.0-4-amd64"]["default"]="true";
$elem["linux-image-3.2.0-4-amd64/postinst/missing-firmware-3.2.0-4-amd64"]["type"]="note";
$elem["linux-image-3.2.0-4-amd64/postinst/missing-firmware-3.2.0-4-amd64"]["description"]="Required firmware files may be missing
 ...
 firmware files.
";
$elem["linux-image-3.2.0-4-amd64/postinst/missing-firmware-3.2.0-4-amd64"]["descriptionde"]="Benötigte Firmware-Dateien möglicherweise nicht vorhanden
...
";
$elem["linux-image-3.2.0-4-amd64/postinst/missing-firmware-3.2.0-4-amd64"]["descriptionfr"]="Microprogrammes (« firmwares ») probablement manquants
...
";
$elem["linux-image-3.2.0-4-amd64/postinst/missing-firmware-3.2.0-4-amd64"]["default"]="";
$elem["linux-image-3.2.0-4-amd64/postinst/ignoring-ramdisk"]["type"]="error";
$elem["linux-image-3.2.0-4-amd64/postinst/ignoring-ramdisk"]["description"]="Ramdisk configuration must be updated
...
";
$elem["linux-image-3.2.0-4-amd64/postinst/ignoring-ramdisk"]["descriptionde"]="Aktualisierung der Ramdisk-Konfiguration erforderlich
...
";
$elem["linux-image-3.2.0-4-amd64/postinst/ignoring-ramdisk"]["descriptionfr"]="Mise à jour indispensable de la configuration du disque virtuel initial
...
";
$elem["linux-image-3.2.0-4-amd64/postinst/ignoring-ramdisk"]["default"]="";
