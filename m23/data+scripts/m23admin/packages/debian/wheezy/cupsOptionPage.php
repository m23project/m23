...
$elem["cupsys/backend"]["choices"][2]="ipp14";
$elem["cupsys/backend"]["choices"][3]="lpd";
$elem["cupsys/backend"]["choices"][4]="socket";
$elem["cupsys/backend"]["choices"][5]="usb";
$elem["cupsys/backend"]["choices"][6]="snmp";
$elem["cupsys/backend"]["choicesde"][1]="IPP";
$elem["cupsys/backend"]["choicesde"][2]="ipp14";
$elem["cupsys/backend"]["choicesde"][3]="lpd";
$elem["cupsys/backend"]["choicesde"][4]="Socket";
$elem["cupsys/backend"]["choicesde"][5]="USB";
$elem["cupsys/backend"]["choicesde"][6]="SNMP";
$elem["cupsys/backend"]["choicesfr"][1]="IPP";
$elem["cupsys/backend"]["choicesfr"][2]="IPP14";
$elem["cupsys/backend"]["choicesfr"][3]="lpd";
$elem["cupsys/backend"]["choicesfr"][4]="socket";
$elem["cupsys/backend"]["choicesfr"][5]="USB";
$elem["cupsys/backend"]["choicesfr"][6]="SNMP";
