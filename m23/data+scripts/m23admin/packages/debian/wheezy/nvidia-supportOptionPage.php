...
$elem["nvidia-support/removed-but-enabled-in-xorg-conf"]["descriptionde"]="Der Nvidia-Treiber ist immer noch in der xorg.conf aktiviert.
 ...
 ${config-files}
 .
 Beachten Sie, dass ein Umschalten zum freien Nouveau-Treiber erfordert, dass das Paket Nvidia-Kernel-common vollständig beseitigt wird (nicht nur entfernt).
";
$elem["nvidia-support/removed-but-enabled-in-xorg-conf"]["descriptionfr"]="Pilote nvidia encore activé dans xorg.conf
 ...
 ${config-files}
 .
 Veuillez noter que le paquet nvidia-kernel-common doit être purgé (pas seulement supprimé) pour que le pilote libre nouveau fonctionne correctement.
";
