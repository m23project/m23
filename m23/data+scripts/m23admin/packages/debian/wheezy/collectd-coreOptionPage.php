...
$elem["collectd/migration-3-4"]["descriptionde"]="Das Layout der RRD-Dateien hat sich geändert.
 Das Layout der von collectd erstellten RRD-Dateien hat sich seit Version 3.x grundlegend geändert. Um Ihre alten Daten beizubehalten, müssen Sie diese migrieren. Dies kann durch Verwendung von »/usr/lib/collectd-core/utils/migrate-3-4.px« erreicht werden.
 .
...
$elem["collectd/migration-4-5"]["descriptionde"]="Das Layout der RRD-Dateien hat sich in Version 5.0 geändert.
 Das Layout einiger von collectd erstellten RRD-Dateien hat sich seit Version 4.x grundlegend geändert. Um Ihre alten Daten beizubehalten, müssen Sie diese migrieren. Dies kann durch Verwendung von »/usr/lib/collectd-core/utils/migrate-4-5.px« erreicht werden.
 .
 Für diesen Schritt müssen sowohl das perl- als auch das rrdtool-Paket installiert sein. Da dies im Moment nicht der Fall ist, müssen Sie die Migration manuell durchführen.
 .
 Siehe »/usr/share/doc/collectd-core/NEWS.Debian« und das collectd Wiki unter <http://collectd.org/wiki/index.php/V4_to_v5_migration_guide> für Details.
";
$elem["collectd/migration-4-5"]["descriptionfr"]="Le format des fichiers RRD a changé dans la version 5.0
 Le format des fichiers RRD créés par collectd a changé depuis la version 4.x. Afin de conserver les données, il est nécessaire de les convertir. Cette opération peut être réalisée avec la commande « /usr/lib/collectd-core/utils/migrate-4-5.px ».
 .
 Cette étape a besoin des paquets perl et rrdtool qui ne sont pas actuellement installés. La conversion doit par conséquent être effectuée manuellement.
 .
 Voir /usr/share/doc/collectd-core/NEWS.Debian et le wiki de collectd (<http://collectd.org/wiki/index.php/V4_to_v5_migration_guide>) pour plus de détails.
";
