...
$elem["guacamole-tomcat/restart-server"]["descriptionde"]="Tomcat-Server neu starten?
 ...
 .
 Sie können Tomcat auch manuell neu starten, indem Sie »invoke-rc.d tomcat6 restart« ausführen.
";
$elem["guacamole-tomcat/restart-server"]["descriptionfr"]="Faut-il relancer le serveur Tomcat ?
 ...
 .
 Vous pouvez également relancer Tomcat vous-même en exécutant la commande « invoke-rc.d tomcat6 restart » avec les privilèges du superutilisateur.
";
