...
$params = PKG_OptionPageHeader2("linux-image-3.2.0-4-686-pae");

$elem["linux-image-3.2.0-4-686-pae/postinst/depmod-error-initrd-3.2.0-4-686-pae"]["type"]="boolean";
$elem["linux-image-3.2.0-4-686-pae/postinst/depmod-error-initrd-3.2.0-4-686-pae"]["description"]="Abort installation after depmod error?
 The 'depmod' command exited with the exit code ${exit_value}
 (${SIGNAL}${CORE}).
 .
 Since this image uses initrd, the ${modules_base}/3.2.0-4-686-pae/modules.dep file
...
";
$elem["linux-image-3.2.0-4-686-pae/postinst/depmod-error-initrd-3.2.0-4-686-pae"]["descriptionde"]="Installation nach depmod-Fehler abbrechen?
 Der »depmod«-Befehl wurde beendet: Rückgabewert ${exit_value} (${SIGNAL}${CORE}).
 .
 Da dieses Image eine initrd verwendet, wird die Datei ${modules_base}/3.2.0-4-686-pae/modules.dep nicht gelöscht, obwohl sie ungültig sein könnte.
 .
...
";
$elem["linux-image-3.2.0-4-686-pae/postinst/depmod-error-initrd-3.2.0-4-686-pae"]["descriptionfr"]="Abandonner l'installation après l'erreur de depmod ?
 La commande depmod s'est terminée avec le code de retour ${exit_value} (${SIGNAL} ${CORE}).
 .
 Puisque cette image du noyau utilise initrd, le fichier ${modules_base}/3.2.0-4-686-pae/modules.dep ne sera pas effacé, mais il peut ne pas être valable.
 .
...
";
$elem["linux-image-3.2.0-4-686-pae/postinst/depmod-error-initrd-3.2.0-4-686-pae"]["default"]="false";
$elem["linux-image-3.2.0-4-686-pae/prerm/removing-running-kernel-3.2.0-4-686-pae"]["type"]="boolean";
$elem["linux-image-3.2.0-4-686-pae/prerm/removing-running-kernel-3.2.0-4-686-pae"]["description"]="Abort kernel removal?
...
";
$elem["linux-image-3.2.0-4-686-pae/prerm/removing-running-kernel-3.2.0-4-686-pae"]["descriptionde"]="Entfernen des Kernels abbrechen?
...
";
$elem["linux-image-3.2.0-4-686-pae/prerm/removing-running-kernel-3.2.0-4-686-pae"]["descriptionfr"]="Abandonner la suppression du noyau ?
...
";
$elem["linux-image-3.2.0-4-686-pae/prerm/removing-running-kernel-3.2.0-4-686-pae"]["default"]="true";
$elem["linux-image-3.2.0-4-686-pae/postinst/missing-firmware-3.2.0-4-686-pae"]["type"]="note";
$elem["linux-image-3.2.0-4-686-pae/postinst/missing-firmware-3.2.0-4-686-pae"]["description"]="Required firmware files may be missing
 ...
 firmware files.
";
$elem["linux-image-3.2.0-4-686-pae/postinst/missing-firmware-3.2.0-4-686-pae"]["descriptionde"]="Benötigte Firmware-Dateien möglicherweise nicht vorhanden
...
";
$elem["linux-image-3.2.0-4-686-pae/postinst/missing-firmware-3.2.0-4-686-pae"]["descriptionfr"]="Microprogrammes (« firmwares ») probablement manquants
...
";
$elem["linux-image-3.2.0-4-686-pae/postinst/missing-firmware-3.2.0-4-686-pae"]["default"]="";
$elem["linux-image-3.2.0-4-686-pae/postinst/ignoring-ramdisk"]["type"]="error";
$elem["linux-image-3.2.0-4-686-pae/postinst/ignoring-ramdisk"]["description"]="Ramdisk configuration must be updated
...
";
$elem["linux-image-3.2.0-4-686-pae/postinst/ignoring-ramdisk"]["descriptionde"]="Aktualisierung der Ramdisk-Konfiguration erforderlich
...
";
$elem["linux-image-3.2.0-4-686-pae/postinst/ignoring-ramdisk"]["descriptionfr"]="Mise à jour indispensable de la configuration du disque virtuel initial
...
";
$elem["linux-image-3.2.0-4-686-pae/postinst/ignoring-ramdisk"]["default"]="";
