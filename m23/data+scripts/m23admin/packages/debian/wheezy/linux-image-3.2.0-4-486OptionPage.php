...
$params = PKG_OptionPageHeader2("linux-image-3.2.0-4-486");

$elem["linux-image-3.2.0-4-486/postinst/depmod-error-initrd-3.2.0-4-486"]["type"]="boolean";
$elem["linux-image-3.2.0-4-486/postinst/depmod-error-initrd-3.2.0-4-486"]["description"]="Abort installation after depmod error?
 The 'depmod' command exited with the exit code ${exit_value}
 (${SIGNAL}${CORE}).
 .
 Since this image uses initrd, the ${modules_base}/3.2.0-4-486/modules.dep file
...
";
$elem["linux-image-3.2.0-4-486/postinst/depmod-error-initrd-3.2.0-4-486"]["descriptionde"]="Installation nach depmod-Fehler abbrechen?
 Der »depmod«-Befehl wurde beendet: Rückgabewert ${exit_value} (${SIGNAL}${CORE}).
 .
 Da dieses Image eine initrd verwendet, wird die Datei ${modules_base}/3.2.0-4-486/modules.dep nicht gelöscht, obwohl sie ungültig sein könnte.
 .
...
";
$elem["linux-image-3.2.0-4-486/postinst/depmod-error-initrd-3.2.0-4-486"]["descriptionfr"]="Abandonner l'installation après l'erreur de depmod ?
 La commande depmod s'est terminée avec le code de retour ${exit_value} (${SIGNAL} ${CORE}).
 .
 Puisque cette image du noyau utilise initrd, le fichier ${modules_base}/3.2.0-4-486/modules.dep ne sera pas effacé, mais il peut ne pas être valable.
 .
...
";
$elem["linux-image-3.2.0-4-486/postinst/depmod-error-initrd-3.2.0-4-486"]["default"]="false";
$elem["linux-image-3.2.0-4-486/prerm/removing-running-kernel-3.2.0-4-486"]["type"]="boolean";
$elem["linux-image-3.2.0-4-486/prerm/removing-running-kernel-3.2.0-4-486"]["description"]="Abort kernel removal?
...
";
$elem["linux-image-3.2.0-4-486/prerm/removing-running-kernel-3.2.0-4-486"]["descriptionde"]="Entfernen des Kernels abbrechen?
...
";
$elem["linux-image-3.2.0-4-486/prerm/removing-running-kernel-3.2.0-4-486"]["descriptionfr"]="Abandonner la suppression du noyau ?
...
";
$elem["linux-image-3.2.0-4-486/prerm/removing-running-kernel-3.2.0-4-486"]["default"]="true";
$elem["linux-image-3.2.0-4-486/postinst/missing-firmware-3.2.0-4-486"]["type"]="note";
$elem["linux-image-3.2.0-4-486/postinst/missing-firmware-3.2.0-4-486"]["description"]="Required firmware files may be missing
 ...
 firmware files.
";
$elem["linux-image-3.2.0-4-486/postinst/missing-firmware-3.2.0-4-486"]["descriptionde"]="Benötigte Firmware-Dateien möglicherweise nicht vorhanden
...
";
$elem["linux-image-3.2.0-4-486/postinst/missing-firmware-3.2.0-4-486"]["descriptionfr"]="Microprogrammes (« firmwares ») probablement manquants
...
";
$elem["linux-image-3.2.0-4-486/postinst/missing-firmware-3.2.0-4-486"]["default"]="";
$elem["linux-image-3.2.0-4-486/postinst/ignoring-ramdisk"]["type"]="error";
$elem["linux-image-3.2.0-4-486/postinst/ignoring-ramdisk"]["description"]="Ramdisk configuration must be updated
...
";
$elem["linux-image-3.2.0-4-486/postinst/ignoring-ramdisk"]["descriptionde"]="Aktualisierung der Ramdisk-Konfiguration erforderlich
...
";
$elem["linux-image-3.2.0-4-486/postinst/ignoring-ramdisk"]["descriptionfr"]="Mise à jour indispensable de la configuration du disque virtuel initial
...
";
$elem["linux-image-3.2.0-4-486/postinst/ignoring-ramdisk"]["default"]="";
