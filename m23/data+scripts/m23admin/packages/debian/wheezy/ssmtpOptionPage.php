...
$elem["ssmtp/root"]["description"]="Username who gets mail for userids < 1000:
...
";
$elem["ssmtp/root"]["descriptionde"]="Benutzername, der E-Mails für Benutzer-IDs < 1000 erhält:
...
$elem["ssmtp/rewritedomain"]["description"]="Domain to masquerade as:
 ssmtp will use \"username@REWRITEDOMAIN\" as the default From: address
 for outgoing mail which contains only a local username.
";
$elem["ssmtp/rewritedomain"]["descriptionde"]="Als diese Domäne ausgeben:
...
$elem["ssmtp/mailname"]["description"]="Name to store in /etc/mailname:
 This is the portion of the address after the '@' sign to be shown on
 outgoing news and mail messages.
";
$elem["ssmtp/mailname"]["descriptionde"]="Diesen Namen in der Datei /etc/mailname speichern:
