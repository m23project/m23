...
$elem["cinder/keystone-auth-token"]["type"]="password";
$elem["cinder/keystone-auth-token"]["description"]="Keystone authentication token:
 To configure its endpoint in Keystone, cinder-api needs the Keystone
 authentication token.
";
$elem["cinder/keystone-auth-token"]["descriptionde"]="Keystone-Authentifizierungs-Token:
 Cinder-API benötigt das Keystone-Authentifizierungs-Token, um seinen Endpunkt in Keystone zu konfigurieren.
";
$elem["cinder/keystone-auth-token"]["descriptionfr"]="
 Pour configurer son point d'accès dans Keystone, l'api de Cinder a besoin du jeton d'authentification Keystone.
";
$elem["cinder/keystone-auth-token"]["default"]="";
