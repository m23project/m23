...
$params = PKG_OptionPageHeader2("linux-image-3.16.0-4-586");

$elem["linux-image-3.16.0-4-586/postinst/depmod-error-initrd-3.16.0-4-586"]["type"]="boolean";
$elem["linux-image-3.16.0-4-586/postinst/depmod-error-initrd-3.16.0-4-586"]["description"]="Abort installation after depmod error?
 The 'depmod' command exited with the exit code ${exit_value}
 (${SIGNAL}${CORE}).
 .
 Since this image uses initrd, the ${modules_base}/3.16.0-4-586/modules.dep file
...
";
$elem["linux-image-3.16.0-4-586/postinst/depmod-error-initrd-3.16.0-4-586"]["descriptionde"]="Installation nach depmod-Fehler abbrechen?
 Der »depmod«-Befehl wurde beendet: Rückgabewert ${exit_value} (${SIGNAL}${CORE}).
 .
 Da dieses Image eine Initrd verwendet, wird die Datei ${modules_base}/3.16.0-4-586/modules.dep nicht gelöscht, obwohl sie ungültig sein könnte.
 .
...
";
$elem["linux-image-3.16.0-4-586/postinst/depmod-error-initrd-3.16.0-4-586"]["descriptionfr"]="Abandonner l'installation après l'erreur de depmod ?
 La commande depmod s’est terminée avec le code de retour ${exit_value} (${SIGNAL} ${CORE}).
 .
 Puisque cette image du noyau utilise initrd, le fichier ${modules_base}/3.16.0-4-586/modules.dep ne sera pas effacé, mais il peut ne pas être valable.
 .
...
";
$elem["linux-image-3.16.0-4-586/postinst/depmod-error-initrd-3.16.0-4-586"]["default"]="false";
$elem["linux-image-3.16.0-4-586/prerm/removing-running-kernel-3.16.0-4-586"]["type"]="boolean";
$elem["linux-image-3.16.0-4-586/prerm/removing-running-kernel-3.16.0-4-586"]["description"]="Abort kernel removal?
...
";
$elem["linux-image-3.16.0-4-586/prerm/removing-running-kernel-3.16.0-4-586"]["descriptionde"]="Entfernen des Kernels abbrechen?
...
";
$elem["linux-image-3.16.0-4-586/prerm/removing-running-kernel-3.16.0-4-586"]["descriptionfr"]="Abandonner la suppression du noyau ?
...
";
$elem["linux-image-3.16.0-4-586/prerm/removing-running-kernel-3.16.0-4-586"]["default"]="true";
$elem["linux-image-3.16.0-4-586/postinst/mips-initrd-3.16.0-4-586"]["type"]="note";
$elem["linux-image-3.16.0-4-586/postinst/mips-initrd-3.16.0-4-586"]["description"]="Boot loader configuration must be updated to load initramfs
 This kernel package will build an \"initramfs\" file
 (/boot/initrd.img-3.16.0-4-586) for the system's boot loader
...
";
$elem["linux-image-3.16.0-4-586/postinst/mips-initrd-3.16.0-4-586"]["descriptionde"]="Bootloader-Konfiguration muss aktualisiert werden, um initramfs zu laden
 Dieses Kernel-Paket wird eine »initramfs«-Datei (/boot/initrd.img-3.16.0-4-586) erstellen, die vom Bootloader des Systems zusätzlich zum Kernel selbst verwendet wird. Diese Methode, früher auf MIPS nicht unterstützt, ermöglicht einen viel flexibleren Boot-Prozess und spätere Kernel-Versionen könnten eine passende initrd.img zum Booten voraussetzen.
 .
...
";
$elem["linux-image-3.16.0-4-586/postinst/mips-initrd-3.16.0-4-586"]["descriptionfr"]="La configuration du chargeur de démarrage doit être mise à jour pour charger le système de fichiers initial en mémoire
 Ce paquet de noyau construira un système de fichiers initial en mémoire (fichier « initramfs » : /boot/initrd.img-3.16.0-4-586) pour que le chargeur de démarrage du système puisse l’utiliser en plus du noyau lui-même. Cette méthode, jusqu’alors non prise en charge sous MIPS, active un processus de démarrage plus flexible et les prochaines versions de noyau pourraient nécessiter un initrd.img pour démarrer.
 .
...
";
$elem["linux-image-3.16.0-4-586/postinst/mips-initrd-3.16.0-4-586"]["default"]="";
