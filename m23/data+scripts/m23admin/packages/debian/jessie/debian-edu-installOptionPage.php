...
";
$elem["debian-edu-install/no-errors-found"]["descriptionde"]="Während der Installation wurden keine Fehler festgestellt
 Dies wird für die Entwicklungs-Version angezeigt, um klar zu machen, dass die Installation erfolgreich war.
";
$elem["debian-edu-install/no-errors-found"]["descriptionfr"]="Aucune erreur rencontrée pendant l'installation
 Ce message s'affiche dans la version de développement pour montrer que l'installation s'est bien terminée.
";
