...
$params = PKG_OptionPageHeader2("ganeti-htools-2.12");

$elem["ganeti-htools-2.12/abort-removal"]["type"]="boolean";
$elem["ganeti-htools-2.12/abort-removal"]["description"]="Abort ${package} removal?
 ...
 removing ${package}.
";
$elem["ganeti-htools-2.12/abort-removal"]["descriptionde"]="Entfernen von ${package} abbrechen?
...
";
$elem["ganeti-htools-2.12/abort-removal"]["descriptionfr"]="Faut-il abandonner la suppression de ${package} ?
...
";
$elem["ganeti-htools-2.12/abort-removal"]["default"]="true";
