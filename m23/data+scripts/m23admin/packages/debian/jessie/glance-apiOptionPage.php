...
";
$elem["glance/register-endpoint"]["descriptionde"]="Glance im Keystone-Endpunktkatalog registrieren?
...
";
$elem["glance/register-endpoint"]["descriptionfr"]="Enregistrer Glance dans le catalogue de points d'accès de Keystone ?
...
$elem["glance/keystone-auth-token"]["type"]="password";
$elem["glance/keystone-auth-token"]["description"]="Keystone authentication token:
 To configure its endpoint in Keystone, glance-api needs the Keystone
 authentication token.
";
$elem["glance/keystone-auth-token"]["descriptionde"]="Keystone-Authentifizierungs-Token:
 Glance-API benötigt das Keystone-Authentifizierungs-Token, um seinen Endpunkt in Keystone zu konfigurieren.
";
$elem["glance/keystone-auth-token"]["descriptionfr"]="
 Pour configurer son point d'accès dans Keystone, l'API de Glance a besoin du jeton d'authentification Keystone.
";
$elem["glance/keystone-auth-token"]["default"]="";
