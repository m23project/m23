...
$elem["fglrx-driver/install-even-if-unsupported-gpu-exists"]["description"]="Install ${vendor} driver despite unsupported graphics card?
...
";
$elem["fglrx-driver/install-even-if-unsupported-gpu-exists"]["descriptionde"]="${vendor}-Treiber installieren trotz nicht unterstützter Grafikkarte?
...
";
$elem["fglrx-driver/install-even-if-unsupported-gpu-exists"]["descriptionfr"]="Faut-il installer le pilote ${vendor} avec une carte graphique non gérée ?
