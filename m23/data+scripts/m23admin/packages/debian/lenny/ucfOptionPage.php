...
$elem["ucf/changeprompt_threeway"]["choicesde"][5]="3-Wege-Differenz der verfügbaren Versionen der Datei anzeigen";
...
$elem["ucf/changeprompt_threeway"]["choicesfr"][6]="Fusionner les trois versions disponibles du fichier (expérimental)";
$elem["ucf/changeprompt_threeway"]["description"]="What would you like to do about ${BASENAME}?
 A new version of configuration file ${FILE} is available, but the version installed
 currently has been locally modified.
";
$elem["ucf/changeprompt_threeway"]["descriptionde"]="Wie wollen Sie mit ${BASENAME} verfahren?
 Eine neue Version der Konfigurationsdatei ${FILE} ist verfügbar, aber die installierte Version wurde verändert.
";
$elem["ucf/changeprompt_threeway"]["descriptionfr"]="Action souhaitée pour ${BASENAME} :
...
$elem["ucf/changeprompt"]["description"]="What would you like to do about ${BASENAME}?
 A new version of configuration file ${FILE} is available, but the version installed
 currently has been locally modified.
";
$elem["ucf/changeprompt"]["descriptionde"]="Wie wollen Sie mit ${BASENAME} verfahren?
 Eine neue Version der Konfigurationsdatei ${FILE} ist verfügbar, aber die installierte Version wurde verändert.
";
$elem["ucf/changeprompt"]["descriptionfr"]="Action souhaitée pour ${BASENAME} :
 Une nouvelle version du fichier de configuration ${FILE} est disponible mais la version actuellement utilisée a été modifiée localement.
";
