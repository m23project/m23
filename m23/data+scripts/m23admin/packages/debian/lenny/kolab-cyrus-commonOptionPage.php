...
$params = PKG_OptionPageHeader2("kolab-cyrus-common");

$elem["kolab-cyrus-common/warnbackendchange"]["type"]="note";
$elem["kolab-cyrus-common/warnbackendchange"]["description"]="Database backends have changed!
...
";
$elem["kolab-cyrus-common/warnbackendchange"]["descriptionde"]="Datenbankanbindungen haben sich geändert!
 ...
 .
 Mehr Informationen finden Sie in der Datei /usr/share/doc/kolab-cyrus-common/README.Debian.database.  Starten Sie keinesfalls cyrmaster, bevor Sie die Datenbank in das neue Format überführt haben.
";
$elem["kolab-cyrus-common/warnbackendchange"]["descriptionfr"]="Modifications dans l'interfaçage avec les bases de données
 ...
 .
 Veuillez-vous reporter à /usr/share/doc/kolab-cyrus-common/README.Debian.database pour des informations supplémentaires. Ne lancez pas cyrmaster avant d'avoir converti les bases de données au nouveau format.
";
$elem["kolab-cyrus-common/warnbackendchange"]["default"]="";
$elem["kolab-cyrus-common/removespools"]["type"]="boolean";
$elem["kolab-cyrus-common/removespools"]["description"]="Remove the mail and news spools?
...
";
$elem["kolab-cyrus-common/removespools"]["descriptionde"]="Mail- und News-Spools entfernen?
...
";
$elem["kolab-cyrus-common/removespools"]["descriptionfr"]="Faut-il supprimer les répertoires contenant les courriers et les nouvelles ?
...
";
$elem["kolab-cyrus-common/removespools"]["default"]="false";
