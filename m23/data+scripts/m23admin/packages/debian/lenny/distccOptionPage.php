...
$elem["distcc/daemon-allow"]["descriptionde"]="Zugelassene Client-Netze:
 ...
 .
 Sie können mehrere Hosts bzw. Netze durch Leerzeichen getrennt eingeben. Hosts werden durch deren IP-Adresse repräsentiert. Netze müssen in CIDR-Schreibweise eingegeben werden, z. B. »192.168.1.0/24«.
 .
...
$elem["distcc/daemon-listen"]["descriptionde"]="Netzschnittstellen:
 ...
 .
 Sie wollen möglicherweise die Netzschnittstelle zu Ihrem lokalen Netz verwenden, indem Sie deren IP-Adresse eingeben. Falls distccd an alle Schnittstellen gebunden werden soll, geben Sie hier nichts ein.
 .
...
$elem["distcc/daemon-listen"]["descriptionfr"]="Interfaces d'écoute :
 ...
 .
 Si vous souhaitez changer la listes des adresses plus tard, vous pourrez utiliser la commande « dpkg-reconfigure distcc ».
";
...
$elem["distcc/daemon-zeroconf"]["description"]="Enable Zeroconf support?
 distcc for Debian has been patched with Zeroconf support.
 .
...
$elem["distcc/daemon-zeroconf"]["descriptionde"]="Zeroconf-Unterstützung aktivieren?
 Distcc für Debian wurde modifiziert, um Zeroconf zu unterstützen.
 .
 Falls Sie es hier aktivieren, lesen Sie /usr/share/doc/distcc/README.Debian, um herauszufinden, wie die Clients hierzu konfiguriert werden müssen.
 .
 Um diesen Wert zu einem späteren Zeitpunkt zu ändern, rufen Sie »dpkg-reconfigure distcc« auf.
";
$elem["distcc/daemon-zeroconf"]["descriptionfr"]="Faut-il activer la gestion de Zeroconf ?
 Le paquet distcc a été modifié pour gérer Zeroconf.
 .
 Si vous activez cette option, vous devriez lire le fichier /usr/share/doc/distcc/README.Debian pour pouvoir configurer les clients afin qu'ils s'en servent.
 .
 Si vous souhaitez changer cette valeur plus tard, vous pourrez utiliser la commande « dpkg-reconfigure distcc ».
";
$elem["distcc/daemon-zeroconf"]["default"]="true";
