...
$elem["krb5-admin-server/kadmind"]["descriptionfr"]="Faut-il lancer le démon d'administration de Kerberos v5 (kadmind) ?
 ...
 .
 Il est également indispensable que le programme kpasswd puisse changer les mots de passe. Habituellement, ce démon doit être opérationnel sur le contrôleur de domaine Kerberos (KDC).
";
