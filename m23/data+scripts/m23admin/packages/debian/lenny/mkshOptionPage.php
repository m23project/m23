...
$elem["mksh/cannot"]["descriptionde"]="Kann mksh nicht als /bin/sh installieren!
 Weil dash schon konfiguriert wurde, sich als /bin/sh zu installieren, kann mksh nicht als /bin/sh installiert werden. Bitte benutzen Sie \"dpkg-reconfigure dash\", um dash einzustellen, sich nicht als /bin/sh zu instalieren, dann \"dpkg-reconfigure mksh\", um mksh dort zu installieren.
";
