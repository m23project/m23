...
$elem["spamprobe/db46_upgrade"]["type"]="note";
$elem["spamprobe/db46_upgrade"]["description"]="Upgrading to Berkeley DB 4.6
...
";
$elem["spamprobe/db46_upgrade"]["descriptionde"]="Führe Upgrade auf Berkeley DB 4.6 durch
 Mit Spamprobe 1.4d-1 änderte sich das Datenbankformat auf Berkeley DB 4.6 und Spamprobe ist nicht mehr in der Lage, Datenbanken in älteren Formaten zu bearbeiten.
 .
...
";
$elem["spamprobe/db46_upgrade"]["descriptionfr"]="Mise à jour vers Berkeley DB 4.6
 À partir de la version 1.4d-1 de spamprobe, le format de la base de données est devenu le format Berkeley 4.6. Par conséquence, spamprobe ne peut plus modifier les bases de données existantes si elles utilisent un format antérieur.
 .
...
";
$elem["spamprobe/db46_upgrade"]["default"]="";
