...
$elem["hyperspec/aborting"]["type"]="note";
$elem["hyperspec/aborting"]["description"]="Aborting
 The download of the hyperspec from internet failed. You can try
 reinstalling the file another time.
";
$elem["hyperspec/aborting"]["descriptionde"]="Abbruch
 Das Herunterladen des Hyperspec aus dem Internet ist fehlgeschlagen. Sie können zu einem späteren Zeitpunkt die Installation der Datei erneut versuchen.
";
$elem["hyperspec/aborting"]["descriptionfr"]="Abandon du téléchargement
 Le téléchargement de hyperspec depuis Internet a échoué. Vous pourrez essayer de le réinstaller plus tard.
";
$elem["hyperspec/aborting"]["default"]="";
