...
$elem["cupsys/backend"]["choices"][3]="parallel";
$elem["cupsys/backend"]["choices"][4]="scsi";
$elem["cupsys/backend"]["choices"][5]="serial";
$elem["cupsys/backend"]["choices"][6]="socket";
$elem["cupsys/backend"]["choices"][7]="usb";
$elem["cupsys/backend"]["choices"][8]="snmp";
$elem["cupsys/backend"]["choicesde"][1]="IPP";
$elem["cupsys/backend"]["choicesde"][2]="lpd";
$elem["cupsys/backend"]["choicesde"][3]="parallel";
$elem["cupsys/backend"]["choicesde"][4]="SCSI";
$elem["cupsys/backend"]["choicesde"][5]="seriell";
$elem["cupsys/backend"]["choicesde"][6]="Socket";
$elem["cupsys/backend"]["choicesde"][7]="USB";
$elem["cupsys/backend"]["choicesde"][8]="SNMP";
$elem["cupsys/backend"]["choicesfr"][1]="IPP";
$elem["cupsys/backend"]["choicesfr"][2]="lpd";
$elem["cupsys/backend"]["choicesfr"][3]="parallèle";
$elem["cupsys/backend"]["choicesfr"][4]="SCSI";
$elem["cupsys/backend"]["choicesfr"][5]="série";
$elem["cupsys/backend"]["choicesfr"][6]="socket";
$elem["cupsys/backend"]["choicesfr"][7]="USB";
$elem["cupsys/backend"]["choicesfr"][8]="SNMP";
...
";
$elem["cupsys/backend"]["default"]="ipp, lpd, parallel, scsi, serial, socket, usb, snmp, dnssd";
