...
$params = PKG_OptionPageHeader2("snort-mysql");

$elem["snort-mysql/startup"]["type"]="select";
$elem["snort-mysql/startup"]["choices"][1]="boot";
$elem["snort-mysql/startup"]["choices"][2]="dialup";
$elem["snort-mysql/startup"]["choicesde"][1]="Systemstart";
$elem["snort-mysql/startup"]["choicesde"][2]="Einwahl";
$elem["snort-mysql/startup"]["choicesfr"][1]="Au démarrage";
$elem["snort-mysql/startup"]["choicesfr"][2]="À la connexion";
$elem["snort-mysql/startup"]["description"]="Snort start method:
 Snort can be started during boot, when connecting to the net with pppd or
 only manually with the /usr/sbin/snort command.
";
$elem["snort-mysql/startup"]["descriptionde"]="Startmethode für Snort:
...
";
$elem["snort-mysql/startup"]["descriptionfr"]="Méthode de lancement de Snort :
...
";
$elem["snort-mysql/startup"]["default"]="boot";
$elem["snort-mysql/interface"]["type"]="string";
$elem["snort-mysql/interface"]["description"]="Interface(s) which Snort should listen on:
...
";
$elem["snort-mysql/interface"]["descriptionde"]="Schnittstelle(n) an der/denen Snort lauschen soll:
...
";
$elem["snort-mysql/interface"]["descriptionfr"]="Interface(s) où Snort sera à l'écoute :
...
";
$elem["snort-mysql/interface"]["default"]="eth0";
$elem["snort-mysql/address_range"]["type"]="string";
$elem["snort-mysql/address_range"]["description"]="Address range for the local network:
...
";
$elem["snort-mysql/address_range"]["descriptionde"]="Adressbereich des lokalen Netzwerks:
...
";
$elem["snort-mysql/address_range"]["descriptionfr"]="Plage d'adresses du réseau local :
...
";
$elem["snort-mysql/address_range"]["default"]="192.168.0.0/16";
$elem["snort-mysql/disable_promiscuous"]["type"]="boolean";
$elem["snort-mysql/disable_promiscuous"]["description"]="Should Snort disable promiscuous mode on the interface?
...
";
$elem["snort-mysql/disable_promiscuous"]["descriptionde"]="Soll Snort den Modus »Promiscuous« an der Schnittstelle ausschalten?
...
";
$elem["snort-mysql/disable_promiscuous"]["descriptionfr"]="Faut-il désactiver le mode « promiscuous » sur l'interface ?
...
";
$elem["snort-mysql/disable_promiscuous"]["default"]="false";
$elem["snort-mysql/invalid_interface"]["type"]="error";
$elem["snort-mysql/invalid_interface"]["description"]="Invalid interface
...
";
$elem["snort-mysql/invalid_interface"]["descriptionde"]="Ungültige Schnittstelle
...
";
$elem["snort-mysql/invalid_interface"]["descriptionfr"]="Interface non valable
...
";
$elem["snort-mysql/invalid_interface"]["default"]="";
$elem["snort-mysql/reverse_order"]["type"]="boolean";
$elem["snort-mysql/reverse_order"]["description"]="Should Snort's testing order be changed to Pass|Alert|Log?
...
";
$elem["snort-mysql/reverse_order"]["descriptionde"]="Soll Snorts Reihenfolge der Tests auf Pass|Alert|Log geändert werden?
...
";
$elem["snort-mysql/reverse_order"]["descriptionfr"]="Faut-il modifier l'ordre de vérification de Snort en « Pass|Alert|Log » ?
...
";
$elem["snort-mysql/reverse_order"]["default"]="false";
$elem["snort-mysql/send_stats"]["type"]="boolean";
$elem["snort-mysql/send_stats"]["description"]="Should daily summaries be sent by e-mail?
...
";
$elem["snort-mysql/send_stats"]["descriptionde"]="Sollen tägliche Zusammenfassungen per E-Mail verschickt werden?
...
";
$elem["snort-mysql/send_stats"]["descriptionfr"]="Faut-il envoyer des rapports quotidiens par courriel ?
...
";
$elem["snort-mysql/send_stats"]["default"]="true";
$elem["snort-mysql/stats_rcpt"]["type"]="string";
$elem["snort-mysql/stats_rcpt"]["description"]="Recipient of daily statistics mails:
 Please specify the e-mail address that should receive daily summaries
 of Snort logs.
";
$elem["snort-mysql/stats_rcpt"]["descriptionde"]="Empfänger der täglichen Statistik-E-Mails:
 Bitte geben Sie die E-Mail-Adresse ein, an die täglich Zusammenfassungen der Protokolle von Snort geschickt werden sollen.
";
$elem["snort-mysql/stats_rcpt"]["descriptionfr"]="Destinataire des courriers électroniques quotidiens de statistiques :
 Veuillez indiquer l'adresse électronique qui recevra les résumés quotidiens des journaux de Snort.
";
$elem["snort-mysql/stats_rcpt"]["default"]="root";
$elem["snort-mysql/options"]["type"]="string";
$elem["snort-mysql/options"]["description"]="Additional custom options:
 Please specify any additional options Snort should use.
";
$elem["snort-mysql/options"]["descriptionde"]="Zusätzliche benutzerspezifische Optionen:
 Bitte geben Sie alle weiteren Optionen ein, die Snort benutzen soll.
";
$elem["snort-mysql/options"]["descriptionfr"]="Options personnelles supplémentaires :
 Veuillez indiquer les options supplémentaires qu'utilisera Snort.
";
$elem["snort-mysql/options"]["default"]="";
$elem["snort-mysql/stats_treshold"]["type"]="string";
$elem["snort-mysql/stats_treshold"]["description"]="Minimum occurrences before alerts are reported:
 Please enter the minimum number of alert occurrences before a given alert is
 included in the daily statistics.
";
$elem["snort-mysql/stats_treshold"]["descriptionde"]="Minimale Ereignisanzahl ab der Alarme gemeldet werden:
 Bitte geben Sie die minimale Anzahl eines Alarms ein, ab der dieser Alarm in die tägliche Statistik aufgenommen wird.
";
$elem["snort-mysql/stats_treshold"]["descriptionfr"]="Nombre d'occurrences minimales avant l'envoi d'alertes :
...
";
$elem["snort-mysql/stats_treshold"]["default"]="1";
$elem["snort-mysql/please_restart_manually"]["type"]="note";
$elem["snort-mysql/please_restart_manually"]["description"]="Snort restart required
 As Snort is manually launched, you need to run '/etc/init.d/snort' for
 the changes to take place.
";
$elem["snort-mysql/please_restart_manually"]["descriptionde"]="Neustart von Snort erforderlich
 Da Snort manuell gestartet wurde, müssen Sie den Befehl '/etc/init.d/snort' aufrufen, damit die Änderungen wirksam werden.
";
$elem["snort-mysql/please_restart_manually"]["descriptionfr"]="Redémarrage de Snort indispensable
...
";
$elem["snort-mysql/please_restart_manually"]["default"]="";
$elem["snort-mysql/config_error"]["type"]="error";
$elem["snort-mysql/config_error"]["description"]="Configuration error
...
";
$elem["snort-mysql/config_error"]["descriptionde"]="Fehler in den Einstellungen
...
";
$elem["snort-mysql/config_error"]["descriptionfr"]="Erreur de configuration
...
";
$elem["snort-mysql/config_error"]["default"]="";
$elem["snort-mysql/config_parameters"]["type"]="error";
$elem["snort-mysql/config_parameters"]["description"]="Obsolete configuration file
...
";
$elem["snort-mysql/config_parameters"]["descriptionde"]="Veraltete Konfigurationsdatei
...
";
$elem["snort-mysql/config_parameters"]["descriptionfr"]="Fichier de configuration obsolète
...
";
$elem["snort-mysql/config_parameters"]["default"]="";
$elem["snort-mysql/configure_db"]["type"]="boolean";
$elem["snort-mysql/configure_db"]["description"]="Set up a database for snort-mysql to log to?
...
";
$elem["snort-mysql/configure_db"]["descriptionde"]="Eine Protokoll-Datenbank für Snort-mysql einrichten?
 ...
 .
 Das Protokollieren in eine Datenbank kann später mit dem Befehl 'dpkg-reconfigure -plow snort-mysql'eingerichtet werden.
";
$elem["snort-mysql/configure_db"]["descriptionfr"]="Faut-il configurer une base de données pour la journalisation de snort-mysql ?
 ...
 .
 La journalisation dans une base de données pourra être choisie plus tard avec la commande « dpkg-reconfigure -plow snort-mysql ».
";
$elem["snort-mysql/configure_db"]["default"]="true";
$elem["snort-mysql/db_host"]["type"]="string";
$elem["snort-mysql/db_host"]["description"]="Database server hostname:
 Please specify the host name of a database server that allows
 incoming connections from this host.
";
$elem["snort-mysql/db_host"]["descriptionde"]="Rechnername des Datenbank-Servers:
 Bitte geben Sie den Rechnernamen eines Datenbank-Servers ein, der eingehende Verbindungen von diesem Rechner annimmt.
";
$elem["snort-mysql/db_host"]["descriptionfr"]="Nom d'hôte du serveur de bases de données :
...
";
$elem["snort-mysql/db_host"]["default"]="";
$elem["snort-mysql/db_database"]["type"]="string";
$elem["snort-mysql/db_database"]["description"]="Database name:
 Please specify the name of an existing database to which the
 database user has write access.
";
$elem["snort-mysql/db_database"]["descriptionde"]="Datenbankname:
 Bitte geben Sie den Namen einer vorhandenen Datenbank ein, auf die der Datenbankbenutzer Schreibrechte hat.
";
$elem["snort-mysql/db_database"]["descriptionfr"]="Nom de la base de données :
 Veuillez indiquer le nom d'une base de données existante où l'identifiant choisi possède des droits d'écriture.
";
$elem["snort-mysql/db_database"]["default"]="";
$elem["snort-mysql/db_user"]["type"]="string";
$elem["snort-mysql/db_user"]["description"]="Username for database access:
 Please specify a database server username with write access to the database.
";
$elem["snort-mysql/db_user"]["descriptionde"]="Benutzername für den Datenbankzugriff:
 Bitte geben Sie einen Benutzernamen des Datenbank-Servers ein, der Schreibzugriff auf die Datenbank hat.
";
$elem["snort-mysql/db_user"]["descriptionfr"]="Identifiant de connexion au serveur de bases de données :
 Veuillez indiquer un identifiant du serveur de bases de données, qui possède les droits d'écriture sur la base de données.
";
$elem["snort-mysql/db_user"]["default"]="";
$elem["snort-mysql/db_pass"]["type"]="password";
$elem["snort-mysql/db_pass"]["description"]="Password for the database connection:
 Please enter the password to use to connect to the Snort Alert database.
";
$elem["snort-mysql/db_pass"]["descriptionde"]="Passwort für die Datenbankverbindung:
 Bitte das Passwort für die Verbindung zu Snorts Alarm-Datenbank eingeben.
";
$elem["snort-mysql/db_pass"]["descriptionfr"]="Mot de passe de connexion au serveur de bases de données :
 Veuillez indiquer le mot de passe à utiliser pour la connexion à la base de données des alertes de Snort.
";
$elem["snort-mysql/db_pass"]["default"]="";
$elem["snort-mysql/needs_db_config"]["type"]="note";
$elem["snort-mysql/needs_db_config"]["description"]="Configured database mandatory for Snort
 ...
 manually.
";
$elem["snort-mysql/needs_db_config"]["descriptionde"]="Eingerichtete Datenbank für Snort nötig
 ...
 .
 Geben Sie die korrekten Werte für Benutzer, Rechner und Datenbankname ein. MySQL wird Sie nach dem Passwort fragen.
 .
 Nachdem Sie die Datenbankstruktur angelegt haben, müssen Sie Snort noch starten.
";
$elem["snort-mysql/needs_db_config"]["descriptionfr"]="Base de données configurée obligatoire pour Snort
 ...
 .
 Veuillez indiquer les valeurs appropriées pour l'identifiant, le nom du serveur et de la base de données. MySQL demandera le mot de passe.
 .
 Après avoir créé la structure de base de données, vous devrez démarrer Snort manuellement.
";
$elem["snort-mysql/needs_db_config"]["default"]="";
