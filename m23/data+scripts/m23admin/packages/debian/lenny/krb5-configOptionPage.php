...
";
$elem["krb5-config/default_realm"]["descriptionfr"]="Domaine Kerberos version 5 par défaut :
...
$elem["krb5-config/dns_for_default"]["type"]="boolean";
$elem["krb5-config/dns_for_default"]["description"]="Does DNS contain pointers to your realm's Kerberos Servers?
...
";
$elem["krb5-config/dns_for_default"]["descriptionde"]="Enthält das DNS Verweise zu den Kerberos-Servern Ihres Realm?
...
";
$elem["krb5-config/dns_for_default"]["descriptionfr"]="Le DNS contient-il des enregistrements pointant vers les domaines de vos serveurs Kerberos ?
...
";
$elem["krb5-config/dns_for_default"]["default"]="false";
...
";
$elem["krb5-config/kerberos_servers"]["descriptionfr"]="Serveurs Kerberos pour votre domaine :
...
";
$elem["krb5-config/admin_server"]["descriptionfr"]="Serveur administratif pour votre domaine Kerberos :
