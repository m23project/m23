...
$elem["mantis/passwordnote"]["descriptionde"]="Passwort des Administrators muss geändert werden
 Standardmäßig erstellt das Mantis-Paket ein Administratorkonto. Das Passwort für dieses Konto ist »root«.
 .
...
$elem["mantis/passwordnote"]["descriptionfr"]="Changement obligatoire du mot de passe de l'administrateur
 Par défaut, le paquet de Mantis crée un compte d'administration. Le mot de passe de ce compte est « root ».
 .
