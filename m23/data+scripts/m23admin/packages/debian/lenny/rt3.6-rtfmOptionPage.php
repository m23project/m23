...
$params = PKG_OptionPageHeader2("rt3.6-rtfm");

$elem["rt3.6-rtfm/modify-database-permission"]["type"]="select";
$elem["rt3.6-rtfm/modify-database-permission"]["choices"][1]="allow";
$elem["rt3.6-rtfm/modify-database-permission"]["choices"][2]="prompt";
$elem["rt3.6-rtfm/modify-database-permission"]["choicesde"][1]="Erlauben";
$elem["rt3.6-rtfm/modify-database-permission"]["choicesde"][2]="Fragen";
$elem["rt3.6-rtfm/modify-database-permission"]["choicesfr"][1]="Modifier";
$elem["rt3.6-rtfm/modify-database-permission"]["choicesfr"][2]="Demander";
$elem["rt3.6-rtfm/modify-database-permission"]["description"]="Permission to modify the Request Tracker database:
...
";
$elem["rt3.6-rtfm/modify-database-permission"]["descriptionde"]="Erlaubnis, um die Datenbank zur Anfrageverfolgung zu bearbeiten:
...
";
$elem["rt3.6-rtfm/modify-database-permission"]["descriptionfr"]="Modifications automatiques de la base de données de Request Tracker :
...
";
$elem["rt3.6-rtfm/modify-database-permission"]["default"]="allow";
$elem["rt3.6-rtfm/setup-database-prompt"]["type"]="boolean";
$elem["rt3.6-rtfm/setup-database-prompt"]["description"]="Set up the Request Tracker database?
 New tables must be created in the Request Tracker database for RTFM
 to be functional.
";
$elem["rt3.6-rtfm/setup-database-prompt"]["descriptionde"]="Die Datenbank zur Anfrageverfolgung einrichten?
 Damit RTFM funktioniert, müssen in der Datenbank zur Anfrageverfolgung neue Tabellen erstellt werden.
";
$elem["rt3.6-rtfm/setup-database-prompt"]["descriptionfr"]="Faut-il configurer la base de données de Request Tracker ?
 De nouvelles tables doivent être créées dans la base de données de Request Tracker afin que RTFM puisse fonctionner
";
$elem["rt3.6-rtfm/setup-database-prompt"]["default"]="true";
$elem["rt3.6-rtfm/upgrade-database-prompt"]["type"]="boolean";
$elem["rt3.6-rtfm/upgrade-database-prompt"]["description"]="Upgrade the Request Tracker database?
 The Request Tracker database schema and contents must be upgraded for
 this version of RTFM.
";
$elem["rt3.6-rtfm/upgrade-database-prompt"]["descriptionde"]="Upgrade der Datenbank zur Anfrageverfolgung durchführen?
 Für diese Version von RTFM muss ein Upgrade des Schemas und der Inhalte der Datenbank zur Anfrageverfolgung erfolgen.
";
$elem["rt3.6-rtfm/upgrade-database-prompt"]["descriptionfr"]="Faut-il mettre à jour la base de données de Request Tracker ?
 Le schéma et le contenu de la base de données de Request Tracker doivent être mis à jour pour cette version de RTFM.
";
$elem["rt3.6-rtfm/upgrade-database-prompt"]["default"]="true";
$elem["rt3.6-rtfm/modify-database-error"]["type"]="select";
$elem["rt3.6-rtfm/modify-database-error"]["choices"][1]="abort";
$elem["rt3.6-rtfm/modify-database-error"]["choices"][2]="retry";
$elem["rt3.6-rtfm/modify-database-error"]["choicesde"][1]="Abbrechen";
$elem["rt3.6-rtfm/modify-database-error"]["choicesde"][2]="Erneut versuchen";
$elem["rt3.6-rtfm/modify-database-error"]["choicesfr"][1]="Abandonner";
$elem["rt3.6-rtfm/modify-database-error"]["choicesfr"][2]="Réessayer";
$elem["rt3.6-rtfm/modify-database-error"]["description"]="Action after database modification error:
 ...
 will continue.
";
$elem["rt3.6-rtfm/modify-database-error"]["descriptionde"]="Aktion, die nach einem Fehler beim Anpassen der Datenbank erfolgen soll:
...
";
$elem["rt3.6-rtfm/modify-database-error"]["descriptionfr"]="Action à effectuer après l'erreur de mise à jour de la base de données :
...
";
$elem["rt3.6-rtfm/modify-database-error"]["default"]="abort";
