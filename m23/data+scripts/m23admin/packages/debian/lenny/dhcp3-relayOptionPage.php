...
$params = PKG_OptionPageHeader2("dhcp3-relay");

$elem["dhcp3-relay/servers"]["type"]="string";
$elem["dhcp3-relay/servers"]["description"]="Servers the DHCP relay should forward requests to:
...
";
$elem["dhcp3-relay/servers"]["descriptionde"]="DHCP-Server, zu denen der DHCP-Relay die Anfragen weiterleiten soll:
...
";
$elem["dhcp3-relay/servers"]["descriptionfr"]="Serveurs DHCP auxquels faire suivre les requêtes de relais DHCP :
...
";
$elem["dhcp3-relay/servers"]["default"]="";
$elem["dhcp3-relay/interfaces"]["type"]="string";
$elem["dhcp3-relay/interfaces"]["description"]="Interfaces the DHCP relay should listen on:
...
";
$elem["dhcp3-relay/interfaces"]["descriptionde"]="Netzwerkschnittstellen, an denen der DHCP-Relay auf Anfragen warten soll:
...
";
$elem["dhcp3-relay/interfaces"]["descriptionfr"]="Interface où le relais DHCP sera à l'écoute :
...
";
$elem["dhcp3-relay/interfaces"]["default"]="";
$elem["dhcp3-relay/options"]["type"]="string";
$elem["dhcp3-relay/options"]["description"]="Additional options for the DHCP relay daemon:
 Please specify any additional options for the DHCP relay daemon.
 .
 For example: '-m replace' or '-a -D'.
";
$elem["dhcp3-relay/options"]["descriptionde"]="Zusätzliche Optionen für den DHCP-Relay-Dienst:
 Bitte geben Sie zusätzliche Optionen für den DHCP-Relay-Dienst ein.
 .
 Beispiel: »-m replace« oder »-a -D«.
";
$elem["dhcp3-relay/options"]["descriptionfr"]="Options supplémentaires pour le démon de relais DHCP :
 Vous pouvez ajouter des options supplémentaires pour le démon de relais DHCP.
 .
 Par exemple : « -m replace » ou « -a -D ».
";
$elem["dhcp3-relay/options"]["default"]="";
