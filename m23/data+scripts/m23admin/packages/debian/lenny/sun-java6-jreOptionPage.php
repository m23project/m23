...
$params = PKG_OptionPageHeader2("sun-java6-jre");

$elem["sun-java6-jre/jcepolicy"]["type"]="note";
$elem["sun-java6-jre/jcepolicy"]["description"]="JCE Unlimited Strength Jurisdiction Policy Files
...
";
$elem["sun-java6-jre/jcepolicy"]["descriptionde"]="»JCE Unlimited Strength Jurisdiction Policy Files«
 Aufgrund von Einfuhrbeschränkungen mancher Länder erlauben die Rechtsrichtliniendateien der JCE, wie sie von diesem Paket zur Verfügung gestellt werden, die Benutzung »starker« aber eingeschränkter Verschlüsselung. Eine Version mit »unbegrenzter Stärke«, die keine Einschränkungen der Verschlüsselungsstärke aufweist, ist für diejenigen verfügbar, die in berechtigten Ländern leben (das sind die meisten Länder). Sie können diese Version herunterladen und die Version mit starker Verschlüsselung, die mit diesem Paket geliefert wurden, durch die unlimitierten ersetzen.
 .
 Die »Java(TM) Cryptography Extension (JCE) Unlimited Strength Jurisdiction Policy Files 1.4.2« sind auf http://javashoplm.sun.com/ECom/docs/Welcome.jsp?StoreId=22&PartDetailId=7503-jce-1.4.2-oth-JPR&SiteId=JSC&TransactionId=noreg verfügbar.
";
$elem["sun-java6-jre/jcepolicy"]["descriptionfr"]="« JCE Unlimited Strength Jurisdiction Policy Files »
 ...
 .
 L'extension de cryptographie de Java (TM) « (JCE) Unlimited Strength Jurisdiction Policy Files 1.4.2 » est disponible à http://javashoplm.sun.com/ECom/docs/Welcome.jsp?StoreId=22&PartDetailId=7503-jce-1.4.2-oth-JPR&SiteId=JSC&TransactionId=noreg
";
$elem["sun-java6-jre/jcepolicy"]["default"]="";
$elem["sun-java6-jre/stopthread"]["type"]="boolean";
$elem["sun-java6-jre/stopthread"]["description"]="Grant the \"stopThread\" RuntimePermission?
...
";
$elem["sun-java6-jre/stopthread"]["descriptionde"]="Die »stopThread« RuntimePermission zulassen?
 Diese Erlaubnis erlaubt jedem Thread, sich selbst anzuhalten, indem er die Methode java.lang.Thread.stop() verwendet, die keine Argumente erwartet.
 .
 ...
 .
 Siehe http://java.sun.com/notes für weitere Informationen.
";
$elem["sun-java6-jre/stopthread"]["descriptionfr"]="Voulez-vous autoriser la gestion « stopThread » de la classe « RuntimePermission » ?
 Ceci permet à tout processus léger (« thread ») de s'arrêter lui-même avec la méthode sans paramètre « java.lang.Thread.stop() ».
 .
 ...
 .
 Consultez « http://java.sun.com/notes » pour plus d'informations.
";
$elem["sun-java6-jre/stopthread"]["default"]="true";
$elem["shared/present-sun-dlj-v1-1"]["type"]="note";
$elem["shared/present-sun-dlj-v1-1"]["description"]="Operating System Distributor License for Java v1.1 (DLJ)
...
";
$elem["shared/present-sun-dlj-v1-1"]["descriptionde"]="";
$elem["shared/present-sun-dlj-v1-1"]["descriptionfr"]="";
$elem["shared/present-sun-dlj-v1-1"]["default"]="";
$elem["shared/accepted-sun-dlj-v1-1"]["type"]="boolean";
$elem["shared/accepted-sun-dlj-v1-1"]["description"]="Do you agree with the DLJ license terms?
 In order to install this package, you must agree to its license terms, the
 \"Operating System Distributor License for Java\" (DLJ), v1.1. Not accepting
 will cancel the installation.
";
$elem["shared/accepted-sun-dlj-v1-1"]["descriptionde"]="Sind Sie mit den DLJ-Lizenzbestimmungen einverstanden?
 Um dieses Paket zu installieren, müssen Sie dessen Lizenzbedingungen, den »Operating System Distributor License for Java« (DLJ), v1.1, zustimmen. Nichtakzeptanz wird die Installation abbrechen.
";
$elem["shared/accepted-sun-dlj-v1-1"]["descriptionfr"]="Acceptez-vous les termes de la licence DLJ ?
 Afin d'installer ce paquet, vous devez accepter les termes de la licence « Operating System Distributor License for Java » (DLJ), version 1.1. Si vous n'acceptez pas les termes de cette licence, l'installation sera annulée.
";
$elem["shared/accepted-sun-dlj-v1-1"]["default"]="false";
$elem["shared/error-sun-dlj-v1-1"]["type"]="error";
$elem["shared/error-sun-dlj-v1-1"]["description"]="Declined Operating System Distributor License for Java v1.1 (DLJ)
...
";
$elem["shared/error-sun-dlj-v1-1"]["descriptionde"]="»Operating System Distributor License for Java« v1.1 (DLJ) abgelehnt
 Wenn Sie den DLJ-Lizenzbestimmungen nicht zustimmen, können Sie diese Software nicht installieren.
 .
 Die Installation dieses Pakets wird abgebrochen.
";
$elem["shared/error-sun-dlj-v1-1"]["descriptionfr"]="Refus de la license « Operating System Distributor License for Java » (DLJ), version 1.1
 Si vous n'acceptez pas les termes la licence DLJ, vous ne pouvez pas installer ce programme.
 .
 L'installation de ce paquet sera abandonnée.
";
$elem["shared/error-sun-dlj-v1-1"]["default"]="";
