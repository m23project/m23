...
$elem["fortunes-de/fortunes_to_install"]["description"]="Fortunes to use:
 ...
 ${pkg}'.
";
$elem["fortunes-de/fortunes_to_install"]["descriptionde"]="Fortunes auswÃ¤hlen:
 Sie kÃ¶nnen auswÃ¤hlen, welche Pakete fortune verwenden soll.
 .
 Wenn Sie Ihre Meinung spÃ¤ter Ã¤ndern, starten Sie das Kommando: 'dpkg-reconfigure fortunes-de'.
";
$elem["fortunes-de/fortunes_to_install"]["descriptionfr"]="Citations Ã  utiliserÂ :
 Vous pouvez choisir les groupes de citations qui seront utilisÃ©s par fortune.
 .
 Vous pourrez modifier cette option plus tard avec la commande Â«Â dpkg-reconfigure ${pkg}Â Â».
";
