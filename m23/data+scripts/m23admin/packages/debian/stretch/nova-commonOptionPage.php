...
$elem["nova/active-api"]["choices"][1]="osapi_compute";
...
$elem["nova/active-api"]["descriptionfr"]="API à activer :
 ...
 .
 Dans le cas de l'installation d'un nœud de calcul, il suffit de lancer le serveur API de métadonnées. Si vous utilisez Cinder, vous n'avez pas besoin d'osapi_volume (vous ne pouvez pas lancer osapi_volume et cinder-api sur le même serveur : ils sont liés au même port).
";
...
$elem["nova/metadata_secret"]["type"]="password";
$elem["nova/metadata_secret"]["description"]="Metadata proxy shared secret:
 ...
 package.
";
$elem["nova/metadata_secret"]["descriptionde"]="";
$elem["nova/metadata_secret"]["descriptionfr"]="Secret partagé pour le relais de métadonnées (« metadata proxy ») :
 ...
 .
 Veuillez indiquer le mot de passe à utiliser pour protéger les communications entre l'agent relais de métadonnées de Neutron et le serveur de métadonnées de Nova. Le même mot de passe partagé doit être utilisé lors de 'installation du paquet neutron-metadata-agent.
";
$elem["nova/metadata_secret"]["default"]="";
