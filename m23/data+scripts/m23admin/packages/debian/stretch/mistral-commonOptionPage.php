...
$elem["mistral/configure_db"]["descriptionfr"]="Installer une base de données pour Mistral ?
 Aucune base de données n'a été installée pour Mistral. Avant de continuer, assurez-vous d'avoir :
 .
 ...
 .
 Vous pouvez modifier ce réglage plus tard en lançant « dpkg-reconfigure -plow mistral-common ».
";
