...
$params = PKG_OptionPageHeader2("gdm3");

$elem["gdm3/daemon_name"]["type"]="string";
$elem["gdm3/daemon_name"]["description"]="for internal use only

";
$elem["gdm3/daemon_name"]["descriptionde"]="";
$elem["gdm3/daemon_name"]["descriptionfr"]="";
$elem["gdm3/daemon_name"]["default"]="/usr/sbin/gdm3";
