...
$elem["sahara/configure_db"]["description"]="Set up a database for Sahara?
 ...
 sahara-common\".
";
$elem["sahara/configure_db"]["descriptionde"]="Datenbank für Sahara einrichten?
 Für die Benutzung durch Sahara wurde keine Datenbank eingerichtet. Bevor Sie fortfahren, sollten Sie sicherstellen, dass Sie über die folgenden Informationen verfügen:
 .
 ...
 .
 Sie können diese Einstellung später ändern, indem Sie »dpkg-reconfigure -plow sahara-common« ausführen.
";
...
";
$elem["sahara/auth-host"]["descriptionde"]="Rechnername des Authentifizierungsservers:
...
";
$elem["sahara/admin-tenant-name"]["descriptionde"]="Tenant-Name des Authentifizierungsservers:
...
";
$elem["sahara/admin-user"]["descriptionde"]="Benutzername auf dem Authentifizierungsserver:
...
";
$elem["sahara/admin-password"]["descriptionde"]="Passwort auf dem Authentifizierungsserver:
...
";
$elem["sahara/rabbit_host"]["descriptionde"]="IP-Adresse Ihres RabbitMQ-Rechners:
...
";
$elem["sahara/rabbit_userid"]["descriptionde"]="Benutzername für die Verbindung mit dem RabbitMQ-Server:
 Um mit weiteren Bestandteilen von OpenStack zusammenzuarbeiten, muss sich dieses Paket mit einem zentralen RabbitMQ-Server verbinden.
 .
...
";
$elem["sahara/rabbit_password"]["descriptionde"]="Passwort für die Verbindung mit dem RabbitMQ-Server:
 Um mit weiteren Bestandteilen von OpenStack zusammenzuarbeiten, muss sich dieses Paket mit einem zentralen RabbitMQ-Server verbinden.
 .
