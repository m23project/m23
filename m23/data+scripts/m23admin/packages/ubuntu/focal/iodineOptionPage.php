...
$elem["iodine/start_daemon"]["descriptionde"]="Soll der Iodined (Server) beim Systemstart auch gestartet werden?
 Falls Sie möchten, dass zum Systemstartzeitpunkt auch Iodined gestartet wird, stellen Sie dies hier ein.
";
...
";
$elem["iodine/daemon_options"]["descriptionde"]="Optionen für Iodined (Server):
 Sie müssen die notwendigen Argumente an Iodined übergeben; lesen Sie iodined(8) für Hilfe. Beispiel: 10.0.0.1 tunnel.mydomain.example
";
...
";
$elem["iodine/daemon_password"]["descriptionde"]="Passwort für Iodined (Server):
