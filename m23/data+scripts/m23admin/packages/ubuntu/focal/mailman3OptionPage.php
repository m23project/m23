...
";
$elem["mailman3/config_hyperkitty"]["descriptionfr"]="Faut-il ajouter la configuration pour HyperKitty dans mailman.cfg ?
 Mailman3 a besoin de configurations supplémentaires dans mailman.cfg pour pouvoir envoyer les messages à archiver vers HyperKitty. Cette configuration peut être ajoutée automatiquement maintenant.
 .
 Le contenu de /usr/share/mailman3/mailman_cfg_hyperkitty_snippet.cfg va être ajouté à /etc/mailman3/mailman.cfg.
";
...
";
$elem["mailman3/init_service_failed"]["descriptionfr"]="Le service pour mailman3 a échoué.
 Le service mailman3 n'a pas pu démarrer correctement. Cela peut être dû au fait que vous n'avez pas configuré la base de données de façon adaptée. Le service ne pourra pas démarrer tant que vous ne l'aurez pas fait.
 .
 Si vous avez BIEN configuré la base de données correctement, veuillez signaler un bogue aux mainteneurs du paquet mailman3.
";
