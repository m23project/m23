...
$params = PKG_OptionPageHeader2("octavia-common");

$elem["octavia/configure_db"]["type"]="boolean";
$elem["octavia/configure_db"]["description"]="Set up a database for this package?
...
";
$elem["octavia/configure_db"]["descriptionde"]="Eine Datenbank für dieses Paket einrichten?
...
";
$elem["octavia/configure_db"]["descriptionfr"]="Voulez-vous installer une base de données pour ce paquet ?
...
";
$elem["octavia/configure_db"]["default"]="false";
$elem["octavia/configure_rabbit"]["type"]="boolean";
$elem["octavia/configure_rabbit"]["description"]="Configure RabbitMQ access with debconf?
 ...
 connections.
";
$elem["octavia/configure_rabbit"]["descriptionde"]="Soll der RabbitMQ-Zugriff mit Debconf konfiguriert werden?
...
";
$elem["octavia/configure_rabbit"]["descriptionfr"]="Voulez-vous configurer les accès à RabbitMQ avec les écrans de configuration debconf ?
...
";
$elem["octavia/configure_rabbit"]["default"]="false";
$elem["octavia/rabbit-host"]["type"]="string";
$elem["octavia/rabbit-host"]["description"]="IP address of your RabbitMQ host:
 In order to interoperate with other components of OpenStack, this package
 needs to connect to a central RabbitMQ server.
 .
 Please specify the IP address of that server.
";
$elem["octavia/rabbit-host"]["descriptionde"]="IP-Adresse Ihres RabbitMQ-Rechners:
...
";
$elem["octavia/rabbit-host"]["descriptionfr"]="Adresse IP de votre hôte RabbitMQ :
...
";
$elem["octavia/rabbit-host"]["default"]="localhost";
$elem["octavia/rabbit-userid"]["type"]="string";
$elem["octavia/rabbit-userid"]["description"]="Username for connection to the RabbitMQ server:
 In order to interoperate with other components of OpenStack, this package
 needs to connect to a central RabbitMQ server.
 .
 Please specify the username used to connect to that RabbitMQ server.
";
$elem["octavia/rabbit-userid"]["descriptionde"]="Benutzername für die Verbindung mit dem RabbitMQ-Server:
 Um mit weiteren Bestandteilen von OpenStack zusammenzuarbeiten, muss sich dieses Paket mit einem zentralen RabbitMQ-Server verbinden.
 .
 Bitte geben Sie den Benutzernamen ein, den Sie zum Verbinden mit diesem RabbitMQ-Server verwenden.
";
$elem["octavia/rabbit-userid"]["descriptionfr"]="Nom d'utilisateur pour la connexion au serveur RabbitMQ :
 Afin de pouvoir interagir avec d'autres composants d'OpenStack, ce paquet doit se connecter à un serveur centralisé RabbitMQ.
 .
 Veuillez indiquer le nom d'utilisateur à utiliser pour se connecter au serveur RabbitMQ.
";
$elem["octavia/rabbit-userid"]["default"]="guest";
$elem["octavia/rabbit-password"]["type"]="password";
$elem["octavia/rabbit-password"]["description"]="Password for connection to the RabbitMQ server:
 In order to interoperate with other components of OpenStack, this package
 needs to connect to a central RabbitMQ server.
 .
 Please specify the password used to connect to that RabbitMQ server.
";
$elem["octavia/rabbit-password"]["descriptionde"]="Passwort für die Verbindung mit dem RabbitMQ-Server:
 Um mit weiteren Bestandteilen von OpenStack zusammenzuarbeiten, muss sich dieses Paket mit einem zentralen RabbitMQ-Server verbinden.
 .
 Bitte geben Sie das Passwort ein, das Sie zum Verbinden mit diesem RabbitMQ-Server verwenden.
";
$elem["octavia/rabbit-password"]["descriptionfr"]="Mot de passe pour la connexion au serveur RabbitMQ :
 Afin de pouvoir interagir avec d'autres composants d'OpenStack, ce paquet doit se connecter à un serveur centralisé RabbitMQ.
 .
 Veuillez indiquer le mot de passe à utiliser pour se connecter au serveur RabbitMQ.
";
$elem["octavia/rabbit-password"]["default"]="";
$elem["octavia/configure_ksat"]["type"]="boolean";
$elem["octavia/configure_ksat"]["description"]="Manage keystone_authtoken with debconf?
...
";
$elem["octavia/configure_ksat"]["descriptionde"]="Soll »keystone_authtoken« mit Debconf verwaltet werden?
...
";
$elem["octavia/configure_ksat"]["descriptionfr"]="Voulez-vous gérer le jeton d'authentification keystone (« keystone_authtoken ») avec les écrans de configuration debconf ?
...
";
$elem["octavia/configure_ksat"]["default"]="false";
$elem["octavia/ksat-public-url"]["type"]="string";
$elem["octavia/ksat-public-url"]["description"]="Auth server public endpoint URL:
...
";
$elem["octavia/ksat-public-url"]["descriptionde"]="Öffentlicher Endpunkt-URL des Authentifizierungsservers:
...
";
$elem["octavia/ksat-public-url"]["descriptionfr"]="Adresse URL du point d'accès public pour le serveur d'authentification :
...
";
$elem["octavia/ksat-public-url"]["default"]="http://localhost:5000";
$elem["octavia/ksat-region"]["type"]="string";
$elem["octavia/ksat-region"]["description"]="Keystone region:
 Specify the Keystone region to use.
 .
 The region name is usually a string containing only ASCII alphanumerics,
 dots, and dashes.
";
$elem["octavia/ksat-region"]["descriptionde"]="Keystone-Region:
...
";
$elem["octavia/ksat-region"]["descriptionfr"]="Région Keystone :
...
";
$elem["octavia/ksat-region"]["default"]="regionOne";
$elem["octavia/ksat-create-service-user"]["type"]="boolean";
$elem["octavia/ksat-create-service-user"]["description"]="Create service user?
...
";
$elem["octavia/ksat-create-service-user"]["descriptionde"]="Dienstbenutzer erstellen?
...
";
$elem["octavia/ksat-create-service-user"]["descriptionfr"]="Voulez-vous créer un utilisateur du service ?
...
";
$elem["octavia/ksat-create-service-user"]["default"]="true";
$elem["octavia/ksat-admin-username"]["type"]="string";
$elem["octavia/ksat-admin-username"]["description"]="Auth server admin username:
";
$elem["octavia/ksat-admin-username"]["descriptionde"]="Administratorbenutzername des Authentifizierungsservers:
";
$elem["octavia/ksat-admin-username"]["descriptionfr"]="Nom d'utilisateur administrateur pour le serveur d'authentification :
";
$elem["octavia/ksat-admin-username"]["default"]="admin";
$elem["octavia/ksat-admin-project-name"]["type"]="string";
$elem["octavia/ksat-admin-project-name"]["description"]="Auth server admin project name:
";
$elem["octavia/ksat-admin-project-name"]["descriptionde"]="Administratorprojektname des Authentifizierungsservers:
";
$elem["octavia/ksat-admin-project-name"]["descriptionfr"]="Nom du projet administrateur pour le serveur d'authentification :
";
$elem["octavia/ksat-admin-project-name"]["default"]="admin";
$elem["octavia/ksat-admin-password"]["type"]="password";
$elem["octavia/ksat-admin-password"]["description"]="Auth server admin password:
";
$elem["octavia/ksat-admin-password"]["descriptionde"]="Administratorpasswort des Authentifizierungsservers:
";
$elem["octavia/ksat-admin-password"]["descriptionfr"]="Mot de passe administrateur pour le serveur d'authentification :
";
$elem["octavia/ksat-admin-password"]["default"]="";
$elem["octavia/ksat-service-username"]["type"]="string";
$elem["octavia/ksat-service-username"]["description"]="Auth server service username:
";
$elem["octavia/ksat-service-username"]["descriptionde"]="Dienstbenutzername des Authentifizierungsservers:
";
$elem["octavia/ksat-service-username"]["descriptionfr"]="Nom d'utilisateur pour le serveur du service d'authentification :
";
$elem["octavia/ksat-service-username"]["default"]="";
$elem["octavia/ksat-service-project-name"]["type"]="string";
$elem["octavia/ksat-service-project-name"]["description"]="Auth server service project name:
";
$elem["octavia/ksat-service-project-name"]["descriptionde"]="Dienstprojektname des Authentifizierungsservers:
";
$elem["octavia/ksat-service-project-name"]["descriptionfr"]="Nom du projet pour le serveur du service d'authentification :
";
$elem["octavia/ksat-service-project-name"]["default"]="service";
$elem["octavia/ksat-service-password"]["type"]="password";
$elem["octavia/ksat-service-password"]["description"]="Auth server service password:
";
$elem["octavia/ksat-service-password"]["descriptionde"]="Dienstpasswort des Authentifizierungsservers:
";
$elem["octavia/ksat-service-password"]["descriptionfr"]="Mot de passe pour le serveur du service d'authentification :
";
$elem["octavia/ksat-service-password"]["default"]="";
