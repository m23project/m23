...
$elem["dbconfig-common/remember-admin-pass"]["description"]="Remember database passwords permanently in debconf?
...
";
$elem["dbconfig-common/remember-admin-pass"]["descriptionde"]="Datenbankpassworte dauerhaft in Debconf ablegen?
...
";
$elem["dbconfig-common/remember-admin-pass"]["descriptionfr"]="Se souvenir de manière permanente des mots de passe de la base de données pour les écrans debconf ?
...
$elem["dbconfig-common/dbconfig-reinstall"]["descriptionfr"]="Faut-il réinstaller la base de données pour ${pkg} ?
 ...
 .
 Avertissement : Si vous modifiez le nom de la base de données, la base de données précédente ne sera pas supprimée. Si vous modifiez le nom de l'utilisateur qui se connecte à la base de données, les droits du premier utilisateur ne seront pas révoqués.
";
...
$elem["dbconfig-common/dbconfig-remove"]["descriptionfr"]="Faut-il défaire la configuration de la base de donnée de ${pkg} avec dbconfig-common ?
 Comme vous supprimez ${pkg}, il est possible que vous ne vouliez plus utiliser la base de données et les droits de l'utilisateur qui lui était lié.
 .
...
$elem["dbconfig-common/mysql/method"]["descriptionfr"]="Méthode de connexion pour la base de données MySQL de ${pkg} :
 Par défaut, ${pkg} sera configuré pour utiliser un serveur MySQL local via un socket Unix (cela donne les meilleures performances). Toutefois, si vous souhaitez utiliser une autre méthode de connexion ou vous connecter à un autre serveur, veuillez choisir une des options présentées.
";
...
$elem["dbconfig-common/mysql/authplugin"]["type"]="select";
$elem["dbconfig-common/mysql/authplugin"]["choices"][1]="default";
$elem["dbconfig-common/mysql/authplugin"]["choices"][2]="mysql_native_password";
$elem["dbconfig-common/mysql/authplugin"]["choices"][3]="sha256_password";
$elem["dbconfig-common/mysql/authplugin"]["description"]="Authentication plugin for MySQL database:
...
$elem["dbconfig-common/mysql/authplugin"]["descriptionfr"]="Greffon d'authentification pour la base de données MySQL :
  ...
  * caching_sha2_password - SHA2 plus un cache d'authentification en
    mémoire.
";
$elem["dbconfig-common/mysql/authplugin"]["default"]="default";
