...
$elem["mdadm/autoscan"]["type"]="boolean";
$elem["mdadm/autoscan"]["description"]="Should mdadm check once a day for degraded arrays?
 mdadm can check once a day for degraded arrays and missing spares
 to ensure that such events don't go unnoticed.

";
$elem["mdadm/autoscan"]["descriptionde"]="";
$elem["mdadm/autoscan"]["descriptionfr"]="";
$elem["mdadm/autoscan"]["default"]="true";
