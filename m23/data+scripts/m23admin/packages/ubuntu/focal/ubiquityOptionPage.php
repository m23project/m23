...
";
$elem["ubiquity/text/connecting_label"]["descriptionfr"]="Connexion...
Connexion…
Conèccion
";
...
";
$elem["ubiquity/text/oem_config_title"]["descriptionfr"]="Installer (mode OEM, pour les constructeurs seulement)
...
";
$elem["ubiquity/text/keyboard_comment_label"]["descriptionde"]="Bitte Ihre Tastaturbelegung auswählen:
";
...
";
$elem["ubiquity/text/username_label"]["descriptionde"]="Bitte Benutzernamen auswählen:
";
...
";
$elem["ubiquity/text/password_label"]["descriptionde"]="Ein Passwort auswählen:
";
...
Los contresinyos ne corrèspondont pas
";
...
Buchiér lo contresinyo por se conèctar
";
...
$elem["ubiquity/text/restart_button"]["type"]="text";
$elem["ubiquity/text/restart_button"]["description"]="_Restart

";
$elem["ubiquity/text/restart_button"]["descriptionde"]="";
$elem["ubiquity/text/restart_button"]["descriptionfr"]="";
$elem["ubiquity/text/restart_button"]["default"]="";
...
";
$elem["ubiquity/text/abort_label"]["descriptionde"]="Dadurch könnte der Rechner nicht mehr starten.
";
...
$elem["ubiquity/text/progress_cancel_button"]["description"]="_Skip
";
$elem["ubiquity/text/progress_cancel_button"]["descriptionde"]="_Überspringen
";
$elem["ubiquity/text/progress_cancel_button"]["descriptionfr"]="_Ignorer
_Ignorer
";
...
";
$elem["ubiquity/text/crash_dialog"]["descriptionfr"]="Le programme d'installation a planté
...
";
$elem["ubiquity/text/crash_heading_label"]["descriptionfr"]="Le programme d'installation a planté
Le programme d’installation a planté
";
...
Description-fr_CA.UTF-8:
 L’installation est terminée. Vous pouvez maintenant continuer à tester ${RELEASE}, mais tant que vous n’aurez pas redémarré votre ordinateur, tout changement effectué ou document créé ne sera pas préservé.
";
...
";
$elem["ubiquity/text/in_uefi_mode"]["descriptionde"]="Im UEFI-Modus fortfahren
";
$elem["ubiquity/text/in_uefi_mode"]["descriptionfr"]="Continuer en mode UEFI
Poursuivre en mode UEFI
";
...
Description-fr_CA.UTF-8:
 L'installation est terminée. Vous devez redémarrer l'ordinateur afin d'utiliser votre nouvelle installation.
";
...
La copie des fichiers presque terminée…
";
...
Échec lors de l'installation
 Le programme d’installation a rencontré une erreur lors de la copie des fichiers sur le disque dur :
 .
 ${ERROR}
 .
 Ceci provient d'un espace disque insuffisant pour terminer l'installation sur la partition cible. Veuillez relancer l'installeur et choisir une partition plus grande pour l'installation.
";
...
Échec lors de l'installation
 ...
 ${ERROR}
 .
 Ceci est souvent causé par un disque ou un lecteur CD/DVD défectueux. Vous pourriez nettoyer le CD/DVD, le graver à vitesse réduite ou nettoyer la lentille du lecteur CD/DVD (des trousses de nettoyage sont souvent disponibles chez les fournisseurs d'électronique).
";
...
Échec lors de l'installation
 ...
 ${ERROR}
 .
 Ceci est souvent causé par un disque dur défectueux. Vous pourriez vérifier si le disque dur est ancien et nécessite  un remplacement ou déplacer le système dans un environnement plus frais.
";
...
Échec lors de l'installation
 ...
 ${ERROR}
 .
 Ceci est souvent causé par un disque ou un lecteur CD/DVD défectueux ou un disque dur défectueux. Vous pourriez essayer de nettoyer le CD/DVD, de le graver à vitesse réduite, de nettoyer la lentille du lecteur CD/DVD (des trousses de nettoyage sont souvent disponibles chez les fournisseurs d'électronique), vérifier si le disque dur est ancien et nécessite un remplacement, ou déplacer votre système dans un environnement plus frais.
";
...
$elem["ubiquity/install/copying_error/md5"]["descriptionfr"]="L’installation a échoué
 ...
 Ceci est souvent causé par un disque ou un lecteur CD/DVD défectueux ou un disque dur défectueux. Vous pouvez essayer de nettoyer le CD/DVD, de le graver à vitesse réduite ou de nettoyer la lentille du lecteur CD/DVD (des trousses de nettoyage sont souvent disponibles dans des magasins d'électronique). Il peut aussi être utile de vérifier l'âge du disque dur et d'envisager un éventuel remplacement, ou de déplacer votre système dans un environnement plus frais.
Échec lors de l'installation
 Le fichier suivant ne correspond pas à sa copie originale sur le CD/DVD :
 .
 ${FILE}
 .
 Ceci est souvent causé par un disque ou un lecteur CD/DVD défectueux ou un disque dur défectueux. Vous pourriez essayer de nettoyer le CD/DVD, de le graver à vitesse réduite, de nettoyer la lentille du lecteur CD/DVD (des trousses de nettoyage sont souvent disponibles chez les fournisseurs d'électronique), vérifier si le disque dur est ancien et nécessite un remplacement, ou déplacer votre système dans un environnement plus frais.
...
";
$elem["ubiquity/install/log_files"]["descriptionfr"]="Copie des journaux de l'installation...
...
Configuration des paramètres régionaux et linguistiques…
";
...
";
$elem["ubiquity/install/hardware"]["descriptionde"]="Geräte werden eingerichtet …
";
...
";
$elem["ubiquity/install/nonfree"]["descriptionde"]="Drittanbieterprogramme werden installiert …
";
...
";
$elem["ubiquity/install/bootloader"]["descriptionfr"]="Configuration du chargeur de démarrage...
...
Restauration des paquets précédemment installés…
";
...
";
$elem["ubiquity/install/installing"]["descriptionfr"]="Installation des paquets additionnels...
...
Téléchargement des paquets (${TIME} restant)…
";
...
";
$elem["ubiquity/install/apt_indices"]["descriptionfr"]="Téléchargement de la liste des paquets (${TIME} restant)...
...
Erreur lors de l’installation de paquets
 Une erreur est survenue lors de l’installation de paquets
 .
 ${ERROR}
 .
 Les paquets suivants sont brisés :
 .
 ${PACKAGES}
 .
 Ceci peut être causé par l'utilisation d'une ancienne image de l'installeur, ou par à un bogue dans certains paquets listés ci-dessus. De plus amples détails peuvent être trouvés dans /var/log/syslog. L'installeur essayera de continuer malgré tout, mais pourra échouer plus tard sans pouvoir installer ou supprimer d'autre paquets (possiblement lui-même inclus) du système installé. Vous devriez d'abord chercher de nouvelles versions de votre image de l'installeur, ou si cela échoue, signaler le problème à votre distributeur.
";
...
$elem["ubiquity/install/broken_remove"]["descriptionfr"]="Erreur lors de la suppression des paquets
 ...
 .
 Ceci peut être dû à l’utilisation d’une ancienne image du programme d'installation, ou bien à un bogue dans certains paquets listés ci-dessus. De plus amples renseignements se trouvent dans /var/log/syslog. Le programme d'installation va essayer de poursuivre malgré tout, mais il peut échouer à une étape ultérieure et il ne pourra pas installer ou supprimer d’autres paquets (y compris lui-même probablement) du système installé. Vous devriez d’abord chercher une version plus récente de l’image de l’installateur, ou le cas échéant, signaler ce problème à votre revendeur.
Erreur lors de la suppression de paquets
 Une erreur est survenue lors de la suppression de paquets :
 .
 ${ERROR}
 .
 Les paquets suivants sont brisés :
...
Erreur lors de la copie de la configuration du réseau
 Une erreur est survenue lors de la copie de la configuration du réseau. L’installation va continuer mais la configuration du réseau devra être refaite sur le système installé.
";
...
Erreur lors de la copie de la configuration bluetooth
 Une erreur est survenue lors de la copie des paramètres bluetooth. L’installation va continuer mais la configuration de bluetooth devra être refaite sur le système installé.
";
...
Erreur lors de la restauration des applications installées
 Une erreur s’est produite lors de la restauration des applications précédemment installées. L’installation va continuer mais il vous faudra peut-être réinstaller certains logiciels manuellement après le redémarrage de l’ordinateur.
";
...
Calcul des fichiers à ne pas copier ...
";
...
Échec lors du démontage de partitions
 Le programme d’installation doit enregistrer des changements aux tables de partitions, mais ne peut pas le faire, car les points de montage suivants ne peuvent pas être démontés :
 .
 ${MOUNTED}
 .
 Veuillez fermer toute application utilisant ces points de montage.
 .
 Souhaitez-vous que le programme d’installation ressaie de démonter ces partitions?
";
...
Voulez-vous revenir au partitionneur?
 Certaines des partitions que vous avez créées sont trop petites. Veuillez vous assurer que les partitions suivantes aient au moins cette taille :
 .
 ${PARTITIONS}
 .
 Si vous ne revenez pas au partitionneur et augmenter la taille de ces partitions, l’installation pourrait échouer.
";
...
";
$elem["ubiquity/text/tasks_heading_label"]["descriptionde"]="Programmauswahl
";
...
$elem["ubiquity/text/breadcrumb_prepare"]["description"]="Software
";
$elem["ubiquity/text/breadcrumb_prepare"]["descriptionde"]="Software
";
$elem["ubiquity/text/breadcrumb_prepare"]["descriptionfr"]="Logiciel
Logiciels
";
...
";
$elem["ubiquity/text/checking_for_installer_updates"]["descriptionfr"]="Recherche de mises à jour pour le programme d'installation
Recherche de mises à jour du programme d’installation
";
...
$elem["ubiquity/text/error_updating_installer"]["descriptionde"]="Fehler beim Aktualisieren des Installationsprogramms
 ...
 ${ERROR}
";
$elem["ubiquity/text/error_updating_installer"]["descriptionfr"]="Erreur lors de la mise à jour du programme d'installation
...
Erreur lors de la mise à jour du programme d’installation
 Le programme d'installation a rencontré une erreur en essayant de se mettre à jour :
 .
 ${ERROR}
";
...
Description-fr_CA.UTF-8:
 Veuillez choisir la langue à utiliser pour le processus d'installation. Elle sera la langue par défaut de cet ordinateur.
";
...
Description-fr_CA.UTF-8:
 Veuillez choisir la langue utilisée pour le processus de configuration. Elle sera la langue par défaut de cet ordinateur.
";
...
L'installation a échoué
 L'installateur a rencontré une erreur irrécupérable. Une session de bureau va maintenant vous permettre d'étudier le problème ou ressayer l’installation.
";
...
$elem["ubiquity/text/prepare_heading_label"]["description"]="Updates and other software
";
$elem["ubiquity/text/prepare_heading_label"]["descriptionde"]="Aktualisierungen und andere Software
";
$elem["ubiquity/text/prepare_heading_label"]["descriptionfr"]="Mises à jour et autres logiciels
...
Description-fr_CA.UTF-8:
 Connecter cet ordinateur à un réseau Wi-Fi vous permet d’installer des logiciels tiers, de télécharger des mises à jour, de détecter automatiquement votre fuseau horaire et d’installer la prise en charge complète de votre langue.
";
...
Description-fr_CA.UTF-8:
 Je ne veux pas me connecter tout de suite à un réseau Wi-Fi
";
...
$elem["ubiquity/install_oem"]["type"]="boolean";
$elem["ubiquity/install_oem"]["description"]="for internal use; can be preseeded
 Install hardware enablement packages for this device, if available.

";
$elem["ubiquity/install_oem"]["descriptionde"]="";
$elem["ubiquity/install_oem"]["descriptionfr"]="";
$elem["ubiquity/install_oem"]["default"]="true";
...
$elem["ubiquity/download_updates"]["default"]="true";
$elem["ubiquity/minimal_install"]["type"]="boolean";
$elem["ubiquity/minimal_install"]["description"]="for internal use; can be preseeded
 Only a minimal set of package(s) will be installed when the minimal installation
 checkbox is selected.

";
$elem["ubiquity/minimal_install"]["descriptionde"]="";
$elem["ubiquity/minimal_install"]["descriptionfr"]="";
$elem["ubiquity/minimal_install"]["default"]="false";
...
Allouer de l'espace disque en déplaçant le séparateur ci-dessous :
";
...
Description-fr_CA.UTF-8:
 <small>%d partitions plus petites sont cachées. Utiliser <a href=\"\">l’outil avancé de partitionnement</a> pour plus de contrôle</small>
";
...
Description-fr_CA.UTF-8:
 <small>1 partition plus petite est cachée. Utiliser <a href=\"\">l’outil avancé de partitionnement</a> pour plus de contrôle</small>
";
...
Description-fr_CA.UTF-8:
 %d partitions seront supprimées. Utiliser <a href=\"\">l’outil avancé de partitionnement </a> pour plus d’options
";
...
Description-fr_CA.UTF-8:
 1 partition sera supprimée. Utiliser <a href=\"\">l’outil avancé de partitionnement </a> pour plus d’options
";
...
$elem["ubiquity/text/sorry"]["description"]="Description:
 Sorry
";
$elem["ubiquity/text/sorry"]["descriptionde"]="Description-de.UTF-8:
 Entschuldigung
";
$elem["ubiquity/text/sorry"]["descriptionfr"]="Description-fr.UTF-8:
 Désolé
Description-fr_CA.UTF-8:
 Désolé
";
$elem["ubiquity/text/sorry"]["default"]="";
$elem["ubiquity/text/rst_header"]["type"]="text";
$elem["ubiquity/text/rst_header"]["description"]="Turn off RST

";
$elem["ubiquity/text/rst_header"]["descriptionde"]="";
$elem["ubiquity/text/rst_header"]["descriptionfr"]="";
$elem["ubiquity/text/rst_header"]["default"]="";
$elem["ubiquity/text/label_using_rst"]["type"]="text";
$elem["ubiquity/text/label_using_rst"]["description"]="This computer uses Intel RST (Rapid Storage Technology). You need to turn off RST before installing Ubuntu. For instructions, open this page on a phone or other device: <a href=\"https://help.ubuntu.com/rst\">help.ubuntu.com/rst</a>

";
$elem["ubiquity/text/label_using_rst"]["descriptionde"]="";
$elem["ubiquity/text/label_using_rst"]["descriptionfr"]="";
$elem["ubiquity/text/label_using_rst"]["default"]="";
$elem["ubiquity/text/bitlocker_header"]["type"]="text";
$elem["ubiquity/text/bitlocker_header"]["description"]="Turn off BitLocker

";
$elem["ubiquity/text/bitlocker_header"]["descriptionde"]="";
$elem["ubiquity/text/bitlocker_header"]["descriptionfr"]="";
$elem["ubiquity/text/bitlocker_header"]["default"]="";
$elem["ubiquity/text/label_using_bitlocker"]["type"]="text";
$elem["ubiquity/text/label_using_bitlocker"]["description"]="This computer uses Windows BitLocker encryption. You need to turn off BitLocker in Windows before installing Ubuntu. For instructions, open this page on a phone or other device: <a href=\"https://help.ubuntu.com/bitlocker\">help.ubuntu.com/bitlocker</a>

";
$elem["ubiquity/text/label_using_bitlocker"]["descriptionde"]="";
$elem["ubiquity/text/label_using_bitlocker"]["descriptionfr"]="";
$elem["ubiquity/text/label_using_bitlocker"]["default"]="";
...
";
$elem["ubiquity/text/required_space"]["descriptionde"]="Sie benötigen mindestens ${SIZE} Speicherplatz, um ${RELEASE} zu installieren.
";
$elem["ubiquity/text/required_space"]["descriptionfr"]="Vous avez besoin d'au moins ${SIZE} d'espace disponible pour installer ${RELEASE}.
Il vous faut au moins ${SIZE} d'espace disque libre pour installer ${RELEASE}.
";
...
";
$elem["ubiquity/text/free_space"]["descriptionde"]="Dieser Rechner hat nur ${SIZE}.
";
$elem["ubiquity/text/free_space"]["descriptionfr"]="Cet ordinateur ne possède que ${SIZE}.
L'ordinateur n'en a que ${SIZE}.
";
...
$elem["ubiquity/text/prepare_foss_disclaimer"]["descriptionde"]="Description-de.UTF-8:
 Dieses Programm unterliegt bestimmten Lizenzbedingungen, welche in seiner Dokumentation mitgeliefert werden. Ein Teil davon ist proprietär.
";
...
Description-fr_CA.UTF-8:
 Ces logiciels sont soumis aux conditions de licence incluses dans leurs documentations. Certains sont propriétaires.
";
...
Description-fr_CA.UTF-8:
 Installer un logiciel tiers pour le matériel graphique et Wi-Fi, ainsi que des formats de médias supplémentaires
";
...
";
$elem["ubiquity/text/label_download_updates"]["descriptionde"]="Description-de.UTF-8:
 Das spart Zeit nach der Installation.
";
$elem["ubiquity/text/label_download_updates"]["descriptionfr"]="Description-fr.UTF-8:
 Ceci fait gagner du temps après l'installation.
Description-fr_CA.UTF-8:
 Cela fait gagner du temps après l'installation.
";
...
";
$elem["ubiquity/text/label_download_updates_na"]["descriptionde"]="Description-de.UTF-8:
 Nicht verfügbar. Es besteht keine Internetverbindung.
";
$elem["ubiquity/text/label_download_updates_na"]["descriptionfr"]="Description-fr.UTF-8:
 Indisponible car il n'y a pas de connexion Internet.
Description-fr_CA.UTF-8:
 N'est pas proposé car il n'y a pas de connexion Internet
";
$elem["ubiquity/text/label_download_updates_na"]["default"]="";
$elem["ubiquity/text/minimal_install_header"]["type"]="text";
$elem["ubiquity/text/minimal_install_header"]["description"]="Description:
 What apps would you like to install to start with?
";
$elem["ubiquity/text/minimal_install_header"]["descriptionde"]="Description-de.UTF-8:
 Welche Anwendungen möchten Sie am Anfang installieren?
";
$elem["ubiquity/text/minimal_install_header"]["descriptionfr"]="Description-fr.UTF-8:
 Quelles applications souhaitez-vous installer pour commencer ?
Description-fr_CA.UTF-8:
 Quelles applis souhaitez-vous installer pour commencer ?
";
$elem["ubiquity/text/minimal_install_header"]["default"]="";
$elem["ubiquity/text/qt_minimal_install_header"]["type"]="text";
$elem["ubiquity/text/qt_minimal_install_header"]["description"]="Description:
 Which applications would you like to start with?
";
$elem["ubiquity/text/qt_minimal_install_header"]["descriptionde"]="Description-de.UTF-8:
 Mit welchen Anwendungen möchten Sie starten?
";
$elem["ubiquity/text/qt_minimal_install_header"]["descriptionfr"]="Description-fr.UTF-8:
 Avec quelles applications aimeriez-vous commencer ?
Description-fr_CA.UTF-8:
 Avec quelles applications souhaitez-vous commencer ?
";
$elem["ubiquity/text/qt_minimal_install_header"]["default"]="";
$elem["ubiquity/text/prepare_minimal_install"]["type"]="text";
$elem["ubiquity/text/prepare_minimal_install"]["description"]="Description:
 Minimal installation
";
$elem["ubiquity/text/prepare_minimal_install"]["descriptionde"]="Description-de.UTF-8:
 Minimale Installation
";
$elem["ubiquity/text/prepare_minimal_install"]["descriptionfr"]="Description-fr.UTF-8:
 Installation minimale
Description-fr_CA.UTF-8:
 Installation minimale
";
$elem["ubiquity/text/prepare_minimal_install"]["default"]="";
$elem["ubiquity/text/label_minimal_install"]["type"]="text";
$elem["ubiquity/text/label_minimal_install"]["description"]="Description:
 Web browser and basic utilities.
";
$elem["ubiquity/text/label_minimal_install"]["descriptionde"]="Description-de.UTF-8:
 Webbrowser und grundlegende Dienstprogramme.
";
$elem["ubiquity/text/label_minimal_install"]["descriptionfr"]="Description-fr.UTF-8:
 Navigateur web et utilitaires de base.
Description-fr_CA.UTF-8:
 Navigateur Web et utilitaires de base.
";
$elem["ubiquity/text/label_minimal_install"]["default"]="";
$elem["ubiquity/text/qt_label_minimal_install"]["type"]="text";
$elem["ubiquity/text/qt_label_minimal_install"]["description"]="Description:
 Web browser plus basic utilities and applications.
";
$elem["ubiquity/text/qt_label_minimal_install"]["descriptionde"]="Description-de.UTF-8:
 Webbrowser mit grundlegende Dienstprogramme und Anwendungen.
";
$elem["ubiquity/text/qt_label_minimal_install"]["descriptionfr"]="Description-fr.UTF-8:
 Navigateur web avec utilitaires et applications de base.
Description-fr_CA.UTF-8:
 Navigateur Web, avec utilitaires et applications de base.
";
$elem["ubiquity/text/qt_label_minimal_install"]["default"]="";
$elem["ubiquity/text/prepare_normal_install"]["type"]="text";
$elem["ubiquity/text/prepare_normal_install"]["description"]="Description:
 Normal installation
";
$elem["ubiquity/text/prepare_normal_install"]["descriptionde"]="Description-de.UTF-8:
 Normale Installation
";
$elem["ubiquity/text/prepare_normal_install"]["descriptionfr"]="Description-fr.UTF-8:
 Installation normale
Description-fr_CA.UTF-8:
 Installation normale
";
$elem["ubiquity/text/prepare_normal_install"]["default"]="";
$elem["ubiquity/text/label_normal_install"]["type"]="text";
$elem["ubiquity/text/label_normal_install"]["description"]="Description:
 Web browser, utilities, office software, games, and media players.
";
$elem["ubiquity/text/label_normal_install"]["descriptionde"]="Description-de.UTF-8:
 Webbrowser, Dienstprogramme, Büroanwendungen, Spiele und Medienspieler.
";
$elem["ubiquity/text/label_normal_install"]["descriptionfr"]="Description-fr.UTF-8:
 Navigateur web, utilitaires, logiciels de bureau, jeux et lecteurs multimédias.
Description-fr_CA.UTF-8:
 Navigateur Web, utilitaires, logiciels de bureautique, jeux et diffuseurs de médias.
";
$elem["ubiquity/text/label_normal_install"]["default"]="";
$elem["ubiquity/text/qt_label_normal_install"]["type"]="text";
$elem["ubiquity/text/qt_label_normal_install"]["description"]="Description:
 Web browser, utilities, office software, plus additional internet applications and media players.
";
$elem["ubiquity/text/qt_label_normal_install"]["descriptionde"]="Description-de.UTF-8:
 Webbrowser, Dienstprogramme, Büroanwendungen, und weitere Internetanwendungen und Medienspieler.
";
$elem["ubiquity/text/qt_label_normal_install"]["descriptionfr"]="Description-fr.UTF-8:
 Navigateur web, utilitaires, logiciel de bureau, applications Internet supplémentaires et lecteurs multimédias.
Description-fr_CA.UTF-8:
 Navigateur Web, utilitaires, logiciels bureautiques, applications Internet supplémentaires et diffuseurs de médias.
";
$elem["ubiquity/text/qt_label_normal_install"]["default"]="";
$elem["ubiquity/text/install_other_options_header"]["type"]="text";
$elem["ubiquity/text/install_other_options_header"]["description"]="Description:
 Other options
";
$elem["ubiquity/text/install_other_options_header"]["descriptionde"]="Description-de.UTF-8:
 Weitere Optionen
";
$elem["ubiquity/text/install_other_options_header"]["descriptionfr"]="Description-fr.UTF-8:
 Autres options
Description-fr_CA.UTF-8:
 Autres options
";
$elem["ubiquity/text/install_other_options_header"]["default"]="";
...
";
$elem["ubiquity/text/secureboot_label"]["descriptionde"]="Description-de.UTF-8:
 Die Installation von Treibern von Drittanbietern erfordert die Konfiguration von Secure Boot. Dazu müssen Sie jetzt einen Sicherheitsschlüssel auswählen und beim Neustart des Systems eingeben.
";
$elem["ubiquity/text/secureboot_label"]["descriptionfr"]="Description-fr.UTF-8:
...
$elem["ubiquity/text/use_zfs"]["type"]="text";
$elem["ubiquity/text/use_zfs"]["description"]="Description:
 EXPERIMENTAL: Erase disk and use ZFS
";
$elem["ubiquity/text/use_zfs"]["descriptionde"]="Description-de.UTF-8:
 EXPERIMENTAL: Festplatte löschen und ZFS verwenden
";
$elem["ubiquity/text/use_zfs"]["descriptionfr"]="Description-fr.UTF-8:
 EXPÉRIMENTAL : effacer le disque et utiliser ZFS
Description-fr_CA.UTF-8:
 EXPÉRIMENTAL : effacer le disque et utiliser ZFS
";
$elem["ubiquity/text/use_zfs"]["default"]="";
$elem["ubiquity/text/use_zfs_desc"]["type"]="text";
$elem["ubiquity/text/use_zfs_desc"]["description"]="Description:
 <span foreground=\"darkred\">Warning:</span> This will delete all your files on all operating systems.
 This is experimental and may cause data loss. Do not use on production systems.
";
$elem["ubiquity/text/use_zfs_desc"]["descriptionde"]="Description-de.UTF-8:
 <span foreground=\"darkred\">Warnung:</span> Dadurch werden alle Ihre Dateien auf allen Betriebssystemen gelöscht. Dies ist experimentell und kann zu Datenverlust führen. Nicht auf Produktionssystemen verwenden.
";
$elem["ubiquity/text/use_zfs_desc"]["descriptionfr"]="Description-fr.UTF-8:
...
";
$elem["ubiquity/text/use_zfs_desc"]["default"]="";
$elem["ubiquity/use_zfs"]["type"]="boolean";
$elem["ubiquity/use_zfs"]["description"]="for internal use; can be preseeded
 This will set up ZFS and configure it for zsys.

";
$elem["ubiquity/use_zfs"]["descriptionde"]="";
$elem["ubiquity/use_zfs"]["descriptionfr"]="";
$elem["ubiquity/use_zfs"]["default"]="false";
$elem["ubiquity/text/advanced_features_dialog"]["type"]="text";
$elem["ubiquity/text/advanced_features_dialog"]["description"]="Advanced Features
";
$elem["ubiquity/text/advanced_features_dialog"]["descriptionde"]="Erweiterte Funktionen
";
$elem["ubiquity/text/advanced_features_dialog"]["descriptionfr"]="Fonctions avancées
Fonctions avancées
";
$elem["ubiquity/text/advanced_features_dialog"]["default"]="";
$elem["ubiquity/text/advanced_features_radio_none"]["type"]="text";
$elem["ubiquity/text/advanced_features_radio_none"]["description"]="None
";
$elem["ubiquity/text/advanced_features_radio_none"]["descriptionde"]="Keine
";
$elem["ubiquity/text/advanced_features_radio_none"]["descriptionfr"]="Aucune
Aucune
";
$elem["ubiquity/text/advanced_features_radio_none"]["default"]="";
$elem["ubiquity/text/advanced_features_desc"]["type"]="text";
$elem["ubiquity/text/advanced_features_desc"]["description"]="None selected
";
$elem["ubiquity/text/advanced_features_desc"]["descriptionde"]="Keine ausgewählt
";
$elem["ubiquity/text/advanced_features_desc"]["descriptionfr"]="Aucune sélectionnée
Aucune n’a été sélectionnée
";
$elem["ubiquity/text/advanced_features_desc"]["default"]="";
$elem["ubiquity/text/advanced_features_selected"]["type"]="text";
$elem["ubiquity/text/advanced_features_selected"]["description"]="Advanced features...
";
$elem["ubiquity/text/advanced_features_selected"]["descriptionde"]="Erweiterte Funktionen …
";
$elem["ubiquity/text/advanced_features_selected"]["descriptionfr"]="Fonctions avancées…
Fonctions avancées…
";
$elem["ubiquity/text/advanced_features_selected"]["default"]="";
$elem["ubiquity/text/advanced_features_none_selected"]["type"]="text";
$elem["ubiquity/text/advanced_features_none_selected"]["description"]="None selected
";
$elem["ubiquity/text/advanced_features_none_selected"]["descriptionde"]="Keine ausgewählt
";
$elem["ubiquity/text/advanced_features_none_selected"]["descriptionfr"]="Aucune sélectionnée
Aucune n’a été sélectionnée
";
$elem["ubiquity/text/advanced_features_none_selected"]["default"]="";
$elem["ubiquity/text/advanced_features_lvm_selected"]["type"]="text";
$elem["ubiquity/text/advanced_features_lvm_selected"]["description"]="LVM selected
";
$elem["ubiquity/text/advanced_features_lvm_selected"]["descriptionde"]="LVM ausgewählt
";
$elem["ubiquity/text/advanced_features_lvm_selected"]["descriptionfr"]="LVM sélectionné
LVM est sélectionné
";
$elem["ubiquity/text/advanced_features_lvm_selected"]["default"]="";
$elem["ubiquity/text/advanced_features_crypto_selected"]["type"]="text";
$elem["ubiquity/text/advanced_features_crypto_selected"]["description"]="LVM and encryption selected
";
$elem["ubiquity/text/advanced_features_crypto_selected"]["descriptionde"]="LVM und Verschlüsselung ausgewählt
";
$elem["ubiquity/text/advanced_features_crypto_selected"]["descriptionfr"]="LVM et chiffrement sélectionnés
LVM et chiffrement sont sélectionnés
";
$elem["ubiquity/text/advanced_features_crypto_selected"]["default"]="";
$elem["ubiquity/text/advanced_features_zfs_selected"]["type"]="text";
$elem["ubiquity/text/advanced_features_zfs_selected"]["description"]="ZFS selected
";
$elem["ubiquity/text/advanced_features_zfs_selected"]["descriptionde"]="ZFS ausgewählt
";
$elem["ubiquity/text/advanced_features_zfs_selected"]["descriptionfr"]="ZFS sélectionné
ZFS est sélectionné
";
$elem["ubiquity/text/advanced_features_zfs_selected"]["default"]="";
...
Description-fr_CA.UTF-8:
 Tout fichier en dehors de ${RELEASE} ne sera pas chiffré.
Description-fr.UTF-8:
...
Description-fr_CA.UTF-8:
 LVM (gestion de volumes logiques) permet à ${RELEASE} de traiter plusieurs volumes physiques comme un seul volume.
Description-fr.UTF-8:
...
Description-fr.UTF-8:
 Secure Boot UEFI
Description-fr_CA.UTF-8:
 Amorçage sécurisé UEFI « Secure Boot »
";
...
$elem["ubiquity/text/efi_secureboot_info"]["description"]="Description:
 ...
 .
 After installation completes, Ubuntu will assist you in configuring UEFI
...
";
$elem["ubiquity/text/efi_secureboot_info"]["descriptionde"]="Description-de.UTF-8:
 Sie haben sich dafür entschieden, Drittanbietersoftware als Teil Ihrer Installation zu aktivieren, die für dieses System Hardwaretreiber für Grafiken und/oder Wi-Fi-Hardware enthält. Auf Ihrem System ist auch UEFI Secure Boot aktiviert. UEFI Secure Boot muss konfiguriert werden, um die Verwendung dieser Treiber von Drittanbietern zu ermöglichen.
 .
 Nach Abschluss der Installation unterstützt Sie Ubuntu bei der Konfiguration von UEFI Secure Boot. Um sicherzustellen, dass diese Änderung von Ihnen als autorisiertem Benutzer und nicht von einem Angreifer vorgenommen wird, müssen Sie ab und zu ein Passwort wählen und nach dem Neustart das gleiche Passwort verwenden, um die Änderung zu bestätigen.
 .
...
Description-fr_CA.UTF-8:
 ...
 .
 Une fois l’installation terminée, Ubuntu vous guidera dans la configuration du démarrage sécurisé UEFI. Pour garantir que ce changement est effectué par vous en tant qu’utilisateur autorisé et non par un assaillant, vous devez maintenant choisir un mot de passe et devrez ensuite utiliser le même mot de passe après redémarrage pour confirmer le changement.
 .
 <span foreground=\"darkred\">Avertissement</span> : si vous choisissez de ne pas installer ces pilotes ou si vous continuez mais ne confirmez pas le mot de passe lors du redémarrage, Ubuntu pourra quand même être lancé sur votre système, mais votre matériel n'aura pas accès à ces pilotes tiers.
";
...
";
$elem["ubiquity/secureboot_key"]["descriptionde"]="SecureBoot-Schlüssel für MokPW
";
$elem["ubiquity/secureboot_key"]["descriptionfr"]="Clé SecureBoot pour MokPW
Clef « SecureBoot » de MokPW
";
$elem["ubiquity/secureboot_key"]["default"]="";
$elem["ubiquity/text/partman_confirm_zfs"]["type"]="text";
$elem["ubiquity/text/partman_confirm_zfs"]["description"]="Description:
 partition #%(partid)s as %(parttype)s used for %(partusage)s
";
$elem["ubiquity/text/partman_confirm_zfs"]["descriptionde"]="Description-de.UTF-8:
 Partition #%(partid)s als %(parttype)s benutzt für %(partusage)s
";
$elem["ubiquity/text/partman_confirm_zfs"]["descriptionfr"]="Description-fr.UTF-8:
 partition #%(partid)s en tant que %(parttype)s utilisée pour %(partusage)s
Description-fr_CA.UTF-8:
 partition no %(partid)s en tant que %(parttype)s utilisée pour %(partusage)s
";
$elem["ubiquity/text/partman_confirm_zfs"]["default"]="";
...
$elem["base-installer/kernel/linux/link_in_boot"]["default"]="true";
...
";
$elem["apt-setup/progress/backports"]["descriptionde"]="Durchsuchen des Archivs für rückportierte Software (Backports) ...
";
$elem["apt-setup/progress/backports"]["descriptionfr"]="Analyse du dépôt des logiciels rétroportés...
";
...
$elem["apt-setup/services-select"]["choicesde"][2]="Release-Updates";
$elem["apt-setup/services-select"]["choicesfr"][1]="mises à jour de sécurité (${SEC_HOST})";
$elem["apt-setup/services-select"]["choicesfr"][2]="mises à jour de la publication";
...
$elem["apt-setup/services-select"]["descriptionde"]="Zu verwendende Dienste:
 Debian hat zwei Dienste, die Aktualisierungen für Veröffentlichungen bereitstellen: Security und Release-Updates.
 .
...
$elem["apt-setup/multiarch"]["default"]="i386";
...
$elem["mirror/suite"]["default"]="focal";
...
$elem["mirror/bad"]["descriptionde"]="Ungültiger Archiv-Spiegel
 ...
 einen anderen.
";
$elem["mirror/bad"]["descriptionfr"]="Miroir de l'archive Debian corrompu
...
$elem["mirror/http/countries"]["choices"][39]="Cabo Verde";
$elem["mirror/http/countries"]["choices"][40]="Cambodia";
$elem["mirror/http/countries"]["choices"][41]="Cameroon";
$elem["mirror/http/countries"]["choices"][42]="Canada";
...
$elem["mirror/http/countries"]["choices"][61]="Czechia";
...
$elem["mirror/http/countries"]["choices"][73]="Eswatini";
$elem["mirror/http/countries"]["choices"][74]="Ethiopia";
$elem["mirror/http/countries"]["choices"][75]="Falkland Islands (Malvinas)";
$elem["mirror/http/countries"]["choices"][76]="Faroe Islands";
$elem["mirror/http/countries"]["choices"][77]="Fiji";
$elem["mirror/http/countries"]["choices"][78]="Finland";
$elem["mirror/http/countries"]["choices"][79]="France";
$elem["mirror/http/countries"]["choices"][80]="French Guiana";
$elem["mirror/http/countries"]["choices"][81]="French Polynesia";
$elem["mirror/http/countries"]["choices"][82]="French Southern Territories";
$elem["mirror/http/countries"]["choices"][83]="Gabon";
$elem["mirror/http/countries"]["choices"][84]="Gambia";
$elem["mirror/http/countries"]["choices"][85]="Georgia";
$elem["mirror/http/countries"]["choices"][86]="Germany";
$elem["mirror/http/countries"]["choices"][87]="Ghana";
$elem["mirror/http/countries"]["choices"][88]="Gibraltar";
$elem["mirror/http/countries"]["choices"][89]="Greece";
$elem["mirror/http/countries"]["choices"][90]="Greenland";
$elem["mirror/http/countries"]["choices"][91]="Grenada";
$elem["mirror/http/countries"]["choices"][92]="Guadeloupe";
$elem["mirror/http/countries"]["choices"][93]="Guam";
$elem["mirror/http/countries"]["choices"][94]="Guatemala";
$elem["mirror/http/countries"]["choices"][95]="Guernsey";
$elem["mirror/http/countries"]["choices"][96]="Guinea";
$elem["mirror/http/countries"]["choices"][97]="Guinea-Bissau";
$elem["mirror/http/countries"]["choices"][98]="Guyana";
$elem["mirror/http/countries"]["choices"][99]="Haiti";
$elem["mirror/http/countries"]["choices"][100]="Heard Island and McDonald Islands";
$elem["mirror/http/countries"]["choices"][101]="Holy See (Vatican City State)";
$elem["mirror/http/countries"]["choices"][102]="Honduras";
$elem["mirror/http/countries"]["choices"][103]="Hong Kong";
$elem["mirror/http/countries"]["choices"][104]="Hungary";
$elem["mirror/http/countries"]["choices"][105]="Iceland";
$elem["mirror/http/countries"]["choices"][106]="India";
$elem["mirror/http/countries"]["choices"][107]="Indonesia";
$elem["mirror/http/countries"]["choices"][108]="Iran\";
$elem["mirror/http/countries"]["choices"][109]="Islamic Republic of";
$elem["mirror/http/countries"]["choices"][110]="Iraq";
$elem["mirror/http/countries"]["choices"][111]="Ireland";
$elem["mirror/http/countries"]["choices"][112]="Isle of Man";
$elem["mirror/http/countries"]["choices"][113]="Israel";
$elem["mirror/http/countries"]["choices"][114]="Italy";
$elem["mirror/http/countries"]["choices"][115]="Jamaica";
$elem["mirror/http/countries"]["choices"][116]="Japan";
$elem["mirror/http/countries"]["choices"][117]="Jersey";
$elem["mirror/http/countries"]["choices"][118]="Jordan";
$elem["mirror/http/countries"]["choices"][119]="Kazakhstan";
$elem["mirror/http/countries"]["choices"][120]="Kenya";
$elem["mirror/http/countries"]["choices"][121]="Kiribati";
$elem["mirror/http/countries"]["choices"][122]="Korea\";
$elem["mirror/http/countries"]["choices"][123]="Democratic People's Republic of";
$elem["mirror/http/countries"]["choices"][124]="Korea\";
$elem["mirror/http/countries"]["choices"][125]="Republic of";
$elem["mirror/http/countries"]["choices"][126]="Kuwait";
$elem["mirror/http/countries"]["choices"][127]="Kyrgyzstan";
$elem["mirror/http/countries"]["choices"][128]="Lao People's Democratic Republic";
$elem["mirror/http/countries"]["choices"][129]="Latvia";
$elem["mirror/http/countries"]["choices"][130]="Lebanon";
$elem["mirror/http/countries"]["choices"][131]="Lesotho";
$elem["mirror/http/countries"]["choices"][132]="Liberia";
$elem["mirror/http/countries"]["choices"][133]="Libya";
$elem["mirror/http/countries"]["choices"][134]="Liechtenstein";
$elem["mirror/http/countries"]["choices"][135]="Lithuania";
$elem["mirror/http/countries"]["choices"][136]="Luxembourg";
$elem["mirror/http/countries"]["choices"][137]="Macao";
$elem["mirror/http/countries"]["choices"][138]="Madagascar";
$elem["mirror/http/countries"]["choices"][139]="Malawi";
$elem["mirror/http/countries"]["choices"][140]="Malaysia";
$elem["mirror/http/countries"]["choices"][141]="Maldives";
$elem["mirror/http/countries"]["choices"][142]="Mali";
$elem["mirror/http/countries"]["choices"][143]="Malta";
$elem["mirror/http/countries"]["choices"][144]="Marshall Islands";
$elem["mirror/http/countries"]["choices"][145]="Martinique";
$elem["mirror/http/countries"]["choices"][146]="Mauritania";
$elem["mirror/http/countries"]["choices"][147]="Mauritius";
$elem["mirror/http/countries"]["choices"][148]="Mayotte";
$elem["mirror/http/countries"]["choices"][149]="Mexico";
$elem["mirror/http/countries"]["choices"][150]="Micronesia\";
$elem["mirror/http/countries"]["choices"][151]="Federated States of";
$elem["mirror/http/countries"]["choices"][152]="Moldova";
$elem["mirror/http/countries"]["choices"][153]="Monaco";
$elem["mirror/http/countries"]["choices"][154]="Mongolia";
$elem["mirror/http/countries"]["choices"][155]="Montenegro";
$elem["mirror/http/countries"]["choices"][156]="Montserrat";
$elem["mirror/http/countries"]["choices"][157]="Morocco";
$elem["mirror/http/countries"]["choices"][158]="Mozambique";
$elem["mirror/http/countries"]["choices"][159]="Myanmar";
$elem["mirror/http/countries"]["choices"][160]="Namibia";
$elem["mirror/http/countries"]["choices"][161]="Nauru";
$elem["mirror/http/countries"]["choices"][162]="Nepal";
$elem["mirror/http/countries"]["choices"][163]="Netherlands";
$elem["mirror/http/countries"]["choices"][164]="New Caledonia";
$elem["mirror/http/countries"]["choices"][165]="New Zealand";
$elem["mirror/http/countries"]["choices"][166]="Nicaragua";
$elem["mirror/http/countries"]["choices"][167]="Niger";
$elem["mirror/http/countries"]["choices"][168]="Nigeria";
$elem["mirror/http/countries"]["choices"][169]="Niue";
$elem["mirror/http/countries"]["choices"][170]="Norfolk Island";
$elem["mirror/http/countries"]["choices"][171]="North Macedonia";
...
$elem["mirror/http/countries"]["choices"][223]="Sweden";
$elem["mirror/http/countries"]["choices"][224]="Switzerland";
$elem["mirror/http/countries"]["choices"][225]="Syrian Arab Republic";
$elem["mirror/http/countries"]["choices"][226]="Taiwan";
$elem["mirror/http/countries"]["choices"][227]="Tajikistan";
$elem["mirror/http/countries"]["choices"][228]="Tanzania";
$elem["mirror/http/countries"]["choices"][229]="Thailand";
$elem["mirror/http/countries"]["choices"][230]="Timor-Leste";
$elem["mirror/http/countries"]["choices"][231]="Togo";
$elem["mirror/http/countries"]["choices"][232]="Tokelau";
$elem["mirror/http/countries"]["choices"][233]="Tonga";
$elem["mirror/http/countries"]["choices"][234]="Trinidad and Tobago";
$elem["mirror/http/countries"]["choices"][235]="Tunisia";
$elem["mirror/http/countries"]["choices"][236]="Turkey";
$elem["mirror/http/countries"]["choices"][237]="Turkmenistan";
$elem["mirror/http/countries"]["choices"][238]="Turks and Caicos Islands";
$elem["mirror/http/countries"]["choices"][239]="Tuvalu";
$elem["mirror/http/countries"]["choices"][240]="Uganda";
$elem["mirror/http/countries"]["choices"][241]="Ukraine";
$elem["mirror/http/countries"]["choices"][242]="United Arab Emirates";
$elem["mirror/http/countries"]["choices"][243]="United Kingdom";
$elem["mirror/http/countries"]["choices"][244]="United States";
$elem["mirror/http/countries"]["choices"][245]="United States Minor Outlying Islands";
$elem["mirror/http/countries"]["choices"][246]="Uruguay";
$elem["mirror/http/countries"]["choices"][247]="Uzbekistan";
$elem["mirror/http/countries"]["choices"][248]="Vanuatu";
$elem["mirror/http/countries"]["choices"][249]="Venezuela";
$elem["mirror/http/countries"]["choices"][250]="Vietnam";
$elem["mirror/http/countries"]["choices"][251]="Virgin Islands\";
$elem["mirror/http/countries"]["choices"][252]="British";
$elem["mirror/http/countries"]["choices"][253]="Virgin Islands\";
$elem["mirror/http/countries"]["choices"][254]="U.S.";
$elem["mirror/http/countries"]["choices"][255]="Wallis and Futuna";
$elem["mirror/http/countries"]["choices"][256]="Western Sahara";
$elem["mirror/http/countries"]["choices"][257]="Yemen";
$elem["mirror/http/countries"]["choices"][258]="Zambia";
$elem["mirror/http/countries"]["choices"][259]="Zimbabwe";
...
$elem["mirror/http/countries"]["choicesde"][39]="Cabo Verde";
$elem["mirror/http/countries"]["choicesde"][40]="Kambodscha";
$elem["mirror/http/countries"]["choicesde"][41]="Kamerun";
$elem["mirror/http/countries"]["choicesde"][42]="Kanada";
...
$elem["mirror/http/countries"]["choicesde"][60]="Tschechien";
...
$elem["mirror/http/countries"]["choicesde"][72]="Eswatini";
$elem["mirror/http/countries"]["choicesde"][73]="Äthiopien";
$elem["mirror/http/countries"]["choicesde"][74]="Falklandinseln (Malwinen)";
$elem["mirror/http/countries"]["choicesde"][75]="Färöer-Inseln";
$elem["mirror/http/countries"]["choicesde"][76]="Fidschi";
$elem["mirror/http/countries"]["choicesde"][77]="Finnland";
$elem["mirror/http/countries"]["choicesde"][78]="Frankreich";
$elem["mirror/http/countries"]["choicesde"][79]="Französisch-Guyana";
$elem["mirror/http/countries"]["choicesde"][80]="Französisch-Polynesien";
$elem["mirror/http/countries"]["choicesde"][81]="Französische Süd- und Antarktisgebiete";
$elem["mirror/http/countries"]["choicesde"][82]="Gabun";
$elem["mirror/http/countries"]["choicesde"][83]="Gambia";
$elem["mirror/http/countries"]["choicesde"][84]="Georgien";
$elem["mirror/http/countries"]["choicesde"][85]="Deutschland";
$elem["mirror/http/countries"]["choicesde"][86]="Ghana";
$elem["mirror/http/countries"]["choicesde"][87]="Gibraltar";
$elem["mirror/http/countries"]["choicesde"][88]="Griechenland";
$elem["mirror/http/countries"]["choicesde"][89]="Grönland";
$elem["mirror/http/countries"]["choicesde"][90]="Grenada";
$elem["mirror/http/countries"]["choicesde"][91]="Guadeloupe";
$elem["mirror/http/countries"]["choicesde"][92]="Guam";
$elem["mirror/http/countries"]["choicesde"][93]="Guatemala";
$elem["mirror/http/countries"]["choicesde"][94]="Guernsey";
$elem["mirror/http/countries"]["choicesde"][95]="Guinea";
$elem["mirror/http/countries"]["choicesde"][96]="Guinea-Bissau";
$elem["mirror/http/countries"]["choicesde"][97]="Guyana";
$elem["mirror/http/countries"]["choicesde"][98]="Haiti";
$elem["mirror/http/countries"]["choicesde"][99]="Heard und McDonaldinseln";
$elem["mirror/http/countries"]["choicesde"][100]="Heiliger Stuhl (Staat Vatikanstadt)";
$elem["mirror/http/countries"]["choicesde"][101]="Honduras";
$elem["mirror/http/countries"]["choicesde"][102]="Hongkong";
$elem["mirror/http/countries"]["choicesde"][103]="Ungarn";
$elem["mirror/http/countries"]["choicesde"][104]="Island";
$elem["mirror/http/countries"]["choicesde"][105]="Indien";
$elem["mirror/http/countries"]["choicesde"][106]="Indonesien";
$elem["mirror/http/countries"]["choicesde"][107]="Iran\";
$elem["mirror/http/countries"]["choicesde"][108]="Islamische Republik";
$elem["mirror/http/countries"]["choicesde"][109]="Irak";
$elem["mirror/http/countries"]["choicesde"][110]="Irland";
$elem["mirror/http/countries"]["choicesde"][111]="Insel Man";
$elem["mirror/http/countries"]["choicesde"][112]="Israel";
$elem["mirror/http/countries"]["choicesde"][113]="Italien";
$elem["mirror/http/countries"]["choicesde"][114]="Jamaika";
$elem["mirror/http/countries"]["choicesde"][115]="Japan";
$elem["mirror/http/countries"]["choicesde"][116]="Jersey";
$elem["mirror/http/countries"]["choicesde"][117]="Jordanien";
$elem["mirror/http/countries"]["choicesde"][118]="Kasachstan";
$elem["mirror/http/countries"]["choicesde"][119]="Kenia";
$elem["mirror/http/countries"]["choicesde"][120]="Kiribati";
$elem["mirror/http/countries"]["choicesde"][121]="Korea\";
$elem["mirror/http/countries"]["choicesde"][122]="Demokratische Volksrepublik";
$elem["mirror/http/countries"]["choicesde"][123]="Korea\";
$elem["mirror/http/countries"]["choicesde"][124]="Republik";
$elem["mirror/http/countries"]["choicesde"][125]="Kuwait";
$elem["mirror/http/countries"]["choicesde"][126]="Kirgisistan";
$elem["mirror/http/countries"]["choicesde"][127]="Laos\";
$elem["mirror/http/countries"]["choicesde"][128]="Demokratische Volksrepublik";
$elem["mirror/http/countries"]["choicesde"][129]="Lettland";
$elem["mirror/http/countries"]["choicesde"][130]="Libanon";
$elem["mirror/http/countries"]["choicesde"][131]="Lesotho";
$elem["mirror/http/countries"]["choicesde"][132]="Liberia";
$elem["mirror/http/countries"]["choicesde"][133]="Libyen";
$elem["mirror/http/countries"]["choicesde"][134]="Liechtenstein";
$elem["mirror/http/countries"]["choicesde"][135]="Litauen";
$elem["mirror/http/countries"]["choicesde"][136]="Luxemburg";
$elem["mirror/http/countries"]["choicesde"][137]="Macao";
$elem["mirror/http/countries"]["choicesde"][138]="Madagaskar";
$elem["mirror/http/countries"]["choicesde"][139]="Malawi";
$elem["mirror/http/countries"]["choicesde"][140]="Malaysia";
$elem["mirror/http/countries"]["choicesde"][141]="Malediven";
$elem["mirror/http/countries"]["choicesde"][142]="Mali";
$elem["mirror/http/countries"]["choicesde"][143]="Malta";
$elem["mirror/http/countries"]["choicesde"][144]="Marshallinseln";
$elem["mirror/http/countries"]["choicesde"][145]="Martinique";
$elem["mirror/http/countries"]["choicesde"][146]="Mauretanien";
$elem["mirror/http/countries"]["choicesde"][147]="Mauritius";
$elem["mirror/http/countries"]["choicesde"][148]="Mayotte";
$elem["mirror/http/countries"]["choicesde"][149]="Mexiko";
$elem["mirror/http/countries"]["choicesde"][150]="Mikronesien\";
$elem["mirror/http/countries"]["choicesde"][151]="Föderierte Staaten von";
$elem["mirror/http/countries"]["choicesde"][152]="Moldau";
$elem["mirror/http/countries"]["choicesde"][153]="Monaco";
$elem["mirror/http/countries"]["choicesde"][154]="Mongolei";
$elem["mirror/http/countries"]["choicesde"][155]="Montenegro";
$elem["mirror/http/countries"]["choicesde"][156]="Montserrat";
$elem["mirror/http/countries"]["choicesde"][157]="Marokko";
$elem["mirror/http/countries"]["choicesde"][158]="Mosambik";
$elem["mirror/http/countries"]["choicesde"][159]="Myanmar";
$elem["mirror/http/countries"]["choicesde"][160]="Namibia";
$elem["mirror/http/countries"]["choicesde"][161]="Nauru";
$elem["mirror/http/countries"]["choicesde"][162]="Nepal";
$elem["mirror/http/countries"]["choicesde"][163]="Niederlande";
$elem["mirror/http/countries"]["choicesde"][164]="Neukaledonien";
$elem["mirror/http/countries"]["choicesde"][165]="Neuseeland";
$elem["mirror/http/countries"]["choicesde"][166]="Nicaragua";
$elem["mirror/http/countries"]["choicesde"][167]="Niger";
$elem["mirror/http/countries"]["choicesde"][168]="Nigeria";
$elem["mirror/http/countries"]["choicesde"][169]="Niue";
$elem["mirror/http/countries"]["choicesde"][170]="Norfolkinsel";
$elem["mirror/http/countries"]["choicesde"][171]="Nordmazedonien";
$elem["mirror/http/countries"]["choicesde"][172]="Nördliche Marianen";
...
$elem["mirror/http/countries"]["choicesde"][230]="Thailand";
$elem["mirror/http/countries"]["choicesde"][231]="Timor-Leste";
$elem["mirror/http/countries"]["choicesde"][232]="Togo";
$elem["mirror/http/countries"]["choicesde"][233]="Tokelau";
$elem["mirror/http/countries"]["choicesde"][234]="Tonga";
$elem["mirror/http/countries"]["choicesde"][235]="Trinidad und Tobago";
$elem["mirror/http/countries"]["choicesde"][236]="Tunesien";
$elem["mirror/http/countries"]["choicesde"][237]="Türkei";
$elem["mirror/http/countries"]["choicesde"][238]="Turkmenistan";
$elem["mirror/http/countries"]["choicesde"][239]="Turks- und Caicosinseln";
$elem["mirror/http/countries"]["choicesde"][240]="Tuvalu";
$elem["mirror/http/countries"]["choicesde"][241]="Uganda";
$elem["mirror/http/countries"]["choicesde"][242]="Ukraine";
$elem["mirror/http/countries"]["choicesde"][243]="Vereinigte Arabische Emirate";
$elem["mirror/http/countries"]["choicesde"][244]="Vereinigtes Königreich";
$elem["mirror/http/countries"]["choicesde"][245]="Vereinigte Staaten";
$elem["mirror/http/countries"]["choicesde"][246]="United States Minor Outlying Islands";
$elem["mirror/http/countries"]["choicesde"][247]="Uruguay";
$elem["mirror/http/countries"]["choicesde"][248]="Usbekistan";
$elem["mirror/http/countries"]["choicesde"][249]="Vanuatu";
$elem["mirror/http/countries"]["choicesde"][250]="Venezuela";
$elem["mirror/http/countries"]["choicesde"][251]="Vietnam";
$elem["mirror/http/countries"]["choicesde"][252]="Britische Jungferninseln";
$elem["mirror/http/countries"]["choicesde"][253]="Amerikanische Jungferninseln";
$elem["mirror/http/countries"]["choicesde"][254]="Wallis und Futuna";
$elem["mirror/http/countries"]["choicesde"][255]="Westsahara";
$elem["mirror/http/countries"]["choicesde"][256]="Jemen";
$elem["mirror/http/countries"]["choicesde"][257]="Sambia";
$elem["mirror/http/countries"]["choicesde"][258]="Simbabwe";
...
$elem["mirror/http/countries"]["choicesfr"][41]="Cap-Vert";
$elem["mirror/http/countries"]["choicesfr"][42]="Cambodge";
$elem["mirror/http/countries"]["choicesfr"][43]="Cameroun";
$elem["mirror/http/countries"]["choicesfr"][44]="Canada";
...
$elem["mirror/http/countries"]["choicesfr"][58]="République du Congo";
...
$elem["mirror/http/countries"]["choicesfr"][67]="Tchéquie";
$elem["mirror/http/countries"]["choicesfr"][68]="Côte d'Ivoire";
$elem["mirror/http/countries"]["choicesfr"][69]="Danemark";
$elem["mirror/http/countries"]["choicesfr"][70]="Djibouti";
$elem["mirror/http/countries"]["choicesfr"][71]="Dominique";
$elem["mirror/http/countries"]["choicesfr"][72]="Dominicaine\";
$elem["mirror/http/countries"]["choicesfr"][73]="République";
$elem["mirror/http/countries"]["choicesfr"][74]="Équateur";
$elem["mirror/http/countries"]["choicesfr"][75]="Égypte";
$elem["mirror/http/countries"]["choicesfr"][76]="Salvador";
$elem["mirror/http/countries"]["choicesfr"][77]="Guinée Équatoriale";
$elem["mirror/http/countries"]["choicesfr"][78]="Érythrée";
$elem["mirror/http/countries"]["choicesfr"][79]="Estonie";
$elem["mirror/http/countries"]["choicesfr"][80]="Eswatini";
$elem["mirror/http/countries"]["choicesfr"][81]="Éthiopie";
$elem["mirror/http/countries"]["choicesfr"][82]="Malouines\";
$elem["mirror/http/countries"]["choicesfr"][83]="Îles (Falkland)";
...
$elem["mirror/http/countries"]["choicesfr"][150]="Madagascar";
$elem["mirror/http/countries"]["choicesfr"][151]="Malawi";
$elem["mirror/http/countries"]["choicesfr"][152]="Malaisie";
$elem["mirror/http/countries"]["choicesfr"][153]="Maldives";
$elem["mirror/http/countries"]["choicesfr"][154]="Mali";
$elem["mirror/http/countries"]["choicesfr"][155]="Malte";
$elem["mirror/http/countries"]["choicesfr"][156]="Îles Marshall";
$elem["mirror/http/countries"]["choicesfr"][157]="Martinique";
$elem["mirror/http/countries"]["choicesfr"][158]="Mauritanie";
$elem["mirror/http/countries"]["choicesfr"][159]="Maurice";
$elem["mirror/http/countries"]["choicesfr"][160]="Mayotte";
$elem["mirror/http/countries"]["choicesfr"][161]="Mexique";
$elem["mirror/http/countries"]["choicesfr"][162]="Micronésie\";
$elem["mirror/http/countries"]["choicesfr"][163]="États fédérés de";
$elem["mirror/http/countries"]["choicesfr"][164]="Moldavie";
$elem["mirror/http/countries"]["choicesfr"][165]="Monaco";
$elem["mirror/http/countries"]["choicesfr"][166]="Mongolie";
$elem["mirror/http/countries"]["choicesfr"][167]="Monténégro";
$elem["mirror/http/countries"]["choicesfr"][168]="Montserrat";
$elem["mirror/http/countries"]["choicesfr"][169]="Maroc";
$elem["mirror/http/countries"]["choicesfr"][170]="Mozambique";
$elem["mirror/http/countries"]["choicesfr"][171]="Birmanie";
$elem["mirror/http/countries"]["choicesfr"][172]="Namibie";
$elem["mirror/http/countries"]["choicesfr"][173]="Nauru";
$elem["mirror/http/countries"]["choicesfr"][174]="Népal";
$elem["mirror/http/countries"]["choicesfr"][175]="Pays-Bas";
$elem["mirror/http/countries"]["choicesfr"][176]="Nouvelle-Calédonie";
$elem["mirror/http/countries"]["choicesfr"][177]="Nouvelle-Zélande";
$elem["mirror/http/countries"]["choicesfr"][178]="Nicaragua";
$elem["mirror/http/countries"]["choicesfr"][179]="Niger";
$elem["mirror/http/countries"]["choicesfr"][180]="Nigeria";
$elem["mirror/http/countries"]["choicesfr"][181]="Nioue";
$elem["mirror/http/countries"]["choicesfr"][182]="Norfolk\";
$elem["mirror/http/countries"]["choicesfr"][183]="Île";
$elem["mirror/http/countries"]["choicesfr"][184]="Macédoine du Nord";
$elem["mirror/http/countries"]["choicesfr"][185]="Îles Mariannes du Nord";
$elem["mirror/http/countries"]["choicesfr"][186]="Norvège";
$elem["mirror/http/countries"]["choicesfr"][187]="Oman";
$elem["mirror/http/countries"]["choicesfr"][188]="Pakistan";
$elem["mirror/http/countries"]["choicesfr"][189]="Palaos";
$elem["mirror/http/countries"]["choicesfr"][190]="Palestine\";
$elem["mirror/http/countries"]["choicesfr"][191]="État de";
$elem["mirror/http/countries"]["choicesfr"][192]="Panama";
$elem["mirror/http/countries"]["choicesfr"][193]="Papouasie-Nouvelle-Guinée";
$elem["mirror/http/countries"]["choicesfr"][194]="Paraguay";
$elem["mirror/http/countries"]["choicesfr"][195]="Pérou";
$elem["mirror/http/countries"]["choicesfr"][196]="Philippines";
$elem["mirror/http/countries"]["choicesfr"][197]="Îles Pitcairn";
$elem["mirror/http/countries"]["choicesfr"][198]="Pologne";
$elem["mirror/http/countries"]["choicesfr"][199]="Portugal";
$elem["mirror/http/countries"]["choicesfr"][200]="Porto Rico";
$elem["mirror/http/countries"]["choicesfr"][201]="Qatar";
$elem["mirror/http/countries"]["choicesfr"][202]="Roumanie";
$elem["mirror/http/countries"]["choicesfr"][203]="Russie\";
$elem["mirror/http/countries"]["choicesfr"][204]="Fédération de";
$elem["mirror/http/countries"]["choicesfr"][205]="Rwanda";
$elem["mirror/http/countries"]["choicesfr"][206]="Réunion\";
$elem["mirror/http/countries"]["choicesfr"][207]="Île de la";
$elem["mirror/http/countries"]["choicesfr"][208]="Saint-Barthélemy";
$elem["mirror/http/countries"]["choicesfr"][209]="Sainte-Hélène\";
$elem["mirror/http/countries"]["choicesfr"][210]="Ascension et Tristan da Cunha";
$elem["mirror/http/countries"]["choicesfr"][211]="Saint-Kitts-et-Nevis";
$elem["mirror/http/countries"]["choicesfr"][212]="Sainte-Lucie";
$elem["mirror/http/countries"]["choicesfr"][213]="Saint-Martin (partie française)";
$elem["mirror/http/countries"]["choicesfr"][214]="Saint-Pierre-et-Miquelon";
$elem["mirror/http/countries"]["choicesfr"][215]="Saint-Vincent-et-les Grenadines";
$elem["mirror/http/countries"]["choicesfr"][216]="Samoa";
$elem["mirror/http/countries"]["choicesfr"][217]="Saint-Marin";
$elem["mirror/http/countries"]["choicesfr"][218]="Sao Tomé-et-Principe";
$elem["mirror/http/countries"]["choicesfr"][219]="Arabie saoudite";
$elem["mirror/http/countries"]["choicesfr"][220]="Sénégal";
$elem["mirror/http/countries"]["choicesfr"][221]="Serbie";
$elem["mirror/http/countries"]["choicesfr"][222]="Seychelles";
$elem["mirror/http/countries"]["choicesfr"][223]="Sierra Leone";
$elem["mirror/http/countries"]["choicesfr"][224]="Singapour";
$elem["mirror/http/countries"]["choicesfr"][225]="Saint-Martin (partie néerlandaise)";
$elem["mirror/http/countries"]["choicesfr"][226]="Slovaquie";
$elem["mirror/http/countries"]["choicesfr"][227]="Slovénie";
$elem["mirror/http/countries"]["choicesfr"][228]="Salomon\";
$elem["mirror/http/countries"]["choicesfr"][229]="Îles";
$elem["mirror/http/countries"]["choicesfr"][230]="Somalie";
$elem["mirror/http/countries"]["choicesfr"][231]="Afrique du Sud";
$elem["mirror/http/countries"]["choicesfr"][232]="Géorgie du Sud et les îles Sandwich du Sud";
$elem["mirror/http/countries"]["choicesfr"][233]="Soudan du Sud";
$elem["mirror/http/countries"]["choicesfr"][234]="Espagne";
$elem["mirror/http/countries"]["choicesfr"][235]="Sri Lanka";
$elem["mirror/http/countries"]["choicesfr"][236]="Soudan";
$elem["mirror/http/countries"]["choicesfr"][237]="Surinam";
$elem["mirror/http/countries"]["choicesfr"][238]="Svalbard et île Jan Mayen";
$elem["mirror/http/countries"]["choicesfr"][239]="Suède";
$elem["mirror/http/countries"]["choicesfr"][240]="Suisse";
$elem["mirror/http/countries"]["choicesfr"][241]="Syrienne\";
$elem["mirror/http/countries"]["choicesfr"][242]="République arabe";
$elem["mirror/http/countries"]["choicesfr"][243]="Taïwan";
$elem["mirror/http/countries"]["choicesfr"][244]="Tadjikistan";
$elem["mirror/http/countries"]["choicesfr"][245]="Tanzanie";
$elem["mirror/http/countries"]["choicesfr"][246]="Thaïlande";
$elem["mirror/http/countries"]["choicesfr"][247]="Timor oriental";
$elem["mirror/http/countries"]["choicesfr"][248]="Togo";
$elem["mirror/http/countries"]["choicesfr"][249]="Tokelau";
$elem["mirror/http/countries"]["choicesfr"][250]="Tonga";
$elem["mirror/http/countries"]["choicesfr"][251]="Trinité-et-Tobago";
$elem["mirror/http/countries"]["choicesfr"][252]="Tunisie";
$elem["mirror/http/countries"]["choicesfr"][253]="Turquie";
$elem["mirror/http/countries"]["choicesfr"][254]="Turkménistan";
$elem["mirror/http/countries"]["choicesfr"][255]="Turks et Caïques\";
$elem["mirror/http/countries"]["choicesfr"][256]="Îles";
$elem["mirror/http/countries"]["choicesfr"][257]="Tuvalu";
$elem["mirror/http/countries"]["choicesfr"][258]="Ouganda";
$elem["mirror/http/countries"]["choicesfr"][259]="Ukraine";
$elem["mirror/http/countries"]["choicesfr"][260]="Émirats arabes unis";
$elem["mirror/http/countries"]["choicesfr"][261]="Royaume-Uni";
$elem["mirror/http/countries"]["choicesfr"][262]="États-Unis";
$elem["mirror/http/countries"]["choicesfr"][263]="Îles mineures éloignées des États-Unis";
$elem["mirror/http/countries"]["choicesfr"][264]="Uruguay";
$elem["mirror/http/countries"]["choicesfr"][265]="Ouzbékistan";
$elem["mirror/http/countries"]["choicesfr"][266]="Vanuatu";
$elem["mirror/http/countries"]["choicesfr"][267]="Vénézuela";
$elem["mirror/http/countries"]["choicesfr"][268]="Viêt Nam";
$elem["mirror/http/countries"]["choicesfr"][269]="Îles Vierges britanniques";
$elem["mirror/http/countries"]["choicesfr"][270]="Îles Vierges des États-Unis";
$elem["mirror/http/countries"]["choicesfr"][271]="Wallis et Futuna";
$elem["mirror/http/countries"]["choicesfr"][272]="Sahara occidental";
$elem["mirror/http/countries"]["choicesfr"][273]="Yémen";
$elem["mirror/http/countries"]["choicesfr"][274]="Zambie";
$elem["mirror/http/countries"]["choicesfr"][275]="Zimbabwe";
$elem["mirror/http/countries"]["choicesfr"][276]="Åland\";
...
$elem["mirror/https/countries"]["description"]="Debian archive mirror country:
 ...
 aware that nearby countries, or even your own, may not be the best choice.
";
$elem["mirror/https/countries"]["descriptionde"]="Land des Debian-Archiv-Spiegelservers:
 Sie sollten einen Spiegelserver aussuchen, der netztopologisch in Ihrer
 Nähe liegt -- beachten Sie aber, dass nahegelegene Länder, oder sogar
 Ihr eigenes Land, nicht unbedingt die beste Wahl sein müssen.
";
$elem["mirror/https/countries"]["descriptionfr"]="Pays du miroir de l'archive Debian :
 L'objectif est de trouver un miroir de l'archive Debian qui soit proche de
 vous du point de vue du réseau. Gardez à l'esprit que le fait de choisir
 un pays proche, voire même votre pays, n'est peut-être pas le meilleur
 choix.
";
...
$elem["disk-detect/ibft/enable"]["type"]="boolean";
$elem["disk-detect/ibft/enable"]["description"]="for internal use; can be preseeded
 Check for the presence of iSCSI devices with
 the iSCSI Boot Firmware Table (iBFT)?

";
$elem["disk-detect/ibft/enable"]["descriptionde"]="";
$elem["disk-detect/ibft/enable"]["descriptionfr"]="";
$elem["disk-detect/ibft/enable"]["default"]="false";
...
$elem["localechooser/countrylist/Africa"]["choices"][7]="Cabo Verde";
$elem["localechooser/countrylist/Africa"]["choices"][8]="Cameroon";
...
$elem["localechooser/countrylist/Africa"]["choices"][19]="Eswatini";
$elem["localechooser/countrylist/Africa"]["choices"][20]="Ethiopia";
$elem["localechooser/countrylist/Africa"]["choices"][21]="Gabon";
$elem["localechooser/countrylist/Africa"]["choices"][22]="Gambia";
$elem["localechooser/countrylist/Africa"]["choices"][23]="Ghana";
$elem["localechooser/countrylist/Africa"]["choices"][24]="Guinea";
$elem["localechooser/countrylist/Africa"]["choices"][25]="Guinea-Bissau";
$elem["localechooser/countrylist/Africa"]["choices"][26]="Kenya";
$elem["localechooser/countrylist/Africa"]["choices"][27]="Lesotho";
$elem["localechooser/countrylist/Africa"]["choices"][28]="Liberia";
$elem["localechooser/countrylist/Africa"]["choices"][29]="Libya";
$elem["localechooser/countrylist/Africa"]["choices"][30]="Malawi";
$elem["localechooser/countrylist/Africa"]["choices"][31]="Mali";
$elem["localechooser/countrylist/Africa"]["choices"][32]="Mauritania";
$elem["localechooser/countrylist/Africa"]["choices"][33]="Morocco";
$elem["localechooser/countrylist/Africa"]["choices"][34]="Mozambique";
$elem["localechooser/countrylist/Africa"]["choices"][35]="Namibia";
$elem["localechooser/countrylist/Africa"]["choices"][36]="Niger";
$elem["localechooser/countrylist/Africa"]["choices"][37]="Nigeria";
$elem["localechooser/countrylist/Africa"]["choices"][38]="Rwanda";
$elem["localechooser/countrylist/Africa"]["choices"][39]="Sao Tome and Principe";
$elem["localechooser/countrylist/Africa"]["choices"][40]="Senegal";
$elem["localechooser/countrylist/Africa"]["choices"][41]="Sierra Leone";
$elem["localechooser/countrylist/Africa"]["choices"][42]="Somalia";
$elem["localechooser/countrylist/Africa"]["choices"][43]="South Africa";
$elem["localechooser/countrylist/Africa"]["choices"][44]="South Sudan";
$elem["localechooser/countrylist/Africa"]["choices"][45]="Sudan";
...
$elem["localechooser/countrylist/Africa"]["choicesde"][7]="Cabo Verde";
$elem["localechooser/countrylist/Africa"]["choicesde"][8]="Kamerun";
...
$elem["localechooser/countrylist/Africa"]["choicesde"][18]="Eswatini";
$elem["localechooser/countrylist/Africa"]["choicesde"][19]="Äthiopien";
$elem["localechooser/countrylist/Africa"]["choicesde"][20]="Gabun";
$elem["localechooser/countrylist/Africa"]["choicesde"][21]="Gambia";
$elem["localechooser/countrylist/Africa"]["choicesde"][22]="Ghana";
$elem["localechooser/countrylist/Africa"]["choicesde"][23]="Guinea";
$elem["localechooser/countrylist/Africa"]["choicesde"][24]="Guinea-Bissau";
$elem["localechooser/countrylist/Africa"]["choicesde"][25]="Kenia";
$elem["localechooser/countrylist/Africa"]["choicesde"][26]="Lesotho";
$elem["localechooser/countrylist/Africa"]["choicesde"][27]="Liberia";
$elem["localechooser/countrylist/Africa"]["choicesde"][28]="Libyen";
$elem["localechooser/countrylist/Africa"]["choicesde"][29]="Malawi";
$elem["localechooser/countrylist/Africa"]["choicesde"][30]="Mali";
$elem["localechooser/countrylist/Africa"]["choicesde"][31]="Mauretanien";
$elem["localechooser/countrylist/Africa"]["choicesde"][32]="Marokko";
$elem["localechooser/countrylist/Africa"]["choicesde"][33]="Mosambik";
$elem["localechooser/countrylist/Africa"]["choicesde"][34]="Namibia";
$elem["localechooser/countrylist/Africa"]["choicesde"][35]="Niger";
$elem["localechooser/countrylist/Africa"]["choicesde"][36]="Nigeria";
$elem["localechooser/countrylist/Africa"]["choicesde"][37]="Ruanda";
$elem["localechooser/countrylist/Africa"]["choicesde"][38]="São Tomé und Príncipe";
$elem["localechooser/countrylist/Africa"]["choicesde"][39]="Senegal";
$elem["localechooser/countrylist/Africa"]["choicesde"][40]="Sierra Leone";
$elem["localechooser/countrylist/Africa"]["choicesde"][41]="Somalia";
$elem["localechooser/countrylist/Africa"]["choicesde"][42]="Südafrika";
$elem["localechooser/countrylist/Africa"]["choicesde"][43]="Südsudan";
$elem["localechooser/countrylist/Africa"]["choicesde"][44]="Sudan";
...
$elem["localechooser/countrylist/Africa"]["choicesfr"][7]="Cap-Vert";
$elem["localechooser/countrylist/Africa"]["choicesfr"][8]="Cameroun";
...
$elem["localechooser/countrylist/Africa"]["choicesfr"][12]="République du Congo";
...
$elem["localechooser/countrylist/Africa"]["choicesfr"][19]="Eswatini";
$elem["localechooser/countrylist/Africa"]["choicesfr"][20]="Éthiopie";
$elem["localechooser/countrylist/Africa"]["choicesfr"][21]="Gabon";
$elem["localechooser/countrylist/Africa"]["choicesfr"][22]="Gambie";
$elem["localechooser/countrylist/Africa"]["choicesfr"][23]="Ghana";
$elem["localechooser/countrylist/Africa"]["choicesfr"][24]="Guinée";
$elem["localechooser/countrylist/Africa"]["choicesfr"][25]="Guinée-Bissau";
$elem["localechooser/countrylist/Africa"]["choicesfr"][26]="Kenya";
$elem["localechooser/countrylist/Africa"]["choicesfr"][27]="Lesotho";
$elem["localechooser/countrylist/Africa"]["choicesfr"][28]="Libéria";
$elem["localechooser/countrylist/Africa"]["choicesfr"][29]="Libye";
$elem["localechooser/countrylist/Africa"]["choicesfr"][30]="Malawi";
$elem["localechooser/countrylist/Africa"]["choicesfr"][31]="Mali";
$elem["localechooser/countrylist/Africa"]["choicesfr"][32]="Mauritanie";
$elem["localechooser/countrylist/Africa"]["choicesfr"][33]="Maroc";
$elem["localechooser/countrylist/Africa"]["choicesfr"][34]="Mozambique";
$elem["localechooser/countrylist/Africa"]["choicesfr"][35]="Namibie";
$elem["localechooser/countrylist/Africa"]["choicesfr"][36]="Niger";
$elem["localechooser/countrylist/Africa"]["choicesfr"][37]="Nigeria";
$elem["localechooser/countrylist/Africa"]["choicesfr"][38]="Rwanda";
$elem["localechooser/countrylist/Africa"]["choicesfr"][39]="Sao Tomé-et-Principe";
$elem["localechooser/countrylist/Africa"]["choicesfr"][40]="Sénégal";
$elem["localechooser/countrylist/Africa"]["choicesfr"][41]="Sierra Leone";
$elem["localechooser/countrylist/Africa"]["choicesfr"][42]="Somalie";
$elem["localechooser/countrylist/Africa"]["choicesfr"][43]="Afrique du Sud";
$elem["localechooser/countrylist/Africa"]["choicesfr"][44]="Soudan du Sud";
$elem["localechooser/countrylist/Africa"]["choicesfr"][45]="Soudan";
...
$elem["localechooser/countrylist/Asia"]["choices"][49]="Vietnam";
...
$elem["localechooser/countrylist/Asia"]["choicesfr"][30]="Birmanie";
...
$elem["localechooser/countrylist/Asia"]["choicesfr"][46]="Timor oriental";
...
$elem["localechooser/countrylist/Asia"]["choicesfr"][51]="Viêt Nam";
...
$elem["localechooser/countrylist/Atlantic_Ocean"]["choicesfr"][3]="Malouines\";
$elem["localechooser/countrylist/Atlantic_Ocean"]["choicesfr"][4]="Îles (Falkland)";
...
$elem["localechooser/countrylist/Central_America"]["choicesfr"][3]="Salvador";
...
$elem["localechooser/countrylist/Europe"]["choices"][12]="Czechia";
...
$elem["localechooser/countrylist/Europe"]["choices"][35]="Malta";
$elem["localechooser/countrylist/Europe"]["choices"][36]="Moldova";
$elem["localechooser/countrylist/Europe"]["choices"][37]="Monaco";
$elem["localechooser/countrylist/Europe"]["choices"][38]="Montenegro";
$elem["localechooser/countrylist/Europe"]["choices"][39]="Netherlands";
$elem["localechooser/countrylist/Europe"]["choices"][40]="North Macedonia";
$elem["localechooser/countrylist/Europe"]["choices"][41]="Norway";
$elem["localechooser/countrylist/Europe"]["choices"][42]="Poland";
$elem["localechooser/countrylist/Europe"]["choices"][43]="Portugal";
$elem["localechooser/countrylist/Europe"]["choices"][44]="Romania";
$elem["localechooser/countrylist/Europe"]["choices"][45]="Russian Federation";
$elem["localechooser/countrylist/Europe"]["choices"][46]="San Marino";
$elem["localechooser/countrylist/Europe"]["choices"][47]="Serbia";
$elem["localechooser/countrylist/Europe"]["choices"][48]="Slovakia";
$elem["localechooser/countrylist/Europe"]["choices"][49]="Slovenia";
$elem["localechooser/countrylist/Europe"]["choices"][50]="Spain";
$elem["localechooser/countrylist/Europe"]["choices"][51]="Svalbard and Jan Mayen";
$elem["localechooser/countrylist/Europe"]["choices"][52]="Sweden";
$elem["localechooser/countrylist/Europe"]["choices"][53]="Switzerland";
$elem["localechooser/countrylist/Europe"]["choices"][54]="Ukraine";
$elem["localechooser/countrylist/Europe"]["choices"][55]="United Kingdom";
...
$elem["localechooser/countrylist/Europe"]["choicesde"][12]="Tschechien";
...
$elem["localechooser/countrylist/Europe"]["choicesde"][35]="Malta";
$elem["localechooser/countrylist/Europe"]["choicesde"][36]="Moldau";
$elem["localechooser/countrylist/Europe"]["choicesde"][37]="Monaco";
$elem["localechooser/countrylist/Europe"]["choicesde"][38]="Montenegro";
$elem["localechooser/countrylist/Europe"]["choicesde"][39]="Niederlande";
$elem["localechooser/countrylist/Europe"]["choicesde"][40]="Nordmazedonien";
$elem["localechooser/countrylist/Europe"]["choicesde"][41]="Norwegen";
$elem["localechooser/countrylist/Europe"]["choicesde"][42]="Polen";
$elem["localechooser/countrylist/Europe"]["choicesde"][43]="Portugal";
$elem["localechooser/countrylist/Europe"]["choicesde"][44]="Rumänien";
$elem["localechooser/countrylist/Europe"]["choicesde"][45]="Russische Föderation";
$elem["localechooser/countrylist/Europe"]["choicesde"][46]="San Marino";
$elem["localechooser/countrylist/Europe"]["choicesde"][47]="Serbien";
$elem["localechooser/countrylist/Europe"]["choicesde"][48]="Slowakei";
$elem["localechooser/countrylist/Europe"]["choicesde"][49]="Slowenien";
$elem["localechooser/countrylist/Europe"]["choicesde"][50]="Spanien";
$elem["localechooser/countrylist/Europe"]["choicesde"][51]="Svalbard und Jan Mayen";
$elem["localechooser/countrylist/Europe"]["choicesde"][52]="Schweden";
$elem["localechooser/countrylist/Europe"]["choicesde"][53]="Schweiz";
$elem["localechooser/countrylist/Europe"]["choicesde"][54]="Ukraine";
$elem["localechooser/countrylist/Europe"]["choicesde"][55]="Vereinigtes Königreich";
...
$elem["localechooser/countrylist/Europe"]["choicesfr"][12]="Tchéquie";
$elem["localechooser/countrylist/Europe"]["choicesfr"][13]="Danemark";
$elem["localechooser/countrylist/Europe"]["choicesfr"][14]="Estonie";
$elem["localechooser/countrylist/Europe"]["choicesfr"][15]="Féroé\";
$elem["localechooser/countrylist/Europe"]["choicesfr"][16]="Îles";
$elem["localechooser/countrylist/Europe"]["choicesfr"][17]="Finlande";
$elem["localechooser/countrylist/Europe"]["choicesfr"][18]="France";
$elem["localechooser/countrylist/Europe"]["choicesfr"][19]="Géorgie";
$elem["localechooser/countrylist/Europe"]["choicesfr"][20]="Allemagne";
$elem["localechooser/countrylist/Europe"]["choicesfr"][21]="Gibraltar";
$elem["localechooser/countrylist/Europe"]["choicesfr"][22]="Grèce";
$elem["localechooser/countrylist/Europe"]["choicesfr"][23]="Groënland";
$elem["localechooser/countrylist/Europe"]["choicesfr"][24]="Guernesey";
$elem["localechooser/countrylist/Europe"]["choicesfr"][25]="Saint-Siège (état de la cité du Vatican)";
$elem["localechooser/countrylist/Europe"]["choicesfr"][26]="Hongrie";
$elem["localechooser/countrylist/Europe"]["choicesfr"][27]="Islande";
$elem["localechooser/countrylist/Europe"]["choicesfr"][28]="Irlande";
$elem["localechooser/countrylist/Europe"]["choicesfr"][29]="Île de Man";
$elem["localechooser/countrylist/Europe"]["choicesfr"][30]="Italie";
$elem["localechooser/countrylist/Europe"]["choicesfr"][31]="Jersey";
$elem["localechooser/countrylist/Europe"]["choicesfr"][32]="Lettonie";
$elem["localechooser/countrylist/Europe"]["choicesfr"][33]="Liechtenstein";
$elem["localechooser/countrylist/Europe"]["choicesfr"][34]="Lituanie";
$elem["localechooser/countrylist/Europe"]["choicesfr"][35]="Luxembourg";
$elem["localechooser/countrylist/Europe"]["choicesfr"][36]="Malte";
$elem["localechooser/countrylist/Europe"]["choicesfr"][37]="Moldavie";
$elem["localechooser/countrylist/Europe"]["choicesfr"][38]="Monaco";
$elem["localechooser/countrylist/Europe"]["choicesfr"][39]="Monténégro";
$elem["localechooser/countrylist/Europe"]["choicesfr"][40]="Pays-Bas";
$elem["localechooser/countrylist/Europe"]["choicesfr"][41]="Macédoine du Nord";
$elem["localechooser/countrylist/Europe"]["choicesfr"][42]="Norvège";
$elem["localechooser/countrylist/Europe"]["choicesfr"][43]="Pologne";
$elem["localechooser/countrylist/Europe"]["choicesfr"][44]="Portugal";
$elem["localechooser/countrylist/Europe"]["choicesfr"][45]="Roumanie";
$elem["localechooser/countrylist/Europe"]["choicesfr"][46]="Russie\";
$elem["localechooser/countrylist/Europe"]["choicesfr"][47]="Fédération de";
$elem["localechooser/countrylist/Europe"]["choicesfr"][48]="Saint-Marin";
$elem["localechooser/countrylist/Europe"]["choicesfr"][49]="Serbie";
$elem["localechooser/countrylist/Europe"]["choicesfr"][50]="Slovaquie";
$elem["localechooser/countrylist/Europe"]["choicesfr"][51]="Slovénie";
$elem["localechooser/countrylist/Europe"]["choicesfr"][52]="Espagne";
$elem["localechooser/countrylist/Europe"]["choicesfr"][53]="Svalbard et île Jan Mayen";
$elem["localechooser/countrylist/Europe"]["choicesfr"][54]="Suède";
$elem["localechooser/countrylist/Europe"]["choicesfr"][55]="Suisse";
$elem["localechooser/countrylist/Europe"]["choicesfr"][56]="Ukraine";
$elem["localechooser/countrylist/Europe"]["choicesfr"][57]="Royaume-Uni";
$elem["localechooser/countrylist/Europe"]["choicesfr"][58]="Åland\";
...
$elem["localechooser/countrylist/Oceania"]["choicesde"][16]="Nördliche Marianen";
...
$elem["localechooser/countrylist/Oceania"]["choicesfr"][18]="Îles Mariannes du Nord";
$elem["localechooser/countrylist/Oceania"]["choicesfr"][19]="Palaos";
$elem["localechooser/countrylist/Oceania"]["choicesfr"][20]="Papouasie-Nouvelle-Guinée";
$elem["localechooser/countrylist/Oceania"]["choicesfr"][21]="Îles Pitcairn";
$elem["localechooser/countrylist/Oceania"]["choicesfr"][22]="Samoa";
$elem["localechooser/countrylist/Oceania"]["choicesfr"][23]="Salomon\";
$elem["localechooser/countrylist/Oceania"]["choicesfr"][24]="Îles";
$elem["localechooser/countrylist/Oceania"]["choicesfr"][25]="Tokelau";
$elem["localechooser/countrylist/Oceania"]["choicesfr"][26]="Tonga";
$elem["localechooser/countrylist/Oceania"]["choicesfr"][27]="Tuvalu";
$elem["localechooser/countrylist/Oceania"]["choicesfr"][28]="Îles mineures éloignées des États-Unis";
$elem["localechooser/countrylist/Oceania"]["choicesfr"][29]="Vanuatu";
...
$elem["localechooser/shortlist/ar"]["choices"][14]="South Sudan";
...
$elem["localechooser/shortlist/de"]["choices"][3]="Italy";
$elem["localechooser/shortlist/de"]["choices"][4]="Liechtenstein";
$elem["localechooser/shortlist/de"]["choices"][5]="Luxembourg";
$elem["localechooser/shortlist/de"]["choices"][6]="Switzerland";
$elem["localechooser/shortlist/de"]["choices"][7]="Austria";
$elem["localechooser/shortlist/de"]["choicesde"][1]="Belgien";
$elem["localechooser/shortlist/de"]["choicesde"][2]="Deutschland";
$elem["localechooser/shortlist/de"]["choicesde"][3]="Italien";
$elem["localechooser/shortlist/de"]["choicesde"][4]="Liechtenstein";
$elem["localechooser/shortlist/de"]["choicesde"][5]="Luxemburg";
$elem["localechooser/shortlist/de"]["choicesde"][6]="Schweiz";
$elem["localechooser/shortlist/de"]["choicesde"][7]="Österreich";
...
$elem["localechooser/shortlist/en"]["choices"][8]="Israel";
$elem["localechooser/shortlist/en"]["choices"][9]="New Zealand";
$elem["localechooser/shortlist/en"]["choices"][10]="Nigeria";
$elem["localechooser/shortlist/en"]["choices"][11]="Philippines";
$elem["localechooser/shortlist/en"]["choices"][12]="Seychelles";
$elem["localechooser/shortlist/en"]["choices"][13]="Singapore";
$elem["localechooser/shortlist/en"]["choices"][14]="South Africa";
$elem["localechooser/shortlist/en"]["choices"][15]="United Kingdom";
$elem["localechooser/shortlist/en"]["choices"][16]="United States";
$elem["localechooser/shortlist/en"]["choices"][17]="Zambia";
$elem["localechooser/shortlist/en"]["choices"][18]="Zimbabwe";
...
$elem["localechooser/shortlist/sq"]["choices"][1]="North Macedonia";
$elem["localechooser/shortlist/sq"]["choices"][2]="Albania";
...
$elem["netcfg/use_vlan"]["type"]="boolean";
$elem["netcfg/use_vlan"]["description"]="Is this system connected to a VLAN trunk port?
...
";
$elem["netcfg/use_vlan"]["descriptionde"]="";
$elem["netcfg/use_vlan"]["descriptionfr"]="";
$elem["netcfg/use_vlan"]["default"]="false";
$elem["netcfg/vlan_id"]["type"]="string";
$elem["netcfg/vlan_id"]["description"]="VLAN ID (1-4094):
 If the network interface is directly connected to a VLAN trunk port,
 specifying a VLAN ID may be necessary to get a working connection.

";
$elem["netcfg/vlan_id"]["descriptionde"]="";
$elem["netcfg/vlan_id"]["descriptionfr"]="";
$elem["netcfg/vlan_id"]["default"]="";
$elem["netcfg/vlan_failed"]["type"]="error";
$elem["netcfg/vlan_failed"]["description"]="Error setting up VLAN
...
";
$elem["netcfg/vlan_failed"]["descriptionde"]="";
$elem["netcfg/vlan_failed"]["descriptionfr"]="";
$elem["netcfg/vlan_failed"]["default"]="";
...
$elem["netcfg/internal-enc"]["type"]="text";
$elem["netcfg/internal-enc"]["description"]="Ethernet CCW bus

";
$elem["netcfg/internal-enc"]["descriptionde"]="";
$elem["netcfg/internal-enc"]["descriptionfr"]="";
$elem["netcfg/internal-enc"]["default"]="";
$elem["netcfg/internal-ena"]["type"]="text";
$elem["netcfg/internal-ena"]["description"]="Ethernet Onboard

";
$elem["netcfg/internal-ena"]["descriptionde"]="";
$elem["netcfg/internal-ena"]["descriptionfr"]="";
$elem["netcfg/internal-ena"]["default"]="";
$elem["netcfg/internal-enP"]["type"]="text";
$elem["netcfg/internal-enP"]["description"]="Ethernet PCI

";
$elem["netcfg/internal-enP"]["descriptionde"]="";
$elem["netcfg/internal-enP"]["descriptionfr"]="";
$elem["netcfg/internal-enP"]["default"]="";
$elem["netcfg/internal-enp"]["type"]="text";
$elem["netcfg/internal-enp"]["description"]="Ethernet PCI
...
$elem["netcfg/do_not_use_netplan"]["type"]="boolean";
$elem["netcfg/do_not_use_netplan"]["description"]="for internal use; can be preseeded
 Set to false to fallback to ifupdown.

";
$elem["netcfg/do_not_use_netplan"]["descriptionde"]="";
$elem["netcfg/do_not_use_netplan"]["descriptionfr"]="";
$elem["netcfg/do_not_use_netplan"]["default"]="false";
$elem["netcfg/enable"]["type"]="boolean";
$elem["netcfg/enable"]["description"]="for internal use; can be preseeded
 Set to false to disable netcfg entirely via preseed.
...
$elem["netcfg/internal-nowifi"]["type"]="select";
$elem["netcfg/internal-nowifi"]["choices"][1]="Retry network autoconfiguration";
$elem["netcfg/internal-nowifi"]["choices"][2]="Retry network autoconfiguration with a DHCP hostname";
$elem["netcfg/internal-nowifi"]["choices"][3]="Configure network manually";
$elem["netcfg/internal-nowifi"]["choicesde"][1]="Autom. Konfiguration erneut versuchen";
$elem["netcfg/internal-nowifi"]["choicesde"][2]="Autom. Konfiguration erneut versuchen mit einem DHCP-Rechnernamen";
$elem["netcfg/internal-nowifi"]["choicesde"][3]="Netzwerk manuell einrichten";
$elem["netcfg/internal-nowifi"]["choicesfr"][1]="Réessayer la configuration automatique du réseau";
$elem["netcfg/internal-nowifi"]["choicesfr"][2]="Réessayer la configuration automatique avec un nom d'hôte DHCP";
$elem["netcfg/internal-nowifi"]["choicesfr"][3]="Configurer vous-même le réseau";
$elem["netcfg/internal-nowifi"]["description"]="";
$elem["netcfg/internal-nowifi"]["descriptionde"]="";
$elem["netcfg/internal-nowifi"]["descriptionfr"]="";
$elem["netcfg/internal-nowifi"]["default"]="";
$elem["netcfg/internal-wifireconf"]["type"]="select";
$elem["netcfg/internal-wifireconf"]["choices"][1]="Retry network autoconfiguration";
$elem["netcfg/internal-wifireconf"]["choices"][2]="Retry network autoconfiguration with a DHCP hostname";
$elem["netcfg/internal-wifireconf"]["choices"][3]="Configure network manually";
$elem["netcfg/internal-wifireconf"]["choices"][4]="Reconfigure the wireless network";
$elem["netcfg/internal-wifireconf"]["choicesde"][1]="Autom. Konfiguration erneut versuchen";
$elem["netcfg/internal-wifireconf"]["choicesde"][2]="Autom. Konfiguration erneut versuchen mit einem DHCP-Rechnernamen";
$elem["netcfg/internal-wifireconf"]["choicesde"][3]="Netzwerk manuell einrichten";
$elem["netcfg/internal-wifireconf"]["choicesde"][4]="Das drahtlose Netzwerk erneut konfigurieren";
$elem["netcfg/internal-wifireconf"]["choicesfr"][1]="Réessayer la configuration automatique du réseau";
$elem["netcfg/internal-wifireconf"]["choicesfr"][2]="Réessayer la configuration automatique avec un nom d'hôte DHCP";
$elem["netcfg/internal-wifireconf"]["choicesfr"][3]="Configurer vous-même le réseau";
$elem["netcfg/internal-wifireconf"]["choicesfr"][4]="Reconfigurer le réseau sans fil";
$elem["netcfg/internal-wifireconf"]["description"]="";
$elem["netcfg/internal-wifireconf"]["descriptionde"]="";
$elem["netcfg/internal-wifireconf"]["descriptionfr"]="";
...
$elem["auto-install/defaultroot"]["default"]="d-i/focal/./preseed.cfg";
...
$elem["partman-auto-crypto/erase_disks"]["type"]="boolean";
$elem["partman-auto-crypto/erase_disks"]["description"]="for internal use; can be preseeded
 Set to false if you want to skip disk erase.

";
$elem["partman-auto-crypto/erase_disks"]["descriptionde"]="";
$elem["partman-auto-crypto/erase_disks"]["descriptionfr"]="";
$elem["partman-auto-crypto/erase_disks"]["default"]="true";
...
$elem["partman-auto/cap-ram"]["type"]="string";
$elem["partman-auto/cap-ram"]["description"]="for internal use; can be preseeded
 ...
 uncapped swap size with respect to available ram, pressed this key to
 any string, e.g. partman-auto/cap-ram=false

";
$elem["partman-auto/cap-ram"]["descriptionde"]="";
$elem["partman-auto/cap-ram"]["descriptionfr"]="";
$elem["partman-auto/cap-ram"]["default"]="1024";
...
";
$elem["partman-basicfilesystems/no_swap"]["default"]="false";
...
$elem["partman-btrfs/btrfs_root"]["type"]="error";
$elem["partman-btrfs/btrfs_root"]["description"]="btrfs root file system not supported without separate /boot
...
";
$elem["partman-btrfs/btrfs_root"]["descriptionde"]="btrfs-Root-Dateisystem ohne separate /boot-Partition nicht unterstützt
 Ihr Root-Dateisystem ist ein btrfs-Dateisystem. Dies wird von dem Standard-Bootloader dieses Installers nicht unterstützt.
 .
 Sie sollten eine kleine /boot-Partition mit einem anderen Dateisystem, wie etwa ext4, verwenden.
";
$elem["partman-btrfs/btrfs_root"]["descriptionfr"]="Impossible d'utiliser un système de fichiers racine btrfs sans /boot séparé
 Le système de fichiers pour la partition racine est un système btrfs. Ce choix n'est pas géré par le programme de démarrage qui est utilisé par défaut par le programme d'installation.
 .
 Vous devriez utiliser une petite partition /boot avec un autre système de fichiers, par exemple ext4.
";
$elem["partman-btrfs/btrfs_root"]["default"]="";
$elem["partman-btrfs/btrfs_boot"]["type"]="error";
$elem["partman-btrfs/btrfs_boot"]["description"]="btrfs file system not supported for /boot
 You have mounted a btrfs file system as /boot. This is not supported
 by the boot loader used by default by this installer.
 .
 You should use another file system, such as ext4, for the /boot partition.
";
$elem["partman-btrfs/btrfs_boot"]["descriptionde"]="btrfs-Dateisystem für /boot nicht unterstützt
...
";
$elem["partman-btrfs/btrfs_boot"]["descriptionfr"]="Système de fichiers btrfs non géré pour /boot
 Le système de fichiers pour la partition /boot est un système btrfs. Ce choix n'est pas géré par le programme de démarrage qui est utilisé par défaut par le programme d'installation.
 .
 Vous devriez utiliser un autre système de fichiers, par exemple ext4, pour la partition /boot.
";
$elem["partman-btrfs/btrfs_boot"]["default"]="";
...
";
$elem["partman-efi/no_efi"]["descriptionde"]="";
$elem["partman-efi/no_efi"]["descriptionfr"]="";
...
$elem["partman-partitioning/no_bootable_efi"]["type"]="boolean";
$elem["partman-partitioning/no_bootable_efi"]["description"]="Go back to the menu and correct this problem?
...
";
$elem["partman-partitioning/no_bootable_efi"]["descriptionde"]="";
$elem["partman-partitioning/no_bootable_efi"]["descriptionfr"]="";
$elem["partman-partitioning/no_bootable_efi"]["default"]="";
$elem["partman-partitioning/no_bootable_biosgrub"]["type"]="boolean";
$elem["partman-partitioning/no_bootable_biosgrub"]["description"]="Go back to the menu and correct this problem?
...
";
$elem["partman-partitioning/no_bootable_biosgrub"]["descriptionde"]="";
$elem["partman-partitioning/no_bootable_biosgrub"]["descriptionfr"]="";
$elem["partman-partitioning/no_bootable_biosgrub"]["default"]="";
$elem["partman-swapfile/size"]["type"]="string";
$elem["partman-swapfile/size"]["description"]="Maximum size of swapfile
 Please enter the absolute maximum size of swapfile in MiB.

";
$elem["partman-swapfile/size"]["descriptionde"]="";
$elem["partman-swapfile/size"]["descriptionfr"]="";
$elem["partman-swapfile/size"]["default"]="2048";
$elem["partman-swapfile/percentage"]["type"]="text";
$elem["partman-swapfile/percentage"]["description"]="Maximum percentage of free space to use for swapfile
 Please enter the maximum percentage of free space on root filesystem to
 use for swapfile.

";
$elem["partman-swapfile/percentage"]["descriptionde"]="";
$elem["partman-swapfile/percentage"]["descriptionfr"]="";
$elem["partman-swapfile/percentage"]["default"]="5";
$elem["partman-swapfile/progress_swap_formatting"]["type"]="text";
$elem["partman-swapfile/progress_swap_formatting"]["description"]="Creating swap file...

";
$elem["partman-swapfile/progress_swap_formatting"]["descriptionde"]="";
$elem["partman-swapfile/progress_swap_formatting"]["descriptionfr"]="";
$elem["partman-swapfile/progress_swap_formatting"]["default"]="";
...
$elem["tzsetup/geoip_server"]["default"]="https://geoip.ubuntu.com/lookup";
...
$elem["tzsetup/country/CY"]["type"]="select";
$elem["tzsetup/country/CY"]["choices"][1]="Asia/Nicosia (Cyprus (most areas))";
$elem["tzsetup/country/CY"]["description"]="zone

";
$elem["tzsetup/country/CY"]["descriptionde"]="";
$elem["tzsetup/country/CY"]["descriptionfr"]="";
$elem["tzsetup/country/CY"]["default"]="";
