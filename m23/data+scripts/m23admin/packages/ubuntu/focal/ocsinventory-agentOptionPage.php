...
$elem["ocsinventory-agent/server"]["description"]="OCS Inventory server URL:
 Please enter the URL of the OCS inventory server.
";
$elem["ocsinventory-agent/server"]["descriptionde"]="URL des OCS-Inventory-Servers:
 Bitte geben Sie die URL des OCS-Inventory-Servers ein.
";
$elem["ocsinventory-agent/server"]["descriptionfr"]="Nom d'hôte du serveur d'inventaire OCS :
 Veuillez indiquer l'URL du serveur d'inventaire OCS.
";
