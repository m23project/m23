...
$elem["manila/configure_api-endpoint"]["type"]="boolean";
$elem["manila/configure_api-endpoint"]["description"]="Register this service in the Keystone endpoint catalog?
...
";
$elem["manila/configure_api-endpoint"]["descriptionde"]="Diesen Dienst im Keystone-Endpunktkatalog registrieren?
...
";
$elem["manila/configure_api-endpoint"]["descriptionfr"]="Voulez-vous enregistrer ce service dans le catalogue de points d'accès de Keystone ?
...
";
$elem["manila/configure_api-endpoint"]["default"]="false";
$elem["manila/api-keystone-address"]["type"]="string";
$elem["manila/api-keystone-address"]["description"]="Keystone server address:
 ...
 registration.
";
$elem["manila/api-keystone-address"]["descriptionde"]="Adresse des Keystone-Servers:
...
";
$elem["manila/api-keystone-address"]["descriptionfr"]="Adresse du point d'accès Keystone :
...
";
$elem["manila/api-keystone-address"]["default"]="";
$elem["manila/api-keystone-proto"]["type"]="select";
$elem["manila/api-keystone-proto"]["choices"][1]="http";
$elem["manila/api-keystone-proto"]["description"]="Keystone endpoint protocol:
";
$elem["manila/api-keystone-proto"]["descriptionde"]="Keystone-Endpunktprotokoll:
";
$elem["manila/api-keystone-proto"]["descriptionfr"]="Protocole du point d'accès Keystone :
";
$elem["manila/api-keystone-proto"]["default"]="http";
$elem["manila/api-keystone-admin-username"]["type"]="string";
$elem["manila/api-keystone-admin-username"]["description"]="Keystone admin username:
 ...
 Keystone API.
";
$elem["manila/api-keystone-admin-username"]["descriptionde"]="Keystone-Administratorbenutzername:
...
";
$elem["manila/api-keystone-admin-username"]["descriptionfr"]="Nom d'utilisateur de l'administrateur Keystone :
...
";
$elem["manila/api-keystone-admin-username"]["default"]="admin";
$elem["manila/api-keystone-admin-project-name"]["type"]="string";
$elem["manila/api-keystone-admin-project-name"]["description"]="Keystone admin project name:
 To create the service endpoint, this package needs to know the Admin
 username, project name, and password, so it can issue commands through the
 Keystone API.
";
$elem["manila/api-keystone-admin-project-name"]["descriptionde"]="Keystone-Administratorprojektname:
 Um den Dienstendpunkt zu erstellen, muss dieses Paket den Administratorbenutzernamen, Projektnamen und das Passwort kennen, um Befehle über die Keystone-API zu erteilen.
";
$elem["manila/api-keystone-admin-project-name"]["descriptionfr"]="Nom du projet administrateur Keystone :
 Pour créer le service de point d'accès, ce paquet a besoin de connaître le nom d'utilisateur de l'administrateur, le nom du projet, ainsi que le mot de passe. Il peut ainsi exécuter des commandes au travers de l'API Keystone.
";
$elem["manila/api-keystone-admin-project-name"]["default"]="admin";
$elem["manila/api-keystone-admin-password"]["type"]="password";
$elem["manila/api-keystone-admin-password"]["description"]="Keystone admin password:
 To create the service endpoint, this package needs to know the Admin
 username, project name, and password, so it can issue commands through the
 Keystone API.
";
$elem["manila/api-keystone-admin-password"]["descriptionde"]="Keystone-Administratorpasswort:
 Um den Dienstendpunkt zu erstellen, muss dieses Paket den Administratorbenutzernamen, Projektnamen und das Passwort kennen, um Befehle über die Keystone-API zu erteilen.
";
$elem["manila/api-keystone-admin-password"]["descriptionfr"]="Mot de passe administrateur Keystone :
 Pour créer le service de point d'accès, ce paquet a besoin de connaître le nom d'utilisateur de l'administrateur, le nom du projet, ainsi que le mot de passe. Il peut ainsi exécuter des commandes au travers de l'API Keystone.
";
$elem["manila/api-keystone-admin-password"]["default"]="";
$elem["manila/api-endpoint-address"]["type"]="string";
$elem["manila/api-endpoint-address"]["description"]="This service endpoint address:
...
";
$elem["manila/api-endpoint-address"]["descriptionde"]="Endpunktadresse dieses Dienstes:
...
";
$elem["manila/api-endpoint-address"]["descriptionfr"]="Adresse de ce service de point d'accès :
...
";
$elem["manila/api-endpoint-address"]["default"]="";
$elem["manila/api-endpoint-proto"]["type"]="select";
$elem["manila/api-endpoint-proto"]["choices"][1]="http";
$elem["manila/api-endpoint-proto"]["description"]="This service endpoint protocol:
";
$elem["manila/api-endpoint-proto"]["descriptionde"]="Endpunktprotokoll dieses Dienstes:
";
$elem["manila/api-endpoint-proto"]["descriptionfr"]="Protocole de ce service de point d'accès :
";
$elem["manila/api-endpoint-proto"]["default"]="http";
$elem["manila/api-endpoint-region-name"]["type"]="string";
$elem["manila/api-endpoint-region-name"]["description"]="Name of the region to register:
...
";
$elem["manila/api-endpoint-region-name"]["descriptionde"]="Name der Region, die registriert wird:
...
";
$elem["manila/api-endpoint-region-name"]["descriptionfr"]="Nom de la région à enregistrer :
...
";
$elem["manila/api-endpoint-region-name"]["default"]="regionOne";
