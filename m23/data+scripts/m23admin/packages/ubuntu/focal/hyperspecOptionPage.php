...
$elem["hyperspec/downloading"]["descriptionde"]="Das Hyperspec-Buch aus dem Internet herunterladen?
 Sie haben die Datei /root/tmp/HyperSpec-7-0.tar.gz nicht. Eventuell möchten Sie zuerst diese Datei jetzt aus dem Internet herunterladen und danach mit der Installation fortfahren.
";
$elem["hyperspec/downloading"]["descriptionfr"]="Faut-il télécharger le livre depuis Internet ?
 Le livre électronique sur hyperspec n'est pas présent sur votre système. Vous pouvez télécharger maintenant le fichier « /root/tmp/HyperSpec-7-0.tar.gz » depuis Internet et l'installer plus tard.
";
