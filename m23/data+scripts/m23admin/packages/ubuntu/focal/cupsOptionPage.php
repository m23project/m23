...
$elem["cupsys/backend"]["choices"][1]="lpd";
$elem["cupsys/backend"]["choices"][2]="socket";
$elem["cupsys/backend"]["choices"][3]="usb";
$elem["cupsys/backend"]["choices"][4]="snmp";
$elem["cupsys/backend"]["choicesde"][1]="lpd";
$elem["cupsys/backend"]["choicesde"][2]="Socket";
$elem["cupsys/backend"]["choicesde"][3]="USB";
$elem["cupsys/backend"]["choicesde"][4]="SNMP";
$elem["cupsys/backend"]["choicesfr"][1]="lpd";
$elem["cupsys/backend"]["choicesfr"][2]="socket";
$elem["cupsys/backend"]["choicesfr"][3]="USB";
$elem["cupsys/backend"]["choicesfr"][4]="SNMP";
...
";
$elem["cupsys/backend"]["default"]="lpd, socket, usb, snmp, dnssd";
