...
$elem["sqwebmail/install-www"]["descriptionfr"]="Méthode d'installation des documents et images HTML :
 Les documents et les images HTML placés dans /usr/share/sqwebmail peuvent être rendus accessibles dans /var/www/sqwebmail à l’aide d’un lien symbolique, copiés à cet emplacement dans un répertoire ou ne pas être accessibles du tout.
 .
 L'option « Copie » est recommandée pour des raisons de sécurité. Cependant, si les options « FollowSymLinks » ou « SymLinksIfOwnerMatch » sont déjà activées dans la configuration d'Apache, l'option « Lien symbolique » peut être choisie. Cette dernière option impose une configuration manuelle du serveur web.
 .
