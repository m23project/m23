...
$params = PKG_OptionPageHeader2("octavia-api");

$elem["octavia/configure_api-endpoint"]["type"]="boolean";
$elem["octavia/configure_api-endpoint"]["description"]="Register this service in the Keystone endpoint catalog?
...
";
$elem["octavia/configure_api-endpoint"]["descriptionde"]="Diesen Dienst im Keystone-Endpunktkatalog registrieren?
...
";
$elem["octavia/configure_api-endpoint"]["descriptionfr"]="Voulez-vous enregistrer ce service dans le catalogue de points d'accès de Keystone ?
...
";
$elem["octavia/configure_api-endpoint"]["default"]="false";
$elem["octavia/api-keystone-address"]["type"]="string";
$elem["octavia/api-keystone-address"]["description"]="Keystone server address:
 ...
 registration.
";
$elem["octavia/api-keystone-address"]["descriptionde"]="Adresse des Keystone-Servers:
...
";
$elem["octavia/api-keystone-address"]["descriptionfr"]="Adresse du point d'accès Keystone :
...
";
$elem["octavia/api-keystone-address"]["default"]="";
$elem["octavia/api-keystone-proto"]["type"]="select";
$elem["octavia/api-keystone-proto"]["choices"][1]="http";
$elem["octavia/api-keystone-proto"]["description"]="Keystone endpoint protocol:
";
$elem["octavia/api-keystone-proto"]["descriptionde"]="Keystone-Endpunktprotokoll:
";
$elem["octavia/api-keystone-proto"]["descriptionfr"]="Protocole du point d'accès Keystone :
";
$elem["octavia/api-keystone-proto"]["default"]="http";
$elem["octavia/api-keystone-admin-username"]["type"]="string";
$elem["octavia/api-keystone-admin-username"]["description"]="Keystone admin username:
 ...
 Keystone API.
";
$elem["octavia/api-keystone-admin-username"]["descriptionde"]="Keystone-Administratorbenutzername:
...
";
$elem["octavia/api-keystone-admin-username"]["descriptionfr"]="Nom d'utilisateur de l'administrateur Keystone :
...
";
$elem["octavia/api-keystone-admin-username"]["default"]="admin";
$elem["octavia/api-keystone-admin-project-name"]["type"]="string";
$elem["octavia/api-keystone-admin-project-name"]["description"]="Keystone admin project name:
 To create the service endpoint, this package needs to know the Admin
 username, project name, and password, so it can issue commands through the
 Keystone API.
";
$elem["octavia/api-keystone-admin-project-name"]["descriptionde"]="Keystone-Administratorprojektname:
 Um den Dienstendpunkt zu erstellen, muss dieses Paket den Administratorbenutzernamen, Projektnamen und das Passwort kennen, um Befehle über die Keystone-API zu erteilen.
";
$elem["octavia/api-keystone-admin-project-name"]["descriptionfr"]="Nom du projet administrateur Keystone :
 Pour créer le service de point d'accès, ce paquet a besoin de connaître le nom d'utilisateur de l'administrateur, le nom du projet, ainsi que le mot de passe. Il peut ainsi exécuter des commandes au travers de l'API Keystone.
";
$elem["octavia/api-keystone-admin-project-name"]["default"]="admin";
$elem["octavia/api-keystone-admin-password"]["type"]="password";
$elem["octavia/api-keystone-admin-password"]["description"]="Keystone admin password:
 To create the service endpoint, this package needs to know the Admin
 username, project name, and password, so it can issue commands through the
 Keystone API.
";
$elem["octavia/api-keystone-admin-password"]["descriptionde"]="Keystone-Administratorpasswort:
 Um den Dienstendpunkt zu erstellen, muss dieses Paket den Administratorbenutzernamen, Projektnamen und das Passwort kennen, um Befehle über die Keystone-API zu erteilen.
";
$elem["octavia/api-keystone-admin-password"]["descriptionfr"]="Mot de passe administrateur Keystone :
 Pour créer le service de point d'accès, ce paquet a besoin de connaître le nom d'utilisateur de l'administrateur, le nom du projet, ainsi que le mot de passe. Il peut ainsi exécuter des commandes au travers de l'API Keystone.
";
$elem["octavia/api-keystone-admin-password"]["default"]="";
$elem["octavia/api-endpoint-address"]["type"]="string";
$elem["octavia/api-endpoint-address"]["description"]="This service endpoint address:
...
";
$elem["octavia/api-endpoint-address"]["descriptionde"]="Endpunktadresse dieses Dienstes:
...
";
$elem["octavia/api-endpoint-address"]["descriptionfr"]="Adresse de ce service de point d'accès :
...
";
$elem["octavia/api-endpoint-address"]["default"]="";
$elem["octavia/api-endpoint-proto"]["type"]="select";
$elem["octavia/api-endpoint-proto"]["choices"][1]="http";
$elem["octavia/api-endpoint-proto"]["description"]="This service endpoint protocol:
";
$elem["octavia/api-endpoint-proto"]["descriptionde"]="Endpunktprotokoll dieses Dienstes:
";
$elem["octavia/api-endpoint-proto"]["descriptionfr"]="Protocole de ce service de point d'accès :
";
$elem["octavia/api-endpoint-proto"]["default"]="http";
$elem["octavia/api-endpoint-region-name"]["type"]="string";
$elem["octavia/api-endpoint-region-name"]["description"]="Name of the region to register:
...
";
$elem["octavia/api-endpoint-region-name"]["descriptionde"]="Name der Region, die registriert wird:
...
";
$elem["octavia/api-endpoint-region-name"]["descriptionfr"]="Nom de la région à enregistrer :
...
";
$elem["octavia/api-endpoint-region-name"]["default"]="regionOne";
