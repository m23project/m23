...
$elem["sahara/configure_db"]["description"]="Set up a database for this package?
...
";
$elem["sahara/configure_db"]["descriptionde"]="Eine Datenbank für dieses Paket einrichten?
...
";
$elem["sahara/configure_db"]["descriptionfr"]="Voulez-vous installer une base de données pour ce paquet ?
...
$elem["sahara/configure_rabbit"]["type"]="boolean";
$elem["sahara/configure_rabbit"]["description"]="Configure RabbitMQ access with debconf?
 ...
 connections.
";
$elem["sahara/configure_rabbit"]["descriptionde"]="Soll der RabbitMQ-Zugriff mit Debconf konfiguriert werden?
...
";
$elem["sahara/configure_rabbit"]["descriptionfr"]="Voulez-vous configurer les accès à RabbitMQ avec les écrans de configuration debconf ?
...
";
$elem["sahara/configure_rabbit"]["default"]="false";
$elem["sahara/rabbit-host"]["type"]="string";
$elem["sahara/rabbit-host"]["description"]="IP address of your RabbitMQ host:
 In order to interoperate with other components of OpenStack, this package
 needs to connect to a central RabbitMQ server.
 .
 Please specify the IP address of that server.
";
$elem["sahara/rabbit-host"]["descriptionde"]="IP-Adresse Ihres RabbitMQ-Rechners:
...
";
$elem["sahara/rabbit-host"]["descriptionfr"]="Adresse IP de votre hôte RabbitMQ :
...
";
$elem["sahara/rabbit-host"]["default"]="localhost";
$elem["sahara/rabbit-userid"]["type"]="string";
$elem["sahara/rabbit-userid"]["description"]="Username for connection to the RabbitMQ server:
 In order to interoperate with other components of OpenStack, this package
 needs to connect to a central RabbitMQ server.
 .
 Please specify the username used to connect to that RabbitMQ server.
";
$elem["sahara/rabbit-userid"]["descriptionde"]="Benutzername für die Verbindung mit dem RabbitMQ-Server:
 Um mit weiteren Bestandteilen von OpenStack zusammenzuarbeiten, muss sich dieses Paket mit einem zentralen RabbitMQ-Server verbinden.
 .
 Bitte geben Sie den Benutzernamen ein, den Sie zum Verbinden mit diesem RabbitMQ-Server verwenden.
";
$elem["sahara/rabbit-userid"]["descriptionfr"]="Nom d'utilisateur pour la connexion au serveur RabbitMQ :
 Afin de pouvoir interagir avec d'autres composants d'OpenStack, ce paquet doit se connecter à un serveur centralisé RabbitMQ.
 .
 Veuillez indiquer le nom d'utilisateur à utiliser pour se connecter au serveur RabbitMQ.
";
$elem["sahara/rabbit-userid"]["default"]="guest";
$elem["sahara/rabbit-password"]["type"]="password";
$elem["sahara/rabbit-password"]["description"]="Password for connection to the RabbitMQ server:
 In order to interoperate with other components of OpenStack, this package
 needs to connect to a central RabbitMQ server.
 .
 Please specify the password used to connect to that RabbitMQ server.
";
$elem["sahara/rabbit-password"]["descriptionde"]="Passwort für die Verbindung mit dem RabbitMQ-Server:
 Um mit weiteren Bestandteilen von OpenStack zusammenzuarbeiten, muss sich dieses Paket mit einem zentralen RabbitMQ-Server verbinden.
 .
 Bitte geben Sie das Passwort ein, das Sie zum Verbinden mit diesem RabbitMQ-Server verwenden.
";
$elem["sahara/rabbit-password"]["descriptionfr"]="Mot de passe pour la connexion au serveur RabbitMQ :
 Afin de pouvoir interagir avec d'autres composants d'OpenStack, ce paquet doit se connecter à un serveur centralisé RabbitMQ.
 .
 Veuillez indiquer le mot de passe à utiliser pour se connecter au serveur RabbitMQ.
";
$elem["sahara/rabbit-password"]["default"]="";
$elem["sahara/configure_ksat"]["type"]="boolean";
$elem["sahara/configure_ksat"]["description"]="Manage keystone_authtoken with debconf?
...
";
$elem["sahara/configure_ksat"]["descriptionde"]="Soll »keystone_authtoken« mit Debconf verwaltet werden?
...
";
$elem["sahara/configure_ksat"]["descriptionfr"]="Voulez-vous gérer le jeton d'authentification keystone (« keystone_authtoken ») avec les écrans de configuration debconf ?
...
";
$elem["sahara/configure_ksat"]["default"]="false";
$elem["sahara/ksat-public-url"]["type"]="string";
$elem["sahara/ksat-public-url"]["description"]="Auth server public endpoint URL:
...
";
$elem["sahara/ksat-public-url"]["descriptionde"]="Öffentlicher Endpunkt-URL des Authentifizierungsservers:
...
";
$elem["sahara/ksat-public-url"]["descriptionfr"]="Adresse URL du point d'accès public pour le serveur d'authentification :
...
";
$elem["sahara/ksat-public-url"]["default"]="http://localhost:5000";
$elem["sahara/ksat-region"]["type"]="string";
$elem["sahara/ksat-region"]["description"]="Keystone region:
 Specify the Keystone region to use.
 .
 The region name is usually a string containing only ASCII alphanumerics,
 dots, and dashes.
";
$elem["sahara/ksat-region"]["descriptionde"]="Keystone-Region:
...
";
$elem["sahara/ksat-region"]["descriptionfr"]="Région Keystone :
...
";
$elem["sahara/ksat-region"]["default"]="regionOne";
$elem["sahara/ksat-create-service-user"]["type"]="boolean";
$elem["sahara/ksat-create-service-user"]["description"]="Create service user?
...
";
$elem["sahara/ksat-create-service-user"]["descriptionde"]="Dienstbenutzer erstellen?
...
";
$elem["sahara/ksat-create-service-user"]["descriptionfr"]="Voulez-vous créer un utilisateur du service ?
...
";
$elem["sahara/ksat-create-service-user"]["default"]="true";
$elem["sahara/ksat-admin-username"]["type"]="string";
$elem["sahara/ksat-admin-username"]["description"]="Auth server admin username:
";
$elem["sahara/ksat-admin-username"]["descriptionde"]="Administratorbenutzername des Authentifizierungsservers:
";
$elem["sahara/ksat-admin-username"]["descriptionfr"]="Nom d'utilisateur administrateur pour le serveur d'authentification :
";
$elem["sahara/ksat-admin-username"]["default"]="admin";
$elem["sahara/ksat-admin-project-name"]["type"]="string";
$elem["sahara/ksat-admin-project-name"]["description"]="Auth server admin project name:
";
$elem["sahara/ksat-admin-project-name"]["descriptionde"]="Administratorprojektname des Authentifizierungsservers:
";
$elem["sahara/ksat-admin-project-name"]["descriptionfr"]="Nom du projet administrateur pour le serveur d'authentification :
";
$elem["sahara/ksat-admin-project-name"]["default"]="admin";
$elem["sahara/ksat-admin-password"]["type"]="password";
$elem["sahara/ksat-admin-password"]["description"]="Auth server admin password:
";
$elem["sahara/ksat-admin-password"]["descriptionde"]="Administratorpasswort des Authentifizierungsservers:
";
$elem["sahara/ksat-admin-password"]["descriptionfr"]="Mot de passe administrateur pour le serveur d'authentification :
";
$elem["sahara/ksat-admin-password"]["default"]="";
$elem["sahara/ksat-service-username"]["type"]="string";
$elem["sahara/ksat-service-username"]["description"]="Auth server service username:
";
$elem["sahara/ksat-service-username"]["descriptionde"]="Dienstbenutzername des Authentifizierungsservers:
";
$elem["sahara/ksat-service-username"]["descriptionfr"]="Nom d'utilisateur pour le serveur du service d'authentification :
";
$elem["sahara/ksat-service-username"]["default"]="";
$elem["sahara/ksat-service-project-name"]["type"]="string";
$elem["sahara/ksat-service-project-name"]["description"]="Auth server service project name:
";
$elem["sahara/ksat-service-project-name"]["descriptionde"]="Dienstprojektname des Authentifizierungsservers:
";
$elem["sahara/ksat-service-project-name"]["descriptionfr"]="Nom du projet pour le serveur du service d'authentification :
";
$elem["sahara/ksat-service-project-name"]["default"]="service";
$elem["sahara/ksat-service-password"]["type"]="password";
$elem["sahara/ksat-service-password"]["description"]="Auth server service password:
";
$elem["sahara/ksat-service-password"]["descriptionde"]="Dienstpasswort des Authentifizierungsservers:
";
$elem["sahara/ksat-service-password"]["descriptionfr"]="Mot de passe pour le serveur du service d'authentification :
";
$elem["sahara/ksat-service-password"]["default"]="";
