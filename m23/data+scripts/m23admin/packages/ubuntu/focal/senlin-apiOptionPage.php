...
$elem["senlin/configure_api-endpoint"]["type"]="boolean";
$elem["senlin/configure_api-endpoint"]["description"]="Register this service in the Keystone endpoint catalog?
...
";
$elem["senlin/configure_api-endpoint"]["descriptionde"]="Diesen Dienst im Keystone-Endpunktkatalog registrieren?
...
";
$elem["senlin/configure_api-endpoint"]["descriptionfr"]="Voulez-vous enregistrer ce service dans le catalogue de points d'accès de Keystone ?
...
";
$elem["senlin/configure_api-endpoint"]["default"]="false";
$elem["senlin/api-keystone-address"]["type"]="string";
$elem["senlin/api-keystone-address"]["description"]="Keystone server address:
 ...
 registration.
";
$elem["senlin/api-keystone-address"]["descriptionde"]="Adresse des Keystone-Servers:
...
";
$elem["senlin/api-keystone-address"]["descriptionfr"]="Adresse du point d'accès Keystone :
...
";
$elem["senlin/api-keystone-address"]["default"]="";
$elem["senlin/api-keystone-proto"]["type"]="select";
$elem["senlin/api-keystone-proto"]["choices"][1]="http";
$elem["senlin/api-keystone-proto"]["description"]="Keystone endpoint protocol:
";
$elem["senlin/api-keystone-proto"]["descriptionde"]="Keystone-Endpunktprotokoll:
";
$elem["senlin/api-keystone-proto"]["descriptionfr"]="Protocole du point d'accès Keystone :
";
$elem["senlin/api-keystone-proto"]["default"]="http";
$elem["senlin/api-keystone-admin-username"]["type"]="string";
$elem["senlin/api-keystone-admin-username"]["description"]="Keystone admin username:
 ...
 Keystone API.
";
$elem["senlin/api-keystone-admin-username"]["descriptionde"]="Keystone-Administratorbenutzername:
...
";
$elem["senlin/api-keystone-admin-username"]["descriptionfr"]="Nom d'utilisateur de l'administrateur Keystone :
...
";
$elem["senlin/api-keystone-admin-username"]["default"]="admin";
$elem["senlin/api-keystone-admin-project-name"]["type"]="string";
$elem["senlin/api-keystone-admin-project-name"]["description"]="Keystone admin project name:
 To create the service endpoint, this package needs to know the Admin
 username, project name, and password, so it can issue commands through the
 Keystone API.
";
$elem["senlin/api-keystone-admin-project-name"]["descriptionde"]="Keystone-Administratorprojektname:
 Um den Dienstendpunkt zu erstellen, muss dieses Paket den Administratorbenutzernamen, Projektnamen und das Passwort kennen, um Befehle über die Keystone-API zu erteilen.
";
$elem["senlin/api-keystone-admin-project-name"]["descriptionfr"]="Nom du projet administrateur Keystone :
 Pour créer le service de point d'accès, ce paquet a besoin de connaître le nom d'utilisateur de l'administrateur, le nom du projet, ainsi que le mot de passe. Il peut ainsi exécuter des commandes au travers de l'API Keystone.
";
$elem["senlin/api-keystone-admin-project-name"]["default"]="admin";
$elem["senlin/api-keystone-admin-password"]["type"]="password";
$elem["senlin/api-keystone-admin-password"]["description"]="Keystone admin password:
 To create the service endpoint, this package needs to know the Admin
 username, project name, and password, so it can issue commands through the
 Keystone API.
";
$elem["senlin/api-keystone-admin-password"]["descriptionde"]="Keystone-Administratorpasswort:
 Um den Dienstendpunkt zu erstellen, muss dieses Paket den Administratorbenutzernamen, Projektnamen und das Passwort kennen, um Befehle über die Keystone-API zu erteilen.
";
$elem["senlin/api-keystone-admin-password"]["descriptionfr"]="Mot de passe administrateur Keystone :
 Pour créer le service de point d'accès, ce paquet a besoin de connaître le nom d'utilisateur de l'administrateur, le nom du projet, ainsi que le mot de passe. Il peut ainsi exécuter des commandes au travers de l'API Keystone.
";
$elem["senlin/api-keystone-admin-password"]["default"]="";
$elem["senlin/api-endpoint-address"]["type"]="string";
$elem["senlin/api-endpoint-address"]["description"]="This service endpoint address:
...
";
$elem["senlin/api-endpoint-address"]["descriptionde"]="Endpunktadresse dieses Dienstes:
...
";
$elem["senlin/api-endpoint-address"]["descriptionfr"]="Adresse de ce service de point d'accès :
...
";
$elem["senlin/api-endpoint-address"]["default"]="";
$elem["senlin/api-endpoint-proto"]["type"]="select";
$elem["senlin/api-endpoint-proto"]["choices"][1]="http";
$elem["senlin/api-endpoint-proto"]["description"]="This service endpoint protocol:
";
$elem["senlin/api-endpoint-proto"]["descriptionde"]="Endpunktprotokoll dieses Dienstes:
";
$elem["senlin/api-endpoint-proto"]["descriptionfr"]="Protocole de ce service de point d'accès :
";
$elem["senlin/api-endpoint-proto"]["default"]="http";
$elem["senlin/api-endpoint-region-name"]["type"]="string";
$elem["senlin/api-endpoint-region-name"]["description"]="Name of the region to register:
...
";
$elem["senlin/api-endpoint-region-name"]["descriptionde"]="Name der Region, die registriert wird:
...
";
$elem["senlin/api-endpoint-region-name"]["descriptionfr"]="Nom de la région à enregistrer :
...
";
$elem["senlin/api-endpoint-region-name"]["default"]="regionOne";
