...
$elem["courier-webadmin/install-cgi"]["descriptionfr"]="Faut-il activer le programme CGI ?
 Pour que courier-webadmin fonctionne sans modifications, il est nécessaire de copier le programme CGI de /usr/lib/courier/courier/webmail/webadmin vers /usr/lib/cgi-bin/courierwebadmin et d'activer le bit SUID.
 .
