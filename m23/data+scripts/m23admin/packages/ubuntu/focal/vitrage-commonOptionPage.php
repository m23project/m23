...
$params = PKG_OptionPageHeader2("vitrage-common");

$elem["vitrage/configure_db"]["type"]="boolean";
$elem["vitrage/configure_db"]["description"]="Set up a database for this package?
...
";
$elem["vitrage/configure_db"]["descriptionde"]="Eine Datenbank für dieses Paket einrichten?
...
";
$elem["vitrage/configure_db"]["descriptionfr"]="Voulez-vous installer une base de données pour ce paquet ?
...
";
$elem["vitrage/configure_db"]["default"]="false";
$elem["vitrage/configure_rabbit"]["type"]="boolean";
$elem["vitrage/configure_rabbit"]["description"]="Configure RabbitMQ access with debconf?
 ...
 connections.
";
$elem["vitrage/configure_rabbit"]["descriptionde"]="Soll der RabbitMQ-Zugriff mit Debconf konfiguriert werden?
...
";
$elem["vitrage/configure_rabbit"]["descriptionfr"]="Voulez-vous configurer les accès à RabbitMQ avec les écrans de configuration debconf ?
...
";
$elem["vitrage/configure_rabbit"]["default"]="false";
$elem["vitrage/rabbit-host"]["type"]="string";
$elem["vitrage/rabbit-host"]["description"]="IP address of your RabbitMQ host:
 In order to interoperate with other components of OpenStack, this package
 needs to connect to a central RabbitMQ server.
 .
 Please specify the IP address of that server.
";
$elem["vitrage/rabbit-host"]["descriptionde"]="IP-Adresse Ihres RabbitMQ-Rechners:
...
";
$elem["vitrage/rabbit-host"]["descriptionfr"]="Adresse IP de votre hôte RabbitMQ :
...
";
$elem["vitrage/rabbit-host"]["default"]="localhost";
$elem["vitrage/rabbit-userid"]["type"]="string";
$elem["vitrage/rabbit-userid"]["description"]="Username for connection to the RabbitMQ server:
 In order to interoperate with other components of OpenStack, this package
 needs to connect to a central RabbitMQ server.
 .
 Please specify the username used to connect to that RabbitMQ server.
";
$elem["vitrage/rabbit-userid"]["descriptionde"]="Benutzername für die Verbindung mit dem RabbitMQ-Server:
 Um mit weiteren Bestandteilen von OpenStack zusammenzuarbeiten, muss sich dieses Paket mit einem zentralen RabbitMQ-Server verbinden.
 .
 Bitte geben Sie den Benutzernamen ein, den Sie zum Verbinden mit diesem RabbitMQ-Server verwenden.
";
$elem["vitrage/rabbit-userid"]["descriptionfr"]="Nom d'utilisateur pour la connexion au serveur RabbitMQ :
 Afin de pouvoir interagir avec d'autres composants d'OpenStack, ce paquet doit se connecter à un serveur centralisé RabbitMQ.
 .
 Veuillez indiquer le nom d'utilisateur à utiliser pour se connecter au serveur RabbitMQ.
";
$elem["vitrage/rabbit-userid"]["default"]="guest";
$elem["vitrage/rabbit-password"]["type"]="password";
$elem["vitrage/rabbit-password"]["description"]="Password for connection to the RabbitMQ server:
 In order to interoperate with other components of OpenStack, this package
 needs to connect to a central RabbitMQ server.
 .
 Please specify the password used to connect to that RabbitMQ server.
";
$elem["vitrage/rabbit-password"]["descriptionde"]="Passwort für die Verbindung mit dem RabbitMQ-Server:
 Um mit weiteren Bestandteilen von OpenStack zusammenzuarbeiten, muss sich dieses Paket mit einem zentralen RabbitMQ-Server verbinden.
 .
 Bitte geben Sie das Passwort ein, das Sie zum Verbinden mit diesem RabbitMQ-Server verwenden.
";
$elem["vitrage/rabbit-password"]["descriptionfr"]="Mot de passe pour la connexion au serveur RabbitMQ :
 Afin de pouvoir interagir avec d'autres composants d'OpenStack, ce paquet doit se connecter à un serveur centralisé RabbitMQ.
 .
 Veuillez indiquer le mot de passe à utiliser pour se connecter au serveur RabbitMQ.
";
$elem["vitrage/rabbit-password"]["default"]="";
$elem["vitrage/configure_ksat"]["type"]="boolean";
$elem["vitrage/configure_ksat"]["description"]="Manage keystone_authtoken with debconf?
...
";
$elem["vitrage/configure_ksat"]["descriptionde"]="Soll »keystone_authtoken« mit Debconf verwaltet werden?
...
";
$elem["vitrage/configure_ksat"]["descriptionfr"]="Voulez-vous gérer le jeton d'authentification keystone (« keystone_authtoken ») avec les écrans de configuration debconf ?
...
";
$elem["vitrage/configure_ksat"]["default"]="false";
$elem["vitrage/ksat-public-url"]["type"]="string";
$elem["vitrage/ksat-public-url"]["description"]="Auth server public endpoint URL:
...
";
$elem["vitrage/ksat-public-url"]["descriptionde"]="Öffentlicher Endpunkt-URL des Authentifizierungsservers:
...
";
$elem["vitrage/ksat-public-url"]["descriptionfr"]="Adresse URL du point d'accès public pour le serveur d'authentification :
...
";
$elem["vitrage/ksat-public-url"]["default"]="http://localhost:5000";
$elem["vitrage/ksat-region"]["type"]="string";
$elem["vitrage/ksat-region"]["description"]="Keystone region:
 Specify the Keystone region to use.
 .
 The region name is usually a string containing only ASCII alphanumerics,
 dots, and dashes.
";
$elem["vitrage/ksat-region"]["descriptionde"]="Keystone-Region:
...
";
$elem["vitrage/ksat-region"]["descriptionfr"]="Région Keystone :
...
";
$elem["vitrage/ksat-region"]["default"]="regionOne";
$elem["vitrage/ksat-create-service-user"]["type"]="boolean";
$elem["vitrage/ksat-create-service-user"]["description"]="Create service user?
...
";
$elem["vitrage/ksat-create-service-user"]["descriptionde"]="Dienstbenutzer erstellen?
...
";
$elem["vitrage/ksat-create-service-user"]["descriptionfr"]="Voulez-vous créer un utilisateur du service ?
...
";
$elem["vitrage/ksat-create-service-user"]["default"]="true";
$elem["vitrage/ksat-admin-username"]["type"]="string";
$elem["vitrage/ksat-admin-username"]["description"]="Auth server admin username:
";
$elem["vitrage/ksat-admin-username"]["descriptionde"]="Administratorbenutzername des Authentifizierungsservers:
";
$elem["vitrage/ksat-admin-username"]["descriptionfr"]="Nom d'utilisateur administrateur pour le serveur d'authentification :
";
$elem["vitrage/ksat-admin-username"]["default"]="admin";
$elem["vitrage/ksat-admin-project-name"]["type"]="string";
$elem["vitrage/ksat-admin-project-name"]["description"]="Auth server admin project name:
";
$elem["vitrage/ksat-admin-project-name"]["descriptionde"]="Administratorprojektname des Authentifizierungsservers:
";
$elem["vitrage/ksat-admin-project-name"]["descriptionfr"]="Nom du projet administrateur pour le serveur d'authentification :
";
$elem["vitrage/ksat-admin-project-name"]["default"]="admin";
$elem["vitrage/ksat-admin-password"]["type"]="password";
$elem["vitrage/ksat-admin-password"]["description"]="Auth server admin password:
";
$elem["vitrage/ksat-admin-password"]["descriptionde"]="Administratorpasswort des Authentifizierungsservers:
";
$elem["vitrage/ksat-admin-password"]["descriptionfr"]="Mot de passe administrateur pour le serveur d'authentification :
";
$elem["vitrage/ksat-admin-password"]["default"]="";
$elem["vitrage/ksat-service-username"]["type"]="string";
$elem["vitrage/ksat-service-username"]["description"]="Auth server service username:
";
$elem["vitrage/ksat-service-username"]["descriptionde"]="Dienstbenutzername des Authentifizierungsservers:
";
$elem["vitrage/ksat-service-username"]["descriptionfr"]="Nom d'utilisateur pour le serveur du service d'authentification :
";
$elem["vitrage/ksat-service-username"]["default"]="";
$elem["vitrage/ksat-service-project-name"]["type"]="string";
$elem["vitrage/ksat-service-project-name"]["description"]="Auth server service project name:
";
$elem["vitrage/ksat-service-project-name"]["descriptionde"]="Dienstprojektname des Authentifizierungsservers:
";
$elem["vitrage/ksat-service-project-name"]["descriptionfr"]="Nom du projet pour le serveur du service d'authentification :
";
$elem["vitrage/ksat-service-project-name"]["default"]="service";
$elem["vitrage/ksat-service-password"]["type"]="password";
$elem["vitrage/ksat-service-password"]["description"]="Auth server service password:
";
$elem["vitrage/ksat-service-password"]["descriptionde"]="Dienstpasswort des Authentifizierungsservers:
";
$elem["vitrage/ksat-service-password"]["descriptionfr"]="Mot de passe pour le serveur du service d'authentification :
";
$elem["vitrage/ksat-service-password"]["default"]="";
