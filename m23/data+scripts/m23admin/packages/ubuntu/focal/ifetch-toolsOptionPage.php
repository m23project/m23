...
$elem["ifetch-tools/remove"]["type"]="boolean";
$elem["ifetch-tools/remove"]["description"]="Remove all ifetch-tools data, logs, and settings files?
...
";
$elem["ifetch-tools/remove"]["descriptionde"]="Alle Daten, Protokolle und Einrichtungsdateien von »ifetch-tools« entfernen?
...
";
$elem["ifetch-tools/remove"]["descriptionfr"]="Faut-il supprimer les données, journaux et réglages de ifetch-tools ?
...
";
$elem["ifetch-tools/remove"]["default"]="false";
