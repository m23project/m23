...
$elem["ucf/changeprompt_threeway"]["choicesde"][1]="Version des Paketbetreuers installieren";
$elem["ucf/changeprompt_threeway"]["choicesde"][2]="aktuell lokal installierte Version beibehalten";
...
$elem["ucf/changeprompt_threeway"]["choicesde"][5]="3-Wege-Unterschiede verfügbarer Versionen anzeigen";
$elem["ucf/changeprompt_threeway"]["choicesde"][6]="eine 3-Wege-Zusammenführung der verfügbaren Versionen durchführen";
...
$elem["ucf/changeprompt_threeway"]["choicesfr"][6]="Fusionner les différences entre les trois versions du fichier";
...
$elem["ucf/changeprompt_threeway"]["descriptionde"]="Wie wollen Sie mit der geänderten Konfigurationsdatei ${BASENAME} verfahren?
 Eine neue Version (${NEW}) der Konfigurationsdatei ${FILE} ist verfügbar, aber die derzeit installierte Version wurde verändert.
";
...
$elem["ucf/changeprompt"]["descriptionde"]="Wie wollen Sie mit der geänderten Konfigurationsdatei ${BASENAME} verfahren?
 ${BASENAME}: Eine neue Version (${NEW}) der Konfigurationsdatei ${FILE} ist verfügbar, aber die derzeit installierte Version wurde verändert.
";
$elem["ucf/changeprompt"]["descriptionfr"]="Action souhaitée pour le fichier de configuration modifié ${BASENAME} :
 ${BASENAME} : Une nouvelle version (${NEW}) du fichier de configuration ${FILE} est disponible mais la version actuellement utilisée a été modifiée localement.
";
...
";
$elem["ucf/conflicts_found"]["descriptionde"]="Konflikte bei der 3-Wege-Zusammenführung
 Es wurden Konflikte bei der 3-Wege-Zusammenführung festgestellt! Bitte passen Sie die Datei »${dest_file}« selbst an, um die Konflikte zu beseitigen.
 .
