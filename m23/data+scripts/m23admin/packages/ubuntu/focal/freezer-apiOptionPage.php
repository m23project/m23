...
$params = PKG_OptionPageHeader2("freezer-api");

$elem["freezer-api/configure_api-endpoint"]["type"]="boolean";
$elem["freezer-api/configure_api-endpoint"]["description"]="Register this service in the Keystone endpoint catalog?
...
";
$elem["freezer-api/configure_api-endpoint"]["descriptionde"]="Diesen Dienst im Keystone-Endpunktkatalog registrieren?
...
";
$elem["freezer-api/configure_api-endpoint"]["descriptionfr"]="Voulez-vous enregistrer ce service dans le catalogue de points d'accès de Keystone ?
...
";
$elem["freezer-api/configure_api-endpoint"]["default"]="false";
$elem["freezer-api/api-keystone-address"]["type"]="string";
$elem["freezer-api/api-keystone-address"]["description"]="Keystone server address:
 ...
 registration.
";
$elem["freezer-api/api-keystone-address"]["descriptionde"]="Adresse des Keystone-Servers:
...
";
$elem["freezer-api/api-keystone-address"]["descriptionfr"]="Adresse du point d'accès Keystone :
...
";
$elem["freezer-api/api-keystone-address"]["default"]="";
$elem["freezer-api/api-keystone-proto"]["type"]="select";
$elem["freezer-api/api-keystone-proto"]["choices"][1]="http";
$elem["freezer-api/api-keystone-proto"]["description"]="Keystone endpoint protocol:
";
$elem["freezer-api/api-keystone-proto"]["descriptionde"]="Keystone-Endpunktprotokoll:
";
$elem["freezer-api/api-keystone-proto"]["descriptionfr"]="Protocole du point d'accès Keystone :
";
$elem["freezer-api/api-keystone-proto"]["default"]="http";
$elem["freezer-api/api-keystone-admin-username"]["type"]="string";
$elem["freezer-api/api-keystone-admin-username"]["description"]="Keystone admin username:
 ...
 Keystone API.
";
$elem["freezer-api/api-keystone-admin-username"]["descriptionde"]="Keystone-Administratorbenutzername:
...
";
$elem["freezer-api/api-keystone-admin-username"]["descriptionfr"]="Nom d'utilisateur de l'administrateur Keystone :
...
";
$elem["freezer-api/api-keystone-admin-username"]["default"]="admin";
$elem["freezer-api/api-keystone-admin-project-name"]["type"]="string";
$elem["freezer-api/api-keystone-admin-project-name"]["description"]="Keystone admin project name:
 To create the service endpoint, this package needs to know the Admin
 username, project name, and password, so it can issue commands through the
 Keystone API.
";
$elem["freezer-api/api-keystone-admin-project-name"]["descriptionde"]="Keystone-Administratorprojektname:
 Um den Dienstendpunkt zu erstellen, muss dieses Paket den Administratorbenutzernamen, Projektnamen und das Passwort kennen, um Befehle über die Keystone-API zu erteilen.
";
$elem["freezer-api/api-keystone-admin-project-name"]["descriptionfr"]="Nom du projet administrateur Keystone :
 Pour créer le service de point d'accès, ce paquet a besoin de connaître le nom d'utilisateur de l'administrateur, le nom du projet, ainsi que le mot de passe. Il peut ainsi exécuter des commandes au travers de l'API Keystone.
";
$elem["freezer-api/api-keystone-admin-project-name"]["default"]="admin";
$elem["freezer-api/api-keystone-admin-password"]["type"]="password";
$elem["freezer-api/api-keystone-admin-password"]["description"]="Keystone admin password:
 To create the service endpoint, this package needs to know the Admin
 username, project name, and password, so it can issue commands through the
 Keystone API.
";
$elem["freezer-api/api-keystone-admin-password"]["descriptionde"]="Keystone-Administratorpasswort:
 Um den Dienstendpunkt zu erstellen, muss dieses Paket den Administratorbenutzernamen, Projektnamen und das Passwort kennen, um Befehle über die Keystone-API zu erteilen.
";
$elem["freezer-api/api-keystone-admin-password"]["descriptionfr"]="Mot de passe administrateur Keystone :
 Pour créer le service de point d'accès, ce paquet a besoin de connaître le nom d'utilisateur de l'administrateur, le nom du projet, ainsi que le mot de passe. Il peut ainsi exécuter des commandes au travers de l'API Keystone.
";
$elem["freezer-api/api-keystone-admin-password"]["default"]="";
$elem["freezer-api/api-endpoint-address"]["type"]="string";
$elem["freezer-api/api-endpoint-address"]["description"]="This service endpoint address:
...
";
$elem["freezer-api/api-endpoint-address"]["descriptionde"]="Endpunktadresse dieses Dienstes:
...
";
$elem["freezer-api/api-endpoint-address"]["descriptionfr"]="Adresse de ce service de point d'accès :
...
";
$elem["freezer-api/api-endpoint-address"]["default"]="";
$elem["freezer-api/api-endpoint-proto"]["type"]="select";
$elem["freezer-api/api-endpoint-proto"]["choices"][1]="http";
$elem["freezer-api/api-endpoint-proto"]["description"]="This service endpoint protocol:
";
$elem["freezer-api/api-endpoint-proto"]["descriptionde"]="Endpunktprotokoll dieses Dienstes:
";
$elem["freezer-api/api-endpoint-proto"]["descriptionfr"]="Protocole de ce service de point d'accès :
";
$elem["freezer-api/api-endpoint-proto"]["default"]="http";
$elem["freezer-api/api-endpoint-region-name"]["type"]="string";
$elem["freezer-api/api-endpoint-region-name"]["description"]="Name of the region to register:
...
";
$elem["freezer-api/api-endpoint-region-name"]["descriptionde"]="Name der Region, die registriert wird:
...
";
$elem["freezer-api/api-endpoint-region-name"]["descriptionfr"]="Nom de la région à enregistrer :
...
";
$elem["freezer-api/api-endpoint-region-name"]["default"]="regionOne";
$elem["freezer-api/configure_db"]["type"]="boolean";
$elem["freezer-api/configure_db"]["description"]="Set up a database for this package?
...
";
$elem["freezer-api/configure_db"]["descriptionde"]="Eine Datenbank für dieses Paket einrichten?
...
";
$elem["freezer-api/configure_db"]["descriptionfr"]="Voulez-vous installer une base de données pour ce paquet ?
...
";
$elem["freezer-api/configure_db"]["default"]="false";
$elem["freezer-api/configure_ksat"]["type"]="boolean";
$elem["freezer-api/configure_ksat"]["description"]="Manage keystone_authtoken with debconf?
...
";
$elem["freezer-api/configure_ksat"]["descriptionde"]="Soll »keystone_authtoken« mit Debconf verwaltet werden?
...
";
$elem["freezer-api/configure_ksat"]["descriptionfr"]="Voulez-vous gérer le jeton d'authentification keystone (« keystone_authtoken ») avec les écrans de configuration debconf ?
...
";
$elem["freezer-api/configure_ksat"]["default"]="false";
$elem["freezer-api/ksat-public-url"]["type"]="string";
$elem["freezer-api/ksat-public-url"]["description"]="Auth server public endpoint URL:
...
";
$elem["freezer-api/ksat-public-url"]["descriptionde"]="Öffentlicher Endpunkt-URL des Authentifizierungsservers:
...
";
$elem["freezer-api/ksat-public-url"]["descriptionfr"]="Adresse URL du point d'accès public pour le serveur d'authentification :
...
";
$elem["freezer-api/ksat-public-url"]["default"]="http://localhost:5000";
$elem["freezer-api/ksat-region"]["type"]="string";
$elem["freezer-api/ksat-region"]["description"]="Keystone region:
 Specify the Keystone region to use.
 .
 The region name is usually a string containing only ASCII alphanumerics,
 dots, and dashes.
";
$elem["freezer-api/ksat-region"]["descriptionde"]="Keystone-Region:
 Geben Sie die Keystone-Region an, die benutzt werden soll.
 .
 Der Regionsname ist üblicherweise eine Zeichenketten, die nur alphanumerisches ASCII, Punkte und Bindestrichte enthält.
";
$elem["freezer-api/ksat-region"]["descriptionfr"]="Région Keystone :
 Veuillez spécifier la région Keystone à utiliser.
 .
 Le nom de la région est généralement composé d'une chaîne contenant seulement des caractères alphanumériques ASCII, des points et des tirets.
";
$elem["freezer-api/ksat-region"]["default"]="regionOne";
$elem["freezer-api/ksat-create-service-user"]["type"]="boolean";
$elem["freezer-api/ksat-create-service-user"]["description"]="Create service user?
...
";
$elem["freezer-api/ksat-create-service-user"]["descriptionde"]="Dienstbenutzer erstellen?
...
";
$elem["freezer-api/ksat-create-service-user"]["descriptionfr"]="Voulez-vous créer un utilisateur du service ?
...
";
$elem["freezer-api/ksat-create-service-user"]["default"]="true";
$elem["freezer-api/ksat-admin-username"]["type"]="string";
$elem["freezer-api/ksat-admin-username"]["description"]="Auth server admin username:
";
$elem["freezer-api/ksat-admin-username"]["descriptionde"]="Administratorbenutzername des Authentifizierungsservers:
";
$elem["freezer-api/ksat-admin-username"]["descriptionfr"]="Nom d'utilisateur administrateur pour le serveur d'authentification :
";
$elem["freezer-api/ksat-admin-username"]["default"]="admin";
$elem["freezer-api/ksat-admin-project-name"]["type"]="string";
$elem["freezer-api/ksat-admin-project-name"]["description"]="Auth server admin project name:
";
$elem["freezer-api/ksat-admin-project-name"]["descriptionde"]="Administratorprojektname des Authentifizierungsservers:
";
$elem["freezer-api/ksat-admin-project-name"]["descriptionfr"]="Nom du projet administrateur pour le serveur d'authentification :
";
$elem["freezer-api/ksat-admin-project-name"]["default"]="admin";
$elem["freezer-api/ksat-admin-password"]["type"]="password";
$elem["freezer-api/ksat-admin-password"]["description"]="Auth server admin password:
";
$elem["freezer-api/ksat-admin-password"]["descriptionde"]="Administratorpasswort des Authentifizierungsservers:
";
$elem["freezer-api/ksat-admin-password"]["descriptionfr"]="Mot de passe administrateur pour le serveur d'authentification :
";
$elem["freezer-api/ksat-admin-password"]["default"]="";
$elem["freezer-api/ksat-service-username"]["type"]="string";
$elem["freezer-api/ksat-service-username"]["description"]="Auth server service username:
";
$elem["freezer-api/ksat-service-username"]["descriptionde"]="Dienstbenutzername des Authentifizierungsservers:
";
$elem["freezer-api/ksat-service-username"]["descriptionfr"]="Nom d'utilisateur pour le serveur du service d'authentification :
";
$elem["freezer-api/ksat-service-username"]["default"]="";
$elem["freezer-api/ksat-service-project-name"]["type"]="string";
$elem["freezer-api/ksat-service-project-name"]["description"]="Auth server service project name:
";
$elem["freezer-api/ksat-service-project-name"]["descriptionde"]="Dienstprojektname des Authentifizierungsservers:
";
$elem["freezer-api/ksat-service-project-name"]["descriptionfr"]="Nom du projet pour le serveur du service d'authentification :
";
$elem["freezer-api/ksat-service-project-name"]["default"]="service";
$elem["freezer-api/ksat-service-password"]["type"]="password";
$elem["freezer-api/ksat-service-password"]["description"]="Auth server service password:
";
$elem["freezer-api/ksat-service-password"]["descriptionde"]="Dienstpasswort des Authentifizierungsservers:
";
$elem["freezer-api/ksat-service-password"]["descriptionfr"]="Mot de passe pour le serveur du service d'authentification :
";
$elem["freezer-api/ksat-service-password"]["default"]="";
