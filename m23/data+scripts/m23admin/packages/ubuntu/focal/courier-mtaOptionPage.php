...
$elem["courier-mta/defaultdomain"]["descriptionfr"]="Domaine par défaut :
 Veuillez indiquer un domaine de courriel valable. La plupart des fonctions de réécriture d'en-têtes ajouteront ce domaine à toutes les adresses électroniques dans lesquelles aucun domaine n'est indiqué, par exemple les comptes locaux.
";
...
$elem["courier-mta/dsnfrom"]["descriptionfr"]="En-tête d'origine (« From ») pour les notifications d'envoi :
 Veuillez indiquez une adresse valable pour l'en-tête « origine » (« From ») des notifications d'envoi de courriel (« mail delivery notifications ») sinon celles-ci ne pourront pas être envoyées.
";
