...
$params = PKG_OptionPageHeader2("igtf-policy-iota");

$elem["igtf-policy-iota/install_profile"]["type"]="boolean";
$elem["igtf-policy-iota/install_profile"]["description"]="Trust IGTF iota CAs by default?
...
";
$elem["igtf-policy-iota/install_profile"]["descriptionde"]="Als Voreinstellung den IGTF-iota-CAs vertrauen?
...
";
$elem["igtf-policy-iota/install_profile"]["descriptionfr"]="Faut-il toujours faire confiance aux certificats d'autorités IGTF iota ?
...
";
$elem["igtf-policy-iota/install_profile"]["default"]="true";
$elem["igtf-policy-iota/exclude_ca"]["type"]="multiselect";
$elem["igtf-policy-iota/exclude_ca"]["description"]="Certificates to explicitly exclude:
 Please select which certificates should not be installed in
 ${location}.
";
$elem["igtf-policy-iota/exclude_ca"]["descriptionde"]="Zertifikate, die ausdrücklich ausgeschlossen werden sollen:
 Bitte wählen Sie die Zertifikate aus, die nicht in ${location} installiert werden sollen.
";
$elem["igtf-policy-iota/exclude_ca"]["descriptionfr"]="Certificats à exclure explicitement :
 Veuillez choisir quels certificats ne doivent pas être installés dans ${location}.
";
$elem["igtf-policy-iota/exclude_ca"]["default"]="";
$elem["igtf-policy-iota/include_ca"]["type"]="multiselect";
$elem["igtf-policy-iota/include_ca"]["description"]="Certificates to explicitly include:
 Please select which certificates should be installed in
 ${location}.
";
$elem["igtf-policy-iota/include_ca"]["descriptionde"]="Zertifikate, die ausdrücklich berücksichtigt werden sollen:
 Bitte wählen Sie die Zertifikate aus, die in ${location} installiert werden sollen.
";
$elem["igtf-policy-iota/include_ca"]["descriptionfr"]="Certificats à inclure explicitement :
 Veuillez choisir quels certificats doivent être installés dans ${location}.
";
$elem["igtf-policy-iota/include_ca"]["default"]="";
