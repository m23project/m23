...
$elem["senlin/configure_db"]["description"]="Set up a database for this package?
...
";
$elem["senlin/configure_db"]["descriptionde"]="Eine Datenbank für dieses Paket einrichten?
...
";
$elem["senlin/configure_db"]["descriptionfr"]="Voulez-vous installer une base de données pour ce paquet ?
...
$elem["senlin/configure_rabbit"]["type"]="boolean";
$elem["senlin/configure_rabbit"]["description"]="Configure RabbitMQ access with debconf?
 ...
 connections.
";
$elem["senlin/configure_rabbit"]["descriptionde"]="Soll der RabbitMQ-Zugriff mit Debconf konfiguriert werden?
...
";
$elem["senlin/configure_rabbit"]["descriptionfr"]="Voulez-vous configurer les accès à RabbitMQ avec les écrans de configuration debconf ?
...
";
$elem["senlin/configure_rabbit"]["default"]="false";
$elem["senlin/rabbit-host"]["type"]="string";
$elem["senlin/rabbit-host"]["description"]="IP address of your RabbitMQ host:
 In order to interoperate with other components of OpenStack, this package
 needs to connect to a central RabbitMQ server.
 .
 Please specify the IP address of that server.
";
$elem["senlin/rabbit-host"]["descriptionde"]="IP-Adresse Ihres RabbitMQ-Rechners:
...
";
$elem["senlin/rabbit-host"]["descriptionfr"]="Adresse IP de votre hôte RabbitMQ :
...
";
$elem["senlin/rabbit-host"]["default"]="localhost";
$elem["senlin/rabbit-userid"]["type"]="string";
$elem["senlin/rabbit-userid"]["description"]="Username for connection to the RabbitMQ server:
 In order to interoperate with other components of OpenStack, this package
 needs to connect to a central RabbitMQ server.
 .
 Please specify the username used to connect to that RabbitMQ server.
";
$elem["senlin/rabbit-userid"]["descriptionde"]="Benutzername für die Verbindung mit dem RabbitMQ-Server:
 Um mit weiteren Bestandteilen von OpenStack zusammenzuarbeiten, muss sich dieses Paket mit einem zentralen RabbitMQ-Server verbinden.
 .
 Bitte geben Sie den Benutzernamen ein, den Sie zum Verbinden mit diesem RabbitMQ-Server verwenden.
";
$elem["senlin/rabbit-userid"]["descriptionfr"]="Nom d'utilisateur pour la connexion au serveur RabbitMQ :
 Afin de pouvoir interagir avec d'autres composants d'OpenStack, ce paquet doit se connecter à un serveur centralisé RabbitMQ.
 .
 Veuillez indiquer le nom d'utilisateur à utiliser pour se connecter au serveur RabbitMQ.
";
$elem["senlin/rabbit-userid"]["default"]="guest";
$elem["senlin/rabbit-password"]["type"]="password";
$elem["senlin/rabbit-password"]["description"]="Password for connection to the RabbitMQ server:
 In order to interoperate with other components of OpenStack, this package
 needs to connect to a central RabbitMQ server.
 .
 Please specify the password used to connect to that RabbitMQ server.
";
$elem["senlin/rabbit-password"]["descriptionde"]="Passwort für die Verbindung mit dem RabbitMQ-Server:
 Um mit weiteren Bestandteilen von OpenStack zusammenzuarbeiten, muss sich dieses Paket mit einem zentralen RabbitMQ-Server verbinden.
 .
 Bitte geben Sie das Passwort ein, das Sie zum Verbinden mit diesem RabbitMQ-Server verwenden.
";
$elem["senlin/rabbit-password"]["descriptionfr"]="Mot de passe pour la connexion au serveur RabbitMQ :
 Afin de pouvoir interagir avec d'autres composants d'OpenStack, ce paquet doit se connecter à un serveur centralisé RabbitMQ.
 .
 Veuillez indiquer le mot de passe à utiliser pour se connecter au serveur RabbitMQ.
";
$elem["senlin/rabbit-password"]["default"]="";
$elem["senlin/configure_ksat"]["type"]="boolean";
$elem["senlin/configure_ksat"]["description"]="Manage keystone_authtoken with debconf?
...
";
$elem["senlin/configure_ksat"]["descriptionde"]="Soll »keystone_authtoken« mit Debconf verwaltet werden?
...
";
$elem["senlin/configure_ksat"]["descriptionfr"]="Voulez-vous gérer le jeton d'authentification keystone (« keystone_authtoken ») avec les écrans de configuration debconf ?
...
";
$elem["senlin/configure_ksat"]["default"]="false";
$elem["senlin/ksat-public-url"]["type"]="string";
$elem["senlin/ksat-public-url"]["description"]="Auth server public endpoint URL:
...
";
$elem["senlin/ksat-public-url"]["descriptionde"]="Öffentlicher Endpunkt-URL des Authentifizierungsservers:
...
";
$elem["senlin/ksat-public-url"]["descriptionfr"]="Adresse URL du point d'accès public pour le serveur d'authentification :
...
";
$elem["senlin/ksat-public-url"]["default"]="http://localhost:5000";
$elem["senlin/ksat-region"]["type"]="string";
$elem["senlin/ksat-region"]["description"]="Keystone region:
 Specify the Keystone region to use.
 .
 The region name is usually a string containing only ASCII alphanumerics,
 dots, and dashes.
";
$elem["senlin/ksat-region"]["descriptionde"]="Keystone-Region:
...
";
$elem["senlin/ksat-region"]["descriptionfr"]="Région Keystone :
...
";
$elem["senlin/ksat-region"]["default"]="regionOne";
$elem["senlin/ksat-create-service-user"]["type"]="boolean";
$elem["senlin/ksat-create-service-user"]["description"]="Create service user?
...
";
$elem["senlin/ksat-create-service-user"]["descriptionde"]="Dienstbenutzer erstellen?
...
";
$elem["senlin/ksat-create-service-user"]["descriptionfr"]="Voulez-vous créer un utilisateur du service ?
...
";
$elem["senlin/ksat-create-service-user"]["default"]="true";
$elem["senlin/ksat-admin-username"]["type"]="string";
$elem["senlin/ksat-admin-username"]["description"]="Auth server admin username:
";
$elem["senlin/ksat-admin-username"]["descriptionde"]="Administratorbenutzername des Authentifizierungsservers:
";
$elem["senlin/ksat-admin-username"]["descriptionfr"]="Nom d'utilisateur administrateur pour le serveur d'authentification :
";
$elem["senlin/ksat-admin-username"]["default"]="admin";
$elem["senlin/ksat-admin-project-name"]["type"]="string";
$elem["senlin/ksat-admin-project-name"]["description"]="Auth server admin project name:
";
$elem["senlin/ksat-admin-project-name"]["descriptionde"]="Administratorprojektname des Authentifizierungsservers:
";
$elem["senlin/ksat-admin-project-name"]["descriptionfr"]="Nom du projet administrateur pour le serveur d'authentification :
";
$elem["senlin/ksat-admin-project-name"]["default"]="admin";
$elem["senlin/ksat-admin-password"]["type"]="password";
$elem["senlin/ksat-admin-password"]["description"]="Auth server admin password:
";
$elem["senlin/ksat-admin-password"]["descriptionde"]="Administratorpasswort des Authentifizierungsservers:
";
$elem["senlin/ksat-admin-password"]["descriptionfr"]="Mot de passe administrateur pour le serveur d'authentification :
";
$elem["senlin/ksat-admin-password"]["default"]="";
$elem["senlin/ksat-service-username"]["type"]="string";
$elem["senlin/ksat-service-username"]["description"]="Auth server service username:
";
$elem["senlin/ksat-service-username"]["descriptionde"]="Dienstbenutzername des Authentifizierungsservers:
";
$elem["senlin/ksat-service-username"]["descriptionfr"]="Nom d'utilisateur pour le serveur du service d'authentification :
";
$elem["senlin/ksat-service-username"]["default"]="";
$elem["senlin/ksat-service-project-name"]["type"]="string";
$elem["senlin/ksat-service-project-name"]["description"]="Auth server service project name:
";
$elem["senlin/ksat-service-project-name"]["descriptionde"]="Dienstprojektname des Authentifizierungsservers:
";
$elem["senlin/ksat-service-project-name"]["descriptionfr"]="Nom du projet pour le serveur du service d'authentification :
";
$elem["senlin/ksat-service-project-name"]["default"]="service";
$elem["senlin/ksat-service-password"]["type"]="password";
$elem["senlin/ksat-service-password"]["description"]="Auth server service password:
";
$elem["senlin/ksat-service-password"]["descriptionde"]="Dienstpasswort des Authentifizierungsservers:
";
$elem["senlin/ksat-service-password"]["descriptionfr"]="Mot de passe pour le serveur du service d'authentification :
";
$elem["senlin/ksat-service-password"]["default"]="";
