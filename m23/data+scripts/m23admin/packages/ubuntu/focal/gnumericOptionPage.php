...
$elem["gnumeric/existing-process-title"]["type"]="title";
$elem["gnumeric/existing-process-title"]["description"]="Detected a running gnumeric process
";
$elem["gnumeric/existing-process-title"]["descriptionde"]="Laufender gnumeric-Prozess gefunden
";
$elem["gnumeric/existing-process-title"]["descriptionfr"]="Détection d'un processus actif de gnumeric
";
$elem["gnumeric/existing-process-title"]["default"]="";
...
$elem["gnumeric/existing-process"]["descriptionde"]="Wirklich eine Aktualisierung von Gnumeric durchführen?
 ...
 .
 Vor der Aktualisierung dieses Paketes sollten Sie die laufenden Instanzen von Gnumeric beenden.
";
