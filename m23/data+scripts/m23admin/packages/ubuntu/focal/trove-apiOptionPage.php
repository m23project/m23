...
$elem["trove/configure_api-endpoint"]["type"]="boolean";
$elem["trove/configure_api-endpoint"]["description"]="Register this service in the Keystone endpoint catalog?
...
";
$elem["trove/configure_api-endpoint"]["descriptionde"]="Diesen Dienst im Keystone-Endpunktkatalog registrieren?
...
";
$elem["trove/configure_api-endpoint"]["descriptionfr"]="Voulez-vous enregistrer ce service dans le catalogue de points d'accès de Keystone ?
...
";
$elem["trove/configure_api-endpoint"]["default"]="false";
$elem["trove/api-keystone-address"]["type"]="string";
$elem["trove/api-keystone-address"]["description"]="Keystone server address:
 ...
 registration.
";
$elem["trove/api-keystone-address"]["descriptionde"]="Adresse des Keystone-Servers:
...
";
$elem["trove/api-keystone-address"]["descriptionfr"]="Adresse du point d'accès Keystone :
...
";
$elem["trove/api-keystone-address"]["default"]="";
$elem["trove/api-keystone-proto"]["type"]="select";
$elem["trove/api-keystone-proto"]["choices"][1]="http";
$elem["trove/api-keystone-proto"]["description"]="Keystone endpoint protocol:
";
$elem["trove/api-keystone-proto"]["descriptionde"]="Keystone-Endpunktprotokoll:
";
$elem["trove/api-keystone-proto"]["descriptionfr"]="Protocole du point d'accès Keystone :
";
$elem["trove/api-keystone-proto"]["default"]="http";
$elem["trove/api-keystone-admin-username"]["type"]="string";
$elem["trove/api-keystone-admin-username"]["description"]="Keystone admin username:
 ...
 Keystone API.
";
$elem["trove/api-keystone-admin-username"]["descriptionde"]="Keystone-Administratorbenutzername:
...
";
$elem["trove/api-keystone-admin-username"]["descriptionfr"]="Nom d'utilisateur de l'administrateur Keystone :
...
";
$elem["trove/api-keystone-admin-username"]["default"]="admin";
$elem["trove/api-keystone-admin-project-name"]["type"]="string";
$elem["trove/api-keystone-admin-project-name"]["description"]="Keystone admin project name:
 To create the service endpoint, this package needs to know the Admin
 username, project name, and password, so it can issue commands through the
 Keystone API.
";
$elem["trove/api-keystone-admin-project-name"]["descriptionde"]="Keystone-Administratorprojektname:
 Um den Dienstendpunkt zu erstellen, muss dieses Paket den Administratorbenutzernamen, Projektnamen und das Passwort kennen, um Befehle über die Keystone-API zu erteilen.
";
$elem["trove/api-keystone-admin-project-name"]["descriptionfr"]="Nom du projet administrateur Keystone :
 Pour créer le service de point d'accès, ce paquet a besoin de connaître le nom d'utilisateur de l'administrateur, le nom du projet, ainsi que le mot de passe. Il peut ainsi exécuter des commandes au travers de l'API Keystone.
";
$elem["trove/api-keystone-admin-project-name"]["default"]="admin";
$elem["trove/api-keystone-admin-password"]["type"]="password";
$elem["trove/api-keystone-admin-password"]["description"]="Keystone admin password:
 To create the service endpoint, this package needs to know the Admin
 username, project name, and password, so it can issue commands through the
 Keystone API.
";
$elem["trove/api-keystone-admin-password"]["descriptionde"]="Keystone-Administratorpasswort:
 Um den Dienstendpunkt zu erstellen, muss dieses Paket den Administratorbenutzernamen, Projektnamen und das Passwort kennen, um Befehle über die Keystone-API zu erteilen.
";
$elem["trove/api-keystone-admin-password"]["descriptionfr"]="Mot de passe administrateur Keystone :
 Pour créer le service de point d'accès, ce paquet a besoin de connaître le nom d'utilisateur de l'administrateur, le nom du projet, ainsi que le mot de passe. Il peut ainsi exécuter des commandes au travers de l'API Keystone.
";
$elem["trove/api-keystone-admin-password"]["default"]="";
$elem["trove/api-endpoint-address"]["type"]="string";
$elem["trove/api-endpoint-address"]["description"]="This service endpoint address:
...
";
$elem["trove/api-endpoint-address"]["descriptionde"]="Endpunktadresse dieses Dienstes:
...
";
$elem["trove/api-endpoint-address"]["descriptionfr"]="Adresse de ce service de point d'accès :
...
";
$elem["trove/api-endpoint-address"]["default"]="";
$elem["trove/api-endpoint-proto"]["type"]="select";
$elem["trove/api-endpoint-proto"]["choices"][1]="http";
$elem["trove/api-endpoint-proto"]["description"]="This service endpoint protocol:
";
$elem["trove/api-endpoint-proto"]["descriptionde"]="Endpunktprotokoll dieses Dienstes:
";
$elem["trove/api-endpoint-proto"]["descriptionfr"]="Protocole de ce service de point d'accès :
";
$elem["trove/api-endpoint-proto"]["default"]="http";
$elem["trove/api-endpoint-region-name"]["type"]="string";
$elem["trove/api-endpoint-region-name"]["description"]="Name of the region to register:
...
";
$elem["trove/api-endpoint-region-name"]["descriptionde"]="Name der Region, die registriert wird:
...
";
$elem["trove/api-endpoint-region-name"]["descriptionfr"]="Nom de la région à enregistrer :
...
";
$elem["trove/api-endpoint-region-name"]["default"]="regionOne";
