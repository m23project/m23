...
";
$elem["cloudkitty/configure_api-endpoint"]["descriptionde"]="Diesen Dienst im Keystone-Endpunktkatalog registrieren?
...
";
$elem["cloudkitty/configure_api-endpoint"]["descriptionfr"]="Voulez-vous enregistrer ce service dans le catalogue de points d'accès de Keystone ?
...
";
$elem["cloudkitty/api-keystone-address"]["descriptionfr"]="Adresse du point d'accès Keystone :
...
";
$elem["cloudkitty/api-keystone-proto"]["descriptionde"]="Keystone-Endpunktprotokoll:
";
$elem["cloudkitty/api-keystone-proto"]["descriptionfr"]="Protocole du point d'accès Keystone :
";
...
$elem["cloudkitty/api-keystone-admin-username"]["description"]="Keystone admin username:
 ...
 Keystone API.
";
$elem["cloudkitty/api-keystone-admin-username"]["descriptionde"]="Keystone-Administratorbenutzername:
...
";
$elem["cloudkitty/api-keystone-admin-username"]["descriptionfr"]="Nom d'utilisateur de l'administrateur Keystone :
...
$elem["cloudkitty/api-keystone-admin-project-name"]["description"]="Keystone admin project name:
 ...
 Keystone API.
";
$elem["cloudkitty/api-keystone-admin-project-name"]["descriptionde"]="Keystone-Administratorprojektname:
 Um den Dienstendpunkt zu erstellen, muss dieses Paket den Administratorbenutzernamen, Projektnamen und das Passwort kennen, um Befehle über die Keystone-API zu erteilen.
";
$elem["cloudkitty/api-keystone-admin-project-name"]["descriptionfr"]="Nom du projet administrateur Keystone :
 Pour créer le service de point d'accès, ce paquet a besoin de connaître le nom d'utilisateur de l'administrateur, le nom du projet, ainsi que le mot de passe. Il peut ainsi exécuter des commandes au travers de l'API Keystone.
";
...
$elem["cloudkitty/api-keystone-admin-password"]["description"]="Keystone admin password:
 ...
 Keystone API.
";
$elem["cloudkitty/api-keystone-admin-password"]["descriptionde"]="Keystone-Administratorpasswort:
 Um den Dienstendpunkt zu erstellen, muss dieses Paket den Administratorbenutzernamen, Projektnamen und das Passwort kennen, um Befehle über die Keystone-API zu erteilen.
";
$elem["cloudkitty/api-keystone-admin-password"]["descriptionfr"]="Mot de passe administrateur Keystone :
 Pour créer le service de point d'accès, ce paquet a besoin de connaître le nom d'utilisateur de l'administrateur, le nom du projet, ainsi que le mot de passe. Il peut ainsi exécuter des commandes au travers de l'API Keystone.
";
...
";
$elem["cloudkitty/api-endpoint-address"]["descriptionde"]="Endpunktadresse dieses Dienstes:
...
";
$elem["cloudkitty/api-endpoint-address"]["descriptionfr"]="Adresse de ce service de point d'accès :
...
";
$elem["cloudkitty/api-endpoint-proto"]["descriptionde"]="Endpunktprotokoll dieses Dienstes:
";
$elem["cloudkitty/api-endpoint-proto"]["descriptionfr"]="Protocole de ce service de point d'accès :
";
...
";
$elem["cloudkitty/api-endpoint-region-name"]["descriptionde"]="Name der Region, die registriert wird:
...
";
$elem["cloudkitty/api-endpoint-region-name"]["descriptionfr"]="Nom de la région à enregistrer :
