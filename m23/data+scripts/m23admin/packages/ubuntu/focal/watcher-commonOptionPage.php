...
$elem["watcher/configure_db"]["description"]="Set up a database for this package?
...
";
$elem["watcher/configure_db"]["descriptionde"]="Eine Datenbank für dieses Paket einrichten?
...
";
$elem["watcher/configure_db"]["descriptionfr"]="Voulez-vous installer une base de données pour ce paquet ?
...
$elem["watcher/configure_rabbit"]["type"]="boolean";
$elem["watcher/configure_rabbit"]["description"]="Configure RabbitMQ access with debconf?
 ...
 connections.
";
$elem["watcher/configure_rabbit"]["descriptionde"]="Soll der RabbitMQ-Zugriff mit Debconf konfiguriert werden?
...
";
$elem["watcher/configure_rabbit"]["descriptionfr"]="Voulez-vous configurer les accès à RabbitMQ avec les écrans de configuration debconf ?
...
";
$elem["watcher/configure_rabbit"]["default"]="false";
$elem["watcher/rabbit-host"]["type"]="string";
$elem["watcher/rabbit-host"]["description"]="IP address of your RabbitMQ host:
 In order to interoperate with other components of OpenStack, this package
 needs to connect to a central RabbitMQ server.
 .
 Please specify the IP address of that server.
";
$elem["watcher/rabbit-host"]["descriptionde"]="IP-Adresse Ihres RabbitMQ-Rechners:
...
";
$elem["watcher/rabbit-host"]["descriptionfr"]="Adresse IP de votre hôte RabbitMQ :
...
";
$elem["watcher/rabbit-host"]["default"]="localhost";
$elem["watcher/rabbit-userid"]["type"]="string";
$elem["watcher/rabbit-userid"]["description"]="Username for connection to the RabbitMQ server:
 In order to interoperate with other components of OpenStack, this package
 needs to connect to a central RabbitMQ server.
 .
 Please specify the username used to connect to that RabbitMQ server.
";
$elem["watcher/rabbit-userid"]["descriptionde"]="Benutzername für die Verbindung mit dem RabbitMQ-Server:
 Um mit weiteren Bestandteilen von OpenStack zusammenzuarbeiten, muss sich dieses Paket mit einem zentralen RabbitMQ-Server verbinden.
 .
 Bitte geben Sie den Benutzernamen ein, den Sie zum Verbinden mit diesem RabbitMQ-Server verwenden.
";
$elem["watcher/rabbit-userid"]["descriptionfr"]="Nom d'utilisateur pour la connexion au serveur RabbitMQ :
 Afin de pouvoir interagir avec d'autres composants d'OpenStack, ce paquet doit se connecter à un serveur centralisé RabbitMQ.
 .
 Veuillez indiquer le nom d'utilisateur à utiliser pour se connecter au serveur RabbitMQ.
";
$elem["watcher/rabbit-userid"]["default"]="guest";
$elem["watcher/rabbit-password"]["type"]="password";
$elem["watcher/rabbit-password"]["description"]="Password for connection to the RabbitMQ server:
 In order to interoperate with other components of OpenStack, this package
 needs to connect to a central RabbitMQ server.
 .
 Please specify the password used to connect to that RabbitMQ server.
";
$elem["watcher/rabbit-password"]["descriptionde"]="Passwort für die Verbindung mit dem RabbitMQ-Server:
 Um mit weiteren Bestandteilen von OpenStack zusammenzuarbeiten, muss sich dieses Paket mit einem zentralen RabbitMQ-Server verbinden.
 .
 Bitte geben Sie das Passwort ein, das Sie zum Verbinden mit diesem RabbitMQ-Server verwenden.
";
$elem["watcher/rabbit-password"]["descriptionfr"]="Mot de passe pour la connexion au serveur RabbitMQ :
 Afin de pouvoir interagir avec d'autres composants d'OpenStack, ce paquet doit se connecter à un serveur centralisé RabbitMQ.
 .
 Veuillez indiquer le mot de passe à utiliser pour se connecter au serveur RabbitMQ.
";
$elem["watcher/rabbit-password"]["default"]="";
$elem["watcher/configure_ksat"]["type"]="boolean";
$elem["watcher/configure_ksat"]["description"]="Manage keystone_authtoken with debconf?
...
";
$elem["watcher/configure_ksat"]["descriptionde"]="Soll »keystone_authtoken« mit Debconf verwaltet werden?
...
";
$elem["watcher/configure_ksat"]["descriptionfr"]="Voulez-vous gérer le jeton d'authentification keystone (« keystone_authtoken ») avec les écrans de configuration debconf ?
...
";
$elem["watcher/configure_ksat"]["default"]="false";
$elem["watcher/ksat-public-url"]["type"]="string";
$elem["watcher/ksat-public-url"]["description"]="Auth server public endpoint URL:
...
";
$elem["watcher/ksat-public-url"]["descriptionde"]="Öffentlicher Endpunkt-URL des Authentifizierungsservers:
...
";
$elem["watcher/ksat-public-url"]["descriptionfr"]="Adresse URL du point d'accès public pour le serveur d'authentification :
...
";
$elem["watcher/ksat-public-url"]["default"]="http://localhost:5000";
$elem["watcher/ksat-region"]["type"]="string";
$elem["watcher/ksat-region"]["description"]="Keystone region:
 Specify the Keystone region to use.
 .
 The region name is usually a string containing only ASCII alphanumerics,
 dots, and dashes.
";
$elem["watcher/ksat-region"]["descriptionde"]="Keystone-Region:
...
";
$elem["watcher/ksat-region"]["descriptionfr"]="Région Keystone :
...
";
$elem["watcher/ksat-region"]["default"]="regionOne";
$elem["watcher/ksat-create-service-user"]["type"]="boolean";
$elem["watcher/ksat-create-service-user"]["description"]="Create service user?
...
";
$elem["watcher/ksat-create-service-user"]["descriptionde"]="Dienstbenutzer erstellen?
...
";
$elem["watcher/ksat-create-service-user"]["descriptionfr"]="Voulez-vous créer un utilisateur du service ?
...
";
$elem["watcher/ksat-create-service-user"]["default"]="true";
$elem["watcher/ksat-admin-username"]["type"]="string";
$elem["watcher/ksat-admin-username"]["description"]="Auth server admin username:
";
$elem["watcher/ksat-admin-username"]["descriptionde"]="Administratorbenutzername des Authentifizierungsservers:
";
$elem["watcher/ksat-admin-username"]["descriptionfr"]="Nom d'utilisateur administrateur pour le serveur d'authentification :
";
$elem["watcher/ksat-admin-username"]["default"]="admin";
$elem["watcher/ksat-admin-project-name"]["type"]="string";
$elem["watcher/ksat-admin-project-name"]["description"]="Auth server admin project name:
";
$elem["watcher/ksat-admin-project-name"]["descriptionde"]="Administratorprojektname des Authentifizierungsservers:
";
$elem["watcher/ksat-admin-project-name"]["descriptionfr"]="Nom du projet administrateur pour le serveur d'authentification :
";
$elem["watcher/ksat-admin-project-name"]["default"]="admin";
$elem["watcher/ksat-admin-password"]["type"]="password";
$elem["watcher/ksat-admin-password"]["description"]="Auth server admin password:
";
$elem["watcher/ksat-admin-password"]["descriptionde"]="Administratorpasswort des Authentifizierungsservers:
";
$elem["watcher/ksat-admin-password"]["descriptionfr"]="Mot de passe administrateur pour le serveur d'authentification :
";
$elem["watcher/ksat-admin-password"]["default"]="";
$elem["watcher/ksat-service-username"]["type"]="string";
$elem["watcher/ksat-service-username"]["description"]="Auth server service username:
";
$elem["watcher/ksat-service-username"]["descriptionde"]="Dienstbenutzername des Authentifizierungsservers:
";
$elem["watcher/ksat-service-username"]["descriptionfr"]="Nom d'utilisateur pour le serveur du service d'authentification :
";
$elem["watcher/ksat-service-username"]["default"]="";
$elem["watcher/ksat-service-project-name"]["type"]="string";
$elem["watcher/ksat-service-project-name"]["description"]="Auth server service project name:
";
$elem["watcher/ksat-service-project-name"]["descriptionde"]="Dienstprojektname des Authentifizierungsservers:
";
$elem["watcher/ksat-service-project-name"]["descriptionfr"]="Nom du projet pour le serveur du service d'authentification :
";
$elem["watcher/ksat-service-project-name"]["default"]="service";
$elem["watcher/ksat-service-password"]["type"]="password";
$elem["watcher/ksat-service-password"]["description"]="Auth server service password:
";
$elem["watcher/ksat-service-password"]["descriptionde"]="Dienstpasswort des Authentifizierungsservers:
";
$elem["watcher/ksat-service-password"]["descriptionfr"]="Mot de passe pour le serveur du service d'authentification :
";
$elem["watcher/ksat-service-password"]["default"]="";
