...
$elem["slay/punish"]["descriptionde"]="Soll slay Benutzer bestrafen?
 Für gewöhnlich bestraft slay normale Benutzer, indem es sie selbst 'slayed'.Das ist richtig so(TM), da Benutzer nicht mit administrativen Kommandos wieslay spielen sollten, aber manche Administratoren finden das unangenehm. Daher kann slay so eingerichtet werden, dass es Benutzer bestraft oder nur eine Fehlermeldung ausgibt.
";
...
$elem["slay/butthead"]["descriptionde"]="Soll slay standarmäßig den 'Butt-head' Modus verwenden?
 Slay besitzt zwei Sammlungen von Meldungen: eine Standardsammlung und eine Alternative die etwas informeller ist. Die Alternative wurde nach \"Butt-head\" von MTV's \"Beavis·&·Butt-head\" Cartoon benannt, einem Charakter, der diese Art von Sprache verwendet, die Sie in der alternativen Sammlung finden. In den meisten Fällen ist die Standardsammlung eher mehr angemessen.
";
