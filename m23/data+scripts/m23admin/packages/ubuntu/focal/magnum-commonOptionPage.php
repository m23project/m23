...
$elem["magnum/configure_db"]["description"]="Set up a database for this package?
...
";
$elem["magnum/configure_db"]["descriptionde"]="Eine Datenbank für dieses Paket einrichten?
...
";
$elem["magnum/configure_db"]["descriptionfr"]="Voulez-vous installer une base de données pour ce paquet ?
...
$elem["magnum/configure_rabbit"]["type"]="boolean";
$elem["magnum/configure_rabbit"]["description"]="Configure RabbitMQ access with debconf?
 ...
 connections.
";
$elem["magnum/configure_rabbit"]["descriptionde"]="Soll der RabbitMQ-Zugriff mit Debconf konfiguriert werden?
...
";
$elem["magnum/configure_rabbit"]["descriptionfr"]="Voulez-vous configurer les accès à RabbitMQ avec les écrans de configuration debconf ?
...
";
$elem["magnum/configure_rabbit"]["default"]="false";
$elem["magnum/rabbit-host"]["type"]="string";
$elem["magnum/rabbit-host"]["description"]="IP address of your RabbitMQ host:
 In order to interoperate with other components of OpenStack, this package
 needs to connect to a central RabbitMQ server.
 .
 Please specify the IP address of that server.
";
$elem["magnum/rabbit-host"]["descriptionde"]="IP-Adresse Ihres RabbitMQ-Rechners:
...
";
$elem["magnum/rabbit-host"]["descriptionfr"]="Adresse IP de votre hôte RabbitMQ :
...
";
$elem["magnum/rabbit-host"]["default"]="localhost";
$elem["magnum/rabbit-userid"]["type"]="string";
$elem["magnum/rabbit-userid"]["description"]="Username for connection to the RabbitMQ server:
 In order to interoperate with other components of OpenStack, this package
 needs to connect to a central RabbitMQ server.
 .
 Please specify the username used to connect to that RabbitMQ server.
";
$elem["magnum/rabbit-userid"]["descriptionde"]="Benutzername für die Verbindung mit dem RabbitMQ-Server:
 Um mit weiteren Bestandteilen von OpenStack zusammenzuarbeiten, muss sich dieses Paket mit einem zentralen RabbitMQ-Server verbinden.
 .
 Bitte geben Sie den Benutzernamen ein, den Sie zum Verbinden mit diesem RabbitMQ-Server verwenden.
";
$elem["magnum/rabbit-userid"]["descriptionfr"]="Nom d'utilisateur pour la connexion au serveur RabbitMQ :
 Afin de pouvoir interagir avec d'autres composants d'OpenStack, ce paquet doit se connecter à un serveur centralisé RabbitMQ.
 .
 Veuillez indiquer le nom d'utilisateur à utiliser pour se connecter au serveur RabbitMQ.
";
$elem["magnum/rabbit-userid"]["default"]="guest";
$elem["magnum/rabbit-password"]["type"]="password";
$elem["magnum/rabbit-password"]["description"]="Password for connection to the RabbitMQ server:
 In order to interoperate with other components of OpenStack, this package
 needs to connect to a central RabbitMQ server.
 .
 Please specify the password used to connect to that RabbitMQ server.
";
$elem["magnum/rabbit-password"]["descriptionde"]="Passwort für die Verbindung mit dem RabbitMQ-Server:
 Um mit weiteren Bestandteilen von OpenStack zusammenzuarbeiten, muss sich dieses Paket mit einem zentralen RabbitMQ-Server verbinden.
 .
 Bitte geben Sie das Passwort ein, das Sie zum Verbinden mit diesem RabbitMQ-Server verwenden.
";
$elem["magnum/rabbit-password"]["descriptionfr"]="Mot de passe pour la connexion au serveur RabbitMQ :
 Afin de pouvoir interagir avec d'autres composants d'OpenStack, ce paquet doit se connecter à un serveur centralisé RabbitMQ.
 .
 Veuillez indiquer le mot de passe à utiliser pour se connecter au serveur RabbitMQ.
";
$elem["magnum/rabbit-password"]["default"]="";
$elem["magnum/configure_ksat"]["type"]="boolean";
$elem["magnum/configure_ksat"]["description"]="Manage keystone_authtoken with debconf?
...
";
$elem["magnum/configure_ksat"]["descriptionde"]="Soll »keystone_authtoken« mit Debconf verwaltet werden?
...
";
$elem["magnum/configure_ksat"]["descriptionfr"]="Voulez-vous gérer le jeton d'authentification keystone (« keystone_authtoken ») avec les écrans de configuration debconf ?
...
";
$elem["magnum/configure_ksat"]["default"]="false";
$elem["magnum/ksat-public-url"]["type"]="string";
$elem["magnum/ksat-public-url"]["description"]="Auth server public endpoint URL:
...
";
$elem["magnum/ksat-public-url"]["descriptionde"]="Öffentlicher Endpunkt-URL des Authentifizierungsservers:
...
";
$elem["magnum/ksat-public-url"]["descriptionfr"]="Adresse URL du point d'accès public pour le serveur d'authentification :
...
";
$elem["magnum/ksat-public-url"]["default"]="http://localhost:5000";
$elem["magnum/ksat-region"]["type"]="string";
$elem["magnum/ksat-region"]["description"]="Keystone region:
 Specify the Keystone region to use.
 .
 The region name is usually a string containing only ASCII alphanumerics,
 dots, and dashes.
";
$elem["magnum/ksat-region"]["descriptionde"]="Keystone-Region:
...
";
$elem["magnum/ksat-region"]["descriptionfr"]="Région Keystone :
...
";
$elem["magnum/ksat-region"]["default"]="regionOne";
$elem["magnum/ksat-create-service-user"]["type"]="boolean";
$elem["magnum/ksat-create-service-user"]["description"]="Create service user?
...
";
$elem["magnum/ksat-create-service-user"]["descriptionde"]="Dienstbenutzer erstellen?
...
";
$elem["magnum/ksat-create-service-user"]["descriptionfr"]="Voulez-vous créer un utilisateur du service ?
...
";
$elem["magnum/ksat-create-service-user"]["default"]="true";
$elem["magnum/ksat-admin-username"]["type"]="string";
$elem["magnum/ksat-admin-username"]["description"]="Auth server admin username:
";
$elem["magnum/ksat-admin-username"]["descriptionde"]="Administratorbenutzername des Authentifizierungsservers:
";
$elem["magnum/ksat-admin-username"]["descriptionfr"]="Nom d'utilisateur administrateur pour le serveur d'authentification :
";
$elem["magnum/ksat-admin-username"]["default"]="admin";
$elem["magnum/ksat-admin-project-name"]["type"]="string";
$elem["magnum/ksat-admin-project-name"]["description"]="Auth server admin project name:
";
$elem["magnum/ksat-admin-project-name"]["descriptionde"]="Administratorprojektname des Authentifizierungsservers:
";
$elem["magnum/ksat-admin-project-name"]["descriptionfr"]="Nom du projet administrateur pour le serveur d'authentification :
";
$elem["magnum/ksat-admin-project-name"]["default"]="admin";
$elem["magnum/ksat-admin-password"]["type"]="password";
$elem["magnum/ksat-admin-password"]["description"]="Auth server admin password:
";
$elem["magnum/ksat-admin-password"]["descriptionde"]="Administratorpasswort des Authentifizierungsservers:
";
$elem["magnum/ksat-admin-password"]["descriptionfr"]="Mot de passe administrateur pour le serveur d'authentification :
";
$elem["magnum/ksat-admin-password"]["default"]="";
$elem["magnum/ksat-service-username"]["type"]="string";
$elem["magnum/ksat-service-username"]["description"]="Auth server service username:
";
$elem["magnum/ksat-service-username"]["descriptionde"]="Dienstbenutzername des Authentifizierungsservers:
";
$elem["magnum/ksat-service-username"]["descriptionfr"]="Nom d'utilisateur pour le serveur du service d'authentification :
";
$elem["magnum/ksat-service-username"]["default"]="";
$elem["magnum/ksat-service-project-name"]["type"]="string";
$elem["magnum/ksat-service-project-name"]["description"]="Auth server service project name:
";
$elem["magnum/ksat-service-project-name"]["descriptionde"]="Dienstprojektname des Authentifizierungsservers:
";
$elem["magnum/ksat-service-project-name"]["descriptionfr"]="Nom du projet pour le serveur du service d'authentification :
";
$elem["magnum/ksat-service-project-name"]["default"]="service";
$elem["magnum/ksat-service-password"]["type"]="password";
$elem["magnum/ksat-service-password"]["description"]="Auth server service password:
";
$elem["magnum/ksat-service-password"]["descriptionde"]="Dienstpasswort des Authentifizierungsservers:
";
$elem["magnum/ksat-service-password"]["descriptionfr"]="Mot de passe pour le serveur du service d'authentification :
";
$elem["magnum/ksat-service-password"]["default"]="";
