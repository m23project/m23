...
$elem["manila/configure_db"]["description"]="Set up a database for this package?
...
";
$elem["manila/configure_db"]["descriptionde"]="Eine Datenbank für dieses Paket einrichten?
...
";
$elem["manila/configure_db"]["descriptionfr"]="Voulez-vous installer une base de données pour ce paquet ?
...
$elem["manila/configure_rabbit"]["type"]="boolean";
$elem["manila/configure_rabbit"]["description"]="Configure RabbitMQ access with debconf?
 ...
 connections.
";
$elem["manila/configure_rabbit"]["descriptionde"]="Soll der RabbitMQ-Zugriff mit Debconf konfiguriert werden?
...
";
$elem["manila/configure_rabbit"]["descriptionfr"]="Voulez-vous configurer les accès à RabbitMQ avec les écrans de configuration debconf ?
...
";
$elem["manila/configure_rabbit"]["default"]="false";
$elem["manila/rabbit-host"]["type"]="string";
$elem["manila/rabbit-host"]["description"]="IP address of your RabbitMQ host:
 In order to interoperate with other components of OpenStack, this package
 needs to connect to a central RabbitMQ server.
 .
 Please specify the IP address of that server.
";
$elem["manila/rabbit-host"]["descriptionde"]="IP-Adresse Ihres RabbitMQ-Rechners:
...
";
$elem["manila/rabbit-host"]["descriptionfr"]="Adresse IP de votre hôte RabbitMQ :
...
";
$elem["manila/rabbit-host"]["default"]="localhost";
$elem["manila/rabbit-userid"]["type"]="string";
$elem["manila/rabbit-userid"]["description"]="Username for connection to the RabbitMQ server:
 In order to interoperate with other components of OpenStack, this package
 needs to connect to a central RabbitMQ server.
 .
 Please specify the username used to connect to that RabbitMQ server.
";
$elem["manila/rabbit-userid"]["descriptionde"]="Benutzername für die Verbindung mit dem RabbitMQ-Server:
 Um mit weiteren Bestandteilen von OpenStack zusammenzuarbeiten, muss sich dieses Paket mit einem zentralen RabbitMQ-Server verbinden.
 .
 Bitte geben Sie den Benutzernamen ein, den Sie zum Verbinden mit diesem RabbitMQ-Server verwenden.
";
$elem["manila/rabbit-userid"]["descriptionfr"]="Nom d'utilisateur pour la connexion au serveur RabbitMQ :
 Afin de pouvoir interagir avec d'autres composants d'OpenStack, ce paquet doit se connecter à un serveur centralisé RabbitMQ.
 .
 Veuillez indiquer le nom d'utilisateur à utiliser pour se connecter au serveur RabbitMQ.
";
$elem["manila/rabbit-userid"]["default"]="guest";
$elem["manila/rabbit-password"]["type"]="password";
$elem["manila/rabbit-password"]["description"]="Password for connection to the RabbitMQ server:
 In order to interoperate with other components of OpenStack, this package
 needs to connect to a central RabbitMQ server.
 .
 Please specify the password used to connect to that RabbitMQ server.
";
$elem["manila/rabbit-password"]["descriptionde"]="Passwort für die Verbindung mit dem RabbitMQ-Server:
 Um mit weiteren Bestandteilen von OpenStack zusammenzuarbeiten, muss sich dieses Paket mit einem zentralen RabbitMQ-Server verbinden.
 .
 Bitte geben Sie das Passwort ein, das Sie zum Verbinden mit diesem RabbitMQ-Server verwenden.
";
$elem["manila/rabbit-password"]["descriptionfr"]="Mot de passe pour la connexion au serveur RabbitMQ :
 Afin de pouvoir interagir avec d'autres composants d'OpenStack, ce paquet doit se connecter à un serveur centralisé RabbitMQ.
 .
 Veuillez indiquer le mot de passe à utiliser pour se connecter au serveur RabbitMQ.
";
$elem["manila/rabbit-password"]["default"]="";
$elem["manila/configure_ksat"]["type"]="boolean";
$elem["manila/configure_ksat"]["description"]="Manage keystone_authtoken with debconf?
...
";
$elem["manila/configure_ksat"]["descriptionde"]="Soll »keystone_authtoken« mit Debconf verwaltet werden?
...
";
$elem["manila/configure_ksat"]["descriptionfr"]="Voulez-vous gérer le jeton d'authentification keystone (« keystone_authtoken ») avec les écrans de configuration debconf ?
...
";
$elem["manila/configure_ksat"]["default"]="false";
$elem["manila/ksat-public-url"]["type"]="string";
$elem["manila/ksat-public-url"]["description"]="Auth server public endpoint URL:
...
";
$elem["manila/ksat-public-url"]["descriptionde"]="Öffentlicher Endpunkt-URL des Authentifizierungsservers:
...
";
$elem["manila/ksat-public-url"]["descriptionfr"]="Adresse URL du point d'accès public pour le serveur d'authentification :
...
";
$elem["manila/ksat-public-url"]["default"]="http://localhost:5000";
$elem["manila/ksat-region"]["type"]="string";
$elem["manila/ksat-region"]["description"]="Keystone region:
 Specify the Keystone region to use.
 .
 The region name is usually a string containing only ASCII alphanumerics,
 dots, and dashes.
";
$elem["manila/ksat-region"]["descriptionde"]="Keystone-Region:
...
";
$elem["manila/ksat-region"]["descriptionfr"]="Région Keystone :
...
";
$elem["manila/ksat-region"]["default"]="regionOne";
$elem["manila/ksat-create-service-user"]["type"]="boolean";
$elem["manila/ksat-create-service-user"]["description"]="Create service user?
...
";
$elem["manila/ksat-create-service-user"]["descriptionde"]="Dienstbenutzer erstellen?
...
";
$elem["manila/ksat-create-service-user"]["descriptionfr"]="Voulez-vous créer un utilisateur du service ?
...
";
$elem["manila/ksat-create-service-user"]["default"]="true";
$elem["manila/ksat-admin-username"]["type"]="string";
$elem["manila/ksat-admin-username"]["description"]="Auth server admin username:
";
$elem["manila/ksat-admin-username"]["descriptionde"]="Administratorbenutzername des Authentifizierungsservers:
";
$elem["manila/ksat-admin-username"]["descriptionfr"]="Nom d'utilisateur administrateur pour le serveur d'authentification :
";
$elem["manila/ksat-admin-username"]["default"]="admin";
$elem["manila/ksat-admin-project-name"]["type"]="string";
$elem["manila/ksat-admin-project-name"]["description"]="Auth server admin project name:
";
$elem["manila/ksat-admin-project-name"]["descriptionde"]="Administratorprojektname des Authentifizierungsservers:
";
$elem["manila/ksat-admin-project-name"]["descriptionfr"]="Nom du projet administrateur pour le serveur d'authentification :
";
$elem["manila/ksat-admin-project-name"]["default"]="admin";
$elem["manila/ksat-admin-password"]["type"]="password";
$elem["manila/ksat-admin-password"]["description"]="Auth server admin password:
";
$elem["manila/ksat-admin-password"]["descriptionde"]="Administratorpasswort des Authentifizierungsservers:
";
$elem["manila/ksat-admin-password"]["descriptionfr"]="Mot de passe administrateur pour le serveur d'authentification :
";
$elem["manila/ksat-admin-password"]["default"]="";
$elem["manila/ksat-service-username"]["type"]="string";
$elem["manila/ksat-service-username"]["description"]="Auth server service username:
";
$elem["manila/ksat-service-username"]["descriptionde"]="Dienstbenutzername des Authentifizierungsservers:
";
$elem["manila/ksat-service-username"]["descriptionfr"]="Nom d'utilisateur pour le serveur du service d'authentification :
";
$elem["manila/ksat-service-username"]["default"]="";
$elem["manila/ksat-service-project-name"]["type"]="string";
$elem["manila/ksat-service-project-name"]["description"]="Auth server service project name:
";
$elem["manila/ksat-service-project-name"]["descriptionde"]="Dienstprojektname des Authentifizierungsservers:
";
$elem["manila/ksat-service-project-name"]["descriptionfr"]="Nom du projet pour le serveur du service d'authentification :
";
$elem["manila/ksat-service-project-name"]["default"]="service";
$elem["manila/ksat-service-password"]["type"]="password";
$elem["manila/ksat-service-password"]["description"]="Auth server service password:
";
$elem["manila/ksat-service-password"]["descriptionde"]="Dienstpasswort des Authentifizierungsservers:
";
$elem["manila/ksat-service-password"]["descriptionfr"]="Mot de passe pour le serveur du service d'authentification :
";
$elem["manila/ksat-service-password"]["default"]="";
