...
$elem["trove/configure_db"]["description"]="Set up a database for this package?
...
";
$elem["trove/configure_db"]["descriptionde"]="Eine Datenbank für dieses Paket einrichten?
...
";
$elem["trove/configure_db"]["descriptionfr"]="Voulez-vous installer une base de données pour ce paquet ?
...
$elem["trove/configure_rabbit"]["type"]="boolean";
$elem["trove/configure_rabbit"]["description"]="Configure RabbitMQ access with debconf?
 ...
 connections.
";
$elem["trove/configure_rabbit"]["descriptionde"]="Soll der RabbitMQ-Zugriff mit Debconf konfiguriert werden?
...
";
$elem["trove/configure_rabbit"]["descriptionfr"]="Voulez-vous configurer les accès à RabbitMQ avec les écrans de configuration debconf ?
...
";
$elem["trove/configure_rabbit"]["default"]="false";
$elem["trove/rabbit-host"]["type"]="string";
$elem["trove/rabbit-host"]["description"]="IP address of your RabbitMQ host:
 In order to interoperate with other components of OpenStack, this package
 needs to connect to a central RabbitMQ server.
 .
 Please specify the IP address of that server.
";
$elem["trove/rabbit-host"]["descriptionde"]="IP-Adresse Ihres RabbitMQ-Rechners:
...
";
$elem["trove/rabbit-host"]["descriptionfr"]="Adresse IP de votre hôte RabbitMQ :
...
";
$elem["trove/rabbit-host"]["default"]="localhost";
$elem["trove/rabbit-userid"]["type"]="string";
$elem["trove/rabbit-userid"]["description"]="Username for connection to the RabbitMQ server:
 In order to interoperate with other components of OpenStack, this package
 needs to connect to a central RabbitMQ server.
 .
 Please specify the username used to connect to that RabbitMQ server.
";
$elem["trove/rabbit-userid"]["descriptionde"]="Benutzername für die Verbindung mit dem RabbitMQ-Server:
 Um mit weiteren Bestandteilen von OpenStack zusammenzuarbeiten, muss sich dieses Paket mit einem zentralen RabbitMQ-Server verbinden.
 .
 Bitte geben Sie den Benutzernamen ein, den Sie zum Verbinden mit diesem RabbitMQ-Server verwenden.
";
$elem["trove/rabbit-userid"]["descriptionfr"]="Nom d'utilisateur pour la connexion au serveur RabbitMQ :
 Afin de pouvoir interagir avec d'autres composants d'OpenStack, ce paquet doit se connecter à un serveur centralisé RabbitMQ.
 .
 Veuillez indiquer le nom d'utilisateur à utiliser pour se connecter au serveur RabbitMQ.
";
$elem["trove/rabbit-userid"]["default"]="guest";
$elem["trove/rabbit-password"]["type"]="password";
$elem["trove/rabbit-password"]["description"]="Password for connection to the RabbitMQ server:
 In order to interoperate with other components of OpenStack, this package
 needs to connect to a central RabbitMQ server.
 .
 Please specify the password used to connect to that RabbitMQ server.
";
$elem["trove/rabbit-password"]["descriptionde"]="Passwort für die Verbindung mit dem RabbitMQ-Server:
 Um mit weiteren Bestandteilen von OpenStack zusammenzuarbeiten, muss sich dieses Paket mit einem zentralen RabbitMQ-Server verbinden.
 .
 Bitte geben Sie das Passwort ein, das Sie zum Verbinden mit diesem RabbitMQ-Server verwenden.
";
$elem["trove/rabbit-password"]["descriptionfr"]="Mot de passe pour la connexion au serveur RabbitMQ :
 Afin de pouvoir interagir avec d'autres composants d'OpenStack, ce paquet doit se connecter à un serveur centralisé RabbitMQ.
 .
 Veuillez indiquer le mot de passe à utiliser pour se connecter au serveur RabbitMQ.
";
$elem["trove/rabbit-password"]["default"]="";
$elem["trove/configure_ksat"]["type"]="boolean";
$elem["trove/configure_ksat"]["description"]="Manage keystone_authtoken with debconf?
...
";
$elem["trove/configure_ksat"]["descriptionde"]="Soll »keystone_authtoken« mit Debconf verwaltet werden?
...
";
$elem["trove/configure_ksat"]["descriptionfr"]="Voulez-vous gérer le jeton d'authentification keystone (« keystone_authtoken ») avec les écrans de configuration debconf ?
...
";
$elem["trove/configure_ksat"]["default"]="false";
$elem["trove/ksat-public-url"]["type"]="string";
$elem["trove/ksat-public-url"]["description"]="Auth server public endpoint URL:
...
";
$elem["trove/ksat-public-url"]["descriptionde"]="Öffentlicher Endpunkt-URL des Authentifizierungsservers:
...
";
$elem["trove/ksat-public-url"]["descriptionfr"]="Adresse URL du point d'accès public pour le serveur d'authentification :
...
";
$elem["trove/ksat-public-url"]["default"]="http://localhost:5000";
$elem["trove/ksat-region"]["type"]="string";
$elem["trove/ksat-region"]["description"]="Keystone region:
 Specify the Keystone region to use.
 .
 The region name is usually a string containing only ASCII alphanumerics,
 dots, and dashes.
";
$elem["trove/ksat-region"]["descriptionde"]="Keystone-Region:
...
";
$elem["trove/ksat-region"]["descriptionfr"]="Région Keystone :
...
";
$elem["trove/ksat-region"]["default"]="regionOne";
$elem["trove/ksat-create-service-user"]["type"]="boolean";
$elem["trove/ksat-create-service-user"]["description"]="Create service user?
...
";
$elem["trove/ksat-create-service-user"]["descriptionde"]="Dienstbenutzer erstellen?
...
";
$elem["trove/ksat-create-service-user"]["descriptionfr"]="Voulez-vous créer un utilisateur du service ?
...
";
$elem["trove/ksat-create-service-user"]["default"]="true";
$elem["trove/ksat-admin-username"]["type"]="string";
$elem["trove/ksat-admin-username"]["description"]="Auth server admin username:
";
$elem["trove/ksat-admin-username"]["descriptionde"]="Administratorbenutzername des Authentifizierungsservers:
";
$elem["trove/ksat-admin-username"]["descriptionfr"]="Nom d'utilisateur administrateur pour le serveur d'authentification :
";
$elem["trove/ksat-admin-username"]["default"]="admin";
$elem["trove/ksat-admin-project-name"]["type"]="string";
$elem["trove/ksat-admin-project-name"]["description"]="Auth server admin project name:
";
$elem["trove/ksat-admin-project-name"]["descriptionde"]="Administratorprojektname des Authentifizierungsservers:
";
$elem["trove/ksat-admin-project-name"]["descriptionfr"]="Nom du projet administrateur pour le serveur d'authentification :
";
$elem["trove/ksat-admin-project-name"]["default"]="admin";
$elem["trove/ksat-admin-password"]["type"]="password";
$elem["trove/ksat-admin-password"]["description"]="Auth server admin password:
";
$elem["trove/ksat-admin-password"]["descriptionde"]="Administratorpasswort des Authentifizierungsservers:
";
$elem["trove/ksat-admin-password"]["descriptionfr"]="Mot de passe administrateur pour le serveur d'authentification :
";
$elem["trove/ksat-admin-password"]["default"]="";
$elem["trove/ksat-service-username"]["type"]="string";
$elem["trove/ksat-service-username"]["description"]="Auth server service username:
";
$elem["trove/ksat-service-username"]["descriptionde"]="Dienstbenutzername des Authentifizierungsservers:
";
$elem["trove/ksat-service-username"]["descriptionfr"]="Nom d'utilisateur pour le serveur du service d'authentification :
";
$elem["trove/ksat-service-username"]["default"]="";
$elem["trove/ksat-service-project-name"]["type"]="string";
$elem["trove/ksat-service-project-name"]["description"]="Auth server service project name:
";
$elem["trove/ksat-service-project-name"]["descriptionde"]="Dienstprojektname des Authentifizierungsservers:
";
$elem["trove/ksat-service-project-name"]["descriptionfr"]="Nom du projet pour le serveur du service d'authentification :
";
$elem["trove/ksat-service-project-name"]["default"]="service";
$elem["trove/ksat-service-password"]["type"]="password";
$elem["trove/ksat-service-password"]["description"]="Auth server service password:
";
$elem["trove/ksat-service-password"]["descriptionde"]="Dienstpasswort des Authentifizierungsservers:
";
$elem["trove/ksat-service-password"]["descriptionfr"]="Mot de passe pour le serveur du service d'authentification :
";
$elem["trove/ksat-service-password"]["default"]="";
