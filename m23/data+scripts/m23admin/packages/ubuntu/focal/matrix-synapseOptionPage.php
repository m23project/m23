...
";
$elem["matrix-synapse/server-name"]["descriptionfr"]="Nom du serveur :
 C'est sous ce nom que ce serveur domestique apparaîtra aux clients et aux autres serveurs par fédération. Ce nom devrait correspondre à l'enregistrement de service (SRV) publié dans le DNS.
";
...
$elem["matrix-synapse/report-stats"]["descriptionde"]="Anonyme Statistiken berichten?
 ...
 Vielen Dank.
";
$elem["matrix-synapse/report-stats"]["descriptionfr"]="Voulez-vous envoyer des statistiques anonymes ?
 Les développeurs de Matrix et de Synapse apprécient vraiment l'aide qu'apporte au projet l'envoi de statistiques anonymes d'utilisation de ce serveur domestique. Seules des données très basiques sont agrégées et envoyées (par exemple le nombre d'utilisateurs), mais cela aide à suivre la croissance de la communauté Matrix, et contribue à faire de Matrix un succès, ainsi qu'à convaincre les autres réseaux d'échanger avec Matrix.
 .
 Merci.
";
