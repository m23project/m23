...
$params = PKG_OptionPageHeader2("mariadb-server-10.3");

$elem["mariadb-server-10.3/old_data_directory_saved"]["type"]="note";
$elem["mariadb-server-10.3/old_data_directory_saved"]["description"]="The old data directory will be saved at new location
...
";
$elem["mariadb-server-10.3/old_data_directory_saved"]["descriptionde"]="Das alte Datenverzeichnis wird an einer neuen Stelle gespeichert
...
";
$elem["mariadb-server-10.3/old_data_directory_saved"]["descriptionfr"]="L'ancien répertoire de données sera sauvegardé à un nouvel emplacement
...
";
$elem["mariadb-server-10.3/old_data_directory_saved"]["default"]="";
$elem["mariadb-server-10.3/nis_warning"]["type"]="note";
$elem["mariadb-server-10.3/nis_warning"]["description"]="Important note for NIS/YP users
...
";
$elem["mariadb-server-10.3/nis_warning"]["descriptionde"]="Wichtige Anmerkung für NIS/YP-Benutzer!
 ...
 .
  /var/lib/mysql: drwxr-xr-x   mysql    mysql
";
$elem["mariadb-server-10.3/nis_warning"]["descriptionfr"]="Note importante pour les utilisateurs NIS/YP
 ...
 .
  /var/lib/mysql: drwxr-xr-x   mysql    mysql
";
$elem["mariadb-server-10.3/nis_warning"]["default"]="";
$elem["mariadb-server-10.3/postrm_remove_databases"]["type"]="boolean";
$elem["mariadb-server-10.3/postrm_remove_databases"]["description"]="Remove all MariaDB databases?
...
";
$elem["mariadb-server-10.3/postrm_remove_databases"]["descriptionde"]="Alle MariaDB-Datenbanken entfernen?
...
";
$elem["mariadb-server-10.3/postrm_remove_databases"]["descriptionfr"]="Faut-il supprimer toutes les bases de données MariaDB ?
...
";
$elem["mariadb-server-10.3/postrm_remove_databases"]["default"]="false";
