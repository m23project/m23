...
";
$elem["shared/default-x-display-manager"]["descriptionde"]="Als Standard gewünschter Display-Manager.
 Ein Display-Manager ist ein Programm mit grafischer Oberfläche zur Anmeldung an einem X-Window-System.
 .
 Es sind mehrere Display-Manager installiert, aber nur einer kann einen bestimmten X-Server verwalten. Bitte wählen Sie den Display-Manager, der standardmäßig ausgeführt werden soll.
 .
 (Mehrere Display-Manager können gleichzeitig laufen, wenn sie so eingestellt sind, dass sie verschiedene Server verwalten. Um das zu erreichen, richten Sie die Display-Manager entsprechend ein: Ändern Sie deren Init-Skripte im Verzeichnis /etc/init.d und deaktivieren Sie den Test auf einen Standard-Display-Manager.)
";
