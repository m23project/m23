...
$elem["oem-config/reboot"]["type"]="boolean";
$elem["oem-config/reboot"]["description"]="for internal use; can be preseeded
 Reboot the system before first login.

";
$elem["oem-config/reboot"]["descriptionde"]="";
$elem["oem-config/reboot"]["descriptionfr"]="";
$elem["oem-config/reboot"]["default"]="false";
