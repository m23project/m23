...
$elem["imapproxy/imap-server"]["descriptionde"]="IMAP-Server, zu dem verbunden werden soll:
 Bitte geben Sie den Namen oder die Adresse des IMAP-Servers ein, zu dem IMAP Proxy sich verbinden wird.
";
$elem["imapproxy/imap-server"]["descriptionfr"]="Serveur IMAP :
 Veuillez indiquer le nom d'hôte ou l'adresse IP du serveur IMAP auquel IMAP Proxy se connectera.
";
