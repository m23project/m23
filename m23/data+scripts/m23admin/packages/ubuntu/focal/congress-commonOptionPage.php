...
$elem["congress/configure_db"]["description"]="Set up a database for this package?
...
";
$elem["congress/configure_db"]["descriptionde"]="Eine Datenbank für dieses Paket einrichten?
...
";
$elem["congress/configure_db"]["descriptionfr"]="Voulez-vous installer une base de données pour ce paquet ?
...
$elem["congress/configure_rabbit"]["type"]="boolean";
$elem["congress/configure_rabbit"]["description"]="Configure RabbitMQ access with debconf?
 ...
 connections.
";
$elem["congress/configure_rabbit"]["descriptionde"]="Soll der RabbitMQ-Zugriff mit Debconf konfiguriert werden?
...
";
$elem["congress/configure_rabbit"]["descriptionfr"]="Voulez-vous configurer les accès à RabbitMQ avec les écrans de configuration debconf ?
...
";
$elem["congress/configure_rabbit"]["default"]="false";
$elem["congress/rabbit-host"]["type"]="string";
$elem["congress/rabbit-host"]["description"]="IP address of your RabbitMQ host:
 In order to interoperate with other components of OpenStack, this package
 needs to connect to a central RabbitMQ server.
 .
 Please specify the IP address of that server.
";
$elem["congress/rabbit-host"]["descriptionde"]="IP-Adresse Ihres RabbitMQ-Rechners:
...
";
$elem["congress/rabbit-host"]["descriptionfr"]="Adresse IP de votre hôte RabbitMQ :
...
";
$elem["congress/rabbit-host"]["default"]="localhost";
$elem["congress/rabbit-userid"]["type"]="string";
$elem["congress/rabbit-userid"]["description"]="Username for connection to the RabbitMQ server:
 In order to interoperate with other components of OpenStack, this package
 needs to connect to a central RabbitMQ server.
 .
 Please specify the username used to connect to that RabbitMQ server.
";
$elem["congress/rabbit-userid"]["descriptionde"]="Benutzername für die Verbindung mit dem RabbitMQ-Server:
 Um mit weiteren Bestandteilen von OpenStack zusammenzuarbeiten, muss sich dieses Paket mit einem zentralen RabbitMQ-Server verbinden.
 .
 Bitte geben Sie den Benutzernamen ein, den Sie zum Verbinden mit diesem RabbitMQ-Server verwenden.
";
$elem["congress/rabbit-userid"]["descriptionfr"]="Nom d'utilisateur pour la connexion au serveur RabbitMQ :
 Afin de pouvoir interagir avec d'autres composants d'OpenStack, ce paquet doit se connecter à un serveur centralisé RabbitMQ.
 .
 Veuillez indiquer le nom d'utilisateur à utiliser pour se connecter au serveur RabbitMQ.
";
$elem["congress/rabbit-userid"]["default"]="guest";
$elem["congress/rabbit-password"]["type"]="password";
$elem["congress/rabbit-password"]["description"]="Password for connection to the RabbitMQ server:
 In order to interoperate with other components of OpenStack, this package
 needs to connect to a central RabbitMQ server.
 .
 Please specify the password used to connect to that RabbitMQ server.
";
$elem["congress/rabbit-password"]["descriptionde"]="Passwort für die Verbindung mit dem RabbitMQ-Server:
 Um mit weiteren Bestandteilen von OpenStack zusammenzuarbeiten, muss sich dieses Paket mit einem zentralen RabbitMQ-Server verbinden.
 .
 Bitte geben Sie das Passwort ein, das Sie zum Verbinden mit diesem RabbitMQ-Server verwenden.
";
$elem["congress/rabbit-password"]["descriptionfr"]="Mot de passe pour la connexion au serveur RabbitMQ :
 Afin de pouvoir interagir avec d'autres composants d'OpenStack, ce paquet doit se connecter à un serveur centralisé RabbitMQ.
 .
 Veuillez indiquer le mot de passe à utiliser pour se connecter au serveur RabbitMQ.
";
$elem["congress/rabbit-password"]["default"]="";
$elem["congress/configure_ksat"]["type"]="boolean";
$elem["congress/configure_ksat"]["description"]="Manage keystone_authtoken with debconf?
...
";
$elem["congress/configure_ksat"]["descriptionde"]="Soll »keystone_authtoken« mit Debconf verwaltet werden?
...
";
$elem["congress/configure_ksat"]["descriptionfr"]="Voulez-vous gérer le jeton d'authentification keystone (« keystone_authtoken ») avec les écrans de configuration debconf ?
...
";
$elem["congress/configure_ksat"]["default"]="false";
$elem["congress/ksat-public-url"]["type"]="string";
$elem["congress/ksat-public-url"]["description"]="Auth server public endpoint URL:
...
";
$elem["congress/ksat-public-url"]["descriptionde"]="Öffentlicher Endpunkt-URL des Authentifizierungsservers:
...
";
$elem["congress/ksat-public-url"]["descriptionfr"]="Adresse URL du point d'accès public pour le serveur d'authentification :
...
";
$elem["congress/ksat-public-url"]["default"]="http://localhost:5000";
$elem["congress/ksat-admin-url"]["type"]="string";
$elem["congress/ksat-admin-url"]["description"]="Auth server admin endpoint URL:
 Specify the URL of your Keystone authentication server admin endpoint. This
 value will be set in auth_url.
";
$elem["congress/ksat-admin-url"]["descriptionde"]="Administrator-Endpunkt-URL des Authentifizierungsservers:
...
";
$elem["congress/ksat-admin-url"]["descriptionfr"]="Adresse URL du point d'accès administrateur pour le serveur d'authentification :
...
";
$elem["congress/ksat-admin-url"]["default"]="http://localhost:5000";
$elem["congress/ksat-region"]["type"]="string";
$elem["congress/ksat-region"]["description"]="Keystone region:
 Specify the Keystone region to use.
 .
 The region name is usually a string containing only ASCII alphanumerics,
 dots, and dashes.
";
$elem["congress/ksat-region"]["descriptionde"]="Keystone-Region:
...
";
$elem["congress/ksat-region"]["descriptionfr"]="Région Keystone :
...
";
$elem["congress/ksat-region"]["default"]="regionOne";
$elem["congress/ksat-create-service-user"]["type"]="boolean";
$elem["congress/ksat-create-service-user"]["description"]="Create service user?
...
";
$elem["congress/ksat-create-service-user"]["descriptionde"]="Dienstbenutzer erstellen?
...
";
$elem["congress/ksat-create-service-user"]["descriptionfr"]="Voulez-vous créer un utilisateur du service ?
...
";
$elem["congress/ksat-create-service-user"]["default"]="true";
$elem["congress/ksat-admin-username"]["type"]="string";
$elem["congress/ksat-admin-username"]["description"]="Auth server admin username:
";
$elem["congress/ksat-admin-username"]["descriptionde"]="Administratorbenutzername des Authentifizierungsservers:
";
$elem["congress/ksat-admin-username"]["descriptionfr"]="Nom d'utilisateur administrateur pour le serveur d'authentification :
";
$elem["congress/ksat-admin-username"]["default"]="admin";
$elem["congress/ksat-admin-project-name"]["type"]="string";
$elem["congress/ksat-admin-project-name"]["description"]="Auth server admin project name:
";
$elem["congress/ksat-admin-project-name"]["descriptionde"]="Administratorprojektname des Authentifizierungsservers:
";
$elem["congress/ksat-admin-project-name"]["descriptionfr"]="Nom du projet administrateur pour le serveur d'authentification :
";
$elem["congress/ksat-admin-project-name"]["default"]="admin";
$elem["congress/ksat-admin-password"]["type"]="password";
$elem["congress/ksat-admin-password"]["description"]="Auth server admin password:
";
$elem["congress/ksat-admin-password"]["descriptionde"]="Administratorpasswort des Authentifizierungsservers:
";
$elem["congress/ksat-admin-password"]["descriptionfr"]="Mot de passe administrateur pour le serveur d'authentification :
";
$elem["congress/ksat-admin-password"]["default"]="";
$elem["congress/ksat-service-username"]["type"]="string";
$elem["congress/ksat-service-username"]["description"]="Auth server service username:
";
$elem["congress/ksat-service-username"]["descriptionde"]="Dienstbenutzername des Authentifizierungsservers:
";
$elem["congress/ksat-service-username"]["descriptionfr"]="Nom d'utilisateur pour le serveur du service d'authentification :
";
$elem["congress/ksat-service-username"]["default"]="";
$elem["congress/ksat-service-project-name"]["type"]="string";
$elem["congress/ksat-service-project-name"]["description"]="Auth server service project name:
";
$elem["congress/ksat-service-project-name"]["descriptionde"]="Dienstprojektname des Authentifizierungsservers:
";
$elem["congress/ksat-service-project-name"]["descriptionfr"]="Nom du projet pour le serveur du service d'authentification :
";
$elem["congress/ksat-service-project-name"]["default"]="service";
$elem["congress/ksat-service-password"]["type"]="password";
$elem["congress/ksat-service-password"]["description"]="Auth server service password:
";
$elem["congress/ksat-service-password"]["descriptionde"]="Dienstpasswort des Authentifizierungsservers:
";
$elem["congress/ksat-service-password"]["descriptionfr"]="Mot de passe pour le serveur du service d'authentification :
";
$elem["congress/ksat-service-password"]["default"]="";
