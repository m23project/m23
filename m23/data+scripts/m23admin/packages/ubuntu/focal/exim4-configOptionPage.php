...
$elem["exim4/dc_eximconfig_configtype"]["choicesfr"][2]="Envoi par relais (« smarthost ») — réception SMTP ou fetchmail";
$elem["exim4/dc_eximconfig_configtype"]["choicesfr"][3]="Envoi par relais (« smarthost ») — pas de courrier local";
...
";
$elem["exim4/mailname"]["descriptionfr"]="Nom de courrier du système :
...
";
$elem["exim4/dc_other_hostnames"]["descriptionfr"]="Autres destinations dont le courrier doit être accepté :
 Veuillez indiquer une liste des domaines, séparés par des points-virgules, pour lesquels cette machine est la destination finale. Il est inutile de mentionner ici le nom d'hôte local (${fqdn}) ou « localhost ». Ces domaines sont habituellement appelés des domaines locaux.
 .
...
$elem["exim4/dc_relay_nets"]["descriptionfr"]="Machines à relayer :
 Veuillez indiquer une liste de plages d'adresses IP, séparées par des points-virgules, pour lesquelles ce système acceptera de relayer le courrier sans discrimination (fonctionnement en « smarthost »).
 .
...
$elem["exim4/dc_readhost"]["descriptionfr"]="Nom de domaine visible pour les utilisateurs locaux :
 L'option permettant de cacher le nom local de courrier a été activée. Il est donc nécessaire d'indiquer le nom de domaine que ce système doit utiliser pour les envois de courriers des utilisateurs locaux.
";
...
";
$elem["exim4/dc_postmaster"]["descriptionfr"]="Destinataire des courriers de « root » et « postmaster » :
...
";
$elem["exim4/exim4-config-title"]["descriptionfr"]="Configuration du serveur de courrier
";
...
";
$elem["exim4/hide_mailname"]["descriptionfr"]="Faut-il cacher le nom local de courrier dans les courriers sortants ?
 Les en-têtes des courriers sortants peuvent être réécrits afin qu'ils semblent avoir été émis depuis un autre système : « ${mailname} », « localhost » et « ${dc_other_hostnames} » seront alors remplacés dans les en-têtes « From », « Reply-To », « Sender » et « Return-Path ».
";
