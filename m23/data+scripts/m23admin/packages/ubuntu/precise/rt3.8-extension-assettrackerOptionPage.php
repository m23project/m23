...
$params = PKG_OptionPageHeader2("rt3.8-extension-assettracker");

$elem["rt3.8-extension-assettracker/modify-database-permission"]["type"]="select";
$elem["rt3.8-extension-assettracker/modify-database-permission"]["choices"][1]="allow";
$elem["rt3.8-extension-assettracker/modify-database-permission"]["choices"][2]="prompt";
$elem["rt3.8-extension-assettracker/modify-database-permission"]["choicesde"][1]="erlauben";
$elem["rt3.8-extension-assettracker/modify-database-permission"]["choicesde"][2]="nachfragen";
$elem["rt3.8-extension-assettracker/modify-database-permission"]["choicesfr"][1]="autoriser";
$elem["rt3.8-extension-assettracker/modify-database-permission"]["choicesfr"][2]="demander";
$elem["rt3.8-extension-assettracker/modify-database-permission"]["description"]="Permission to modify the Request Tracker database:
...
";
$elem["rt3.8-extension-assettracker/modify-database-permission"]["descriptionde"]="Erlaubnis, die Datenbank von Request Tracker zu verändern:
...
";
$elem["rt3.8-extension-assettracker/modify-database-permission"]["descriptionfr"]="Autorisation de modifier la base de données de Request Tracker :
...
";
$elem["rt3.8-extension-assettracker/modify-database-permission"]["default"]="allow";
$elem["rt3.8-extension-assettracker/setup-database-prompt"]["type"]="boolean";
$elem["rt3.8-extension-assettracker/setup-database-prompt"]["description"]="Set up the Request Tracker database?
 New tables must be created in the Request Tracker database for Asset
 Tracker to be functional.
";
$elem["rt3.8-extension-assettracker/setup-database-prompt"]["descriptionde"]="Die Request-Tracker-Datenbank einrichten?
 In der Request-Tracker-Datenbank müssen neue Tabellen erstellt werden, damit Asset Tracker funktioniert.
";
$elem["rt3.8-extension-assettracker/setup-database-prompt"]["descriptionfr"]="Faut-il configurer la base de données de Request Tracker ?
...
";
$elem["rt3.8-extension-assettracker/setup-database-prompt"]["default"]="true";
$elem["rt3.8-extension-assettracker/upgrade-database-prompt"]["type"]="boolean";
$elem["rt3.8-extension-assettracker/upgrade-database-prompt"]["description"]="Upgrade the Request Tracker database?
 The Request Tracker database schema and contents must be upgraded for
 this version of Asset Tracker.
";
$elem["rt3.8-extension-assettracker/upgrade-database-prompt"]["descriptionde"]="Upgrade der Request-Tracker-Datenbank durchführen?
 Es muss ein Upgrade der Request-Tracker-Datenbankschemata für diese Version von Asset Tracker durchgeführt werden.
";
$elem["rt3.8-extension-assettracker/upgrade-database-prompt"]["descriptionfr"]="Faut-il mettre à jour la base de données de Request Tracker ?
...
";
$elem["rt3.8-extension-assettracker/upgrade-database-prompt"]["default"]="true";
$elem["rt3.8-extension-assettracker/modify-database-error"]["type"]="select";
$elem["rt3.8-extension-assettracker/modify-database-error"]["choices"][1]="abort";
$elem["rt3.8-extension-assettracker/modify-database-error"]["choices"][2]="retry";
$elem["rt3.8-extension-assettracker/modify-database-error"]["choicesde"][1]="abbrechen";
$elem["rt3.8-extension-assettracker/modify-database-error"]["choicesde"][2]="erneut versuchen";
$elem["rt3.8-extension-assettracker/modify-database-error"]["choicesfr"][1]="abandonner";
$elem["rt3.8-extension-assettracker/modify-database-error"]["choicesfr"][2]="réessayer";
$elem["rt3.8-extension-assettracker/modify-database-error"]["description"]="Action after database modification error:
 ...
 will continue.
";
$elem["rt3.8-extension-assettracker/modify-database-error"]["descriptionde"]="Aktion, die nach einem Fehler beim Ändern der Datenbank erfolgen soll:
...
";
$elem["rt3.8-extension-assettracker/modify-database-error"]["descriptionfr"]="Action à effectuer en cas d'erreur pendant la modification de la base :
...
";
$elem["rt3.8-extension-assettracker/modify-database-error"]["default"]="abort";
