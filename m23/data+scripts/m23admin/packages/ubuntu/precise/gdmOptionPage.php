...
$params = PKG_OptionPageHeader2("gdm");

$elem["gdm/daemon_name"]["type"]="string";
$elem["gdm/daemon_name"]["description"]="for internal use only

";
$elem["gdm/daemon_name"]["descriptionde"]="";
$elem["gdm/daemon_name"]["descriptionfr"]="";
$elem["gdm/daemon_name"]["default"]="/usr/sbin/gdm";
