...
$elem["dokuwiki/wiki/license"]["choicesfr"][2]="Attribution CC";
$elem["dokuwiki/wiki/license"]["choicesfr"][3]="Partage des conditions initiales à l'identique";
$elem["dokuwiki/wiki/license"]["choicesfr"][4]="Licence de documentation libre GNU";
$elem["dokuwiki/wiki/license"]["choicesfr"][5]="Pas d'utilisation commerciale";
$elem["dokuwiki/wiki/license"]["choicesfr"][6]="Pas d'utilisation commerciale\";
...
$elem["dokuwiki/wiki/license"]["descriptionde"]="Wiki-Lizenz:
 Bitte wählen Sie die Lizenz, die Sie für den Inhalt Ihres Wikis verwenden möchten.
 .
...
$elem["dokuwiki/wiki/license"]["descriptionfr"]="Licence du wiki :
 Veuillez choisir la licence que vous désirez appliquer au contenu de votre wiki.
 .
 La licence CC « Aucun droit réservé » est conçue pour renoncer au maximum de droits qu'il est légalement possible.
 .
 L'attribution CC est une licence permissive qui ne requiert aux licences que de reconnaître l'auteur.
 .
 « Partage des conditions initiales à l'identique » (CC Attribution-Share Alike) et la licence de documentation libre GNU sont des licences de libre diffusion (« copyleft ») (qui requiert que les modifications soient publiées sous des termes similaires).
 .
 « Pas d'utilisation commerciale » (CC Attribution-Noncommercial) et « Pas d'utilisation commerciale, partage des conditions initiales à l'identique » sont des licences interdisant un usage commercial.
";
