...
$params = PKG_OptionPageHeader2("libssl1.0.0");

$elem["libssl1.0.0/restart-services"]["type"]="string";
$elem["libssl1.0.0/restart-services"]["description"]="Services to restart to make them use the new libraries:
 ...
 SSL-related trouble.
";
$elem["libssl1.0.0/restart-services"]["descriptionde"]="Welche Dienste sollen erneut gestartet werden, damit sie die neuen Bibliotheken verwenden?
...
";
$elem["libssl1.0.0/restart-services"]["descriptionfr"]="Services à redémarrer afin d'utiliser les nouvelles bibliothèques :
...
";
$elem["libssl1.0.0/restart-services"]["default"]="";
$elem["libssl1.0.0/restart-failed"]["type"]="error";
$elem["libssl1.0.0/restart-failed"]["description"]="Failure restarting some services for OpenSSL upgrade
...
";
$elem["libssl1.0.0/restart-failed"]["descriptionde"]="Neustarten einiger Dienste beim OpenSSL-Upgrade fehlgeschlagen
...
";
$elem["libssl1.0.0/restart-failed"]["descriptionfr"]="Impossible de redémarrer certains services lors de la mise à jour d'OpenSSL
...
";
$elem["libssl1.0.0/restart-failed"]["default"]="";
