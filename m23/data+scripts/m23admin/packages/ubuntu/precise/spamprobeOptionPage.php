...
$elem["spamprobe/db51_upgrade"]["type"]="note";
$elem["spamprobe/db51_upgrade"]["description"]="Upgrading to Berkeley DB 5.1
 As of spamprobe 1.4d-8, the database format changed
 to Berkeley DB 5.1 and spamprobe is no longer able to modify
...
";
$elem["spamprobe/db51_upgrade"]["descriptionde"]="Upgrade auf Berkeley DB 5.1
 Mit Spamprobe 1.4d-8 änderte sich das Datenbankformat auf Berkeley DB 5.1 und Spamprobe ist nicht mehr in der Lage, Datenbanken in älteren Formaten zu bearbeiten.
 .
...
";
$elem["spamprobe/db51_upgrade"]["descriptionfr"]="Mise à jour vers Berkeley DB 5.1
 À partir de la version 1.4d-8 de spamprobe, le format de la base de données est devenu le format Berkeley 5.1. Par conséquence, spamprobe ne peut plus modifier les bases de données existantes si elles utilisent un format antérieur.
 .
...
";
$elem["spamprobe/db51_upgrade"]["default"]="";
