...
$params = PKG_OptionPageHeader2("slapos-node-unofficial");
...
$elem["slapos-node-unofficial/computer_id"]["type"]="string";
$elem["slapos-node-unofficial/computer_id"]["description"]="SlapOS computer ID:
 Please specify a unique identifier for this SlapOS node.
";
$elem["slapos-node-unofficial/computer_id"]["descriptionde"]="SlapOS-Rechnerkennzahl:
 Bitte geben Sie einen eindeutigen Bezeichner für diesen SlapOS-Knoten an.
";
$elem["slapos-node-unofficial/computer_id"]["descriptionfr"]="Identifiant de la machine SlapOS :
 Veuillez indiquer un identifiant unique pour ce nœud SlapOS.
";
$elem["slapos-node-unofficial/computer_id"]["default"]="";
$elem["slapos-node-unofficial/software_root"]["type"]="string";
$elem["slapos-node-unofficial/software_root"]["description"]="Software Releases root directory:
...
";
$elem["slapos-node-unofficial/software_root"]["descriptionde"]="Wurzelverzeichnis der Softwareveröffentlichung:
...
";
$elem["slapos-node-unofficial/software_root"]["descriptionfr"]="Répertoire racine des publications de logiciels :
...
";
$elem["slapos-node-unofficial/software_root"]["default"]="";
$elem["slapos-node-unofficial/partition_amount"]["type"]="string";
$elem["slapos-node-unofficial/partition_amount"]["description"]="Number of Computer Partitions on this computer:
...
";
$elem["slapos-node-unofficial/partition_amount"]["descriptionde"]="Anzahl der »Computer Partitionen« auf diesem Rechner:
...
";
$elem["slapos-node-unofficial/partition_amount"]["descriptionfr"]="Nombre de « Partitions Ordinateur » présentes sur cette machine :
...
";
$elem["slapos-node-unofficial/partition_amount"]["default"]="";
$elem["slapos-node-unofficial/ipv4_local_network"]["type"]="string";
$elem["slapos-node-unofficial/ipv4_local_network"]["description"]="Local IPv4 network to be used for Computer Partitions:
 Every Computer Partition must have an address on the same IPv4 network.
 Please specify a network in CIDR notation (e.g.: 192.0.2.0/24).
";
$elem["slapos-node-unofficial/ipv4_local_network"]["descriptionde"]="Lokales IPv4-Netzwerk, das für »Computer Partitionen« benutzt wird:
...
";
$elem["slapos-node-unofficial/ipv4_local_network"]["descriptionfr"]="Réseau IPV4 à utiliser pour les « Partitions d'Ordinateur » :
...
";
$elem["slapos-node-unofficial/ipv4_local_network"]["default"]="10.0.0.0/16";
