...
$elem["cloud-init/datasources"]["choices"][11]=" SmartOS: Read from SmartOS metadata service";
$elem["cloud-init/datasources"]["choices"][12]="Ec2: reads data from EC2 Metadata service";
$elem["cloud-init/datasources"]["choices"][13]="CloudStack: Read from CloudStack metadata service";
