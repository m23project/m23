...
$params = PKG_OptionPageHeader2("ganeti-haskell-2.15");

$elem["ganeti-haskell-2.15/abort-removal"]["type"]="boolean";
$elem["ganeti-haskell-2.15/abort-removal"]["description"]="Abort ${package} removal?
 ...
 removing ${package}.
";
$elem["ganeti-haskell-2.15/abort-removal"]["descriptionde"]="Entfernen von ${package} abbrechen?
...
";
$elem["ganeti-haskell-2.15/abort-removal"]["descriptionfr"]="Faut-il abandonner la suppression de ${package} ?
...
";
$elem["ganeti-haskell-2.15/abort-removal"]["default"]="true";
