...
$params = PKG_OptionPageHeader2("percona-server-server-5.6");

$elem["percona-server-server-5.6/really_downgrade"]["type"]="boolean";
$elem["percona-server-server-5.6/really_downgrade"]["description"]="Really proceed with downgrade?
...
";
$elem["percona-server-server-5.6/really_downgrade"]["descriptionde"]="";
$elem["percona-server-server-5.6/really_downgrade"]["descriptionfr"]="";
$elem["percona-server-server-5.6/really_downgrade"]["default"]="false";
