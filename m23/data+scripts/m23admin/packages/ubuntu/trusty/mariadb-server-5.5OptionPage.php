...
$params = PKG_OptionPageHeader2("mariadb-server-5.5");

$elem["mariadb-server-5.5/really_downgrade"]["type"]="boolean";
$elem["mariadb-server-5.5/really_downgrade"]["description"]="Really proceed with downgrade?
...
";
$elem["mariadb-server-5.5/really_downgrade"]["descriptionde"]="Möchten Sie wirklich eine ältere Version einspielen?
 Auf diesem System existiert eine Datei mit dem Namen /var/lib/mysql/debian-*.flag
 .
 Diese Datei ist ein Hinweis darauf, dass früher ein MariaDB-Server-Paket mit einer höheren Version installiert war.
 .
 Es kann nicht garantiert werden, dass die gegenwärtig zu installierende Version dessen Daten benutzen kann.
";
$elem["mariadb-server-5.5/really_downgrade"]["descriptionfr"]="Faut-il vraiment revenir à la version précédente ?
...
";
$elem["mariadb-server-5.5/really_downgrade"]["default"]="false";
...
$elem["mysql-server-5.5/nis_warning"]["descriptionde"]="Wichtige Anmerkung für NIS/YP-Benutzer!
 Falls MariaDB mit NIS/YP genutzt wird, ist ein »mysql«-Benutzerkonto auf dem lokalen System notwendig:
 .
  adduser --system --group --home /var/lib/mysql mysql
 .
...
$elem["mysql-server-5.5/postrm_remove_databases"]["description"]="Remove all MariaDB databases?
...
";
$elem["mysql-server-5.5/postrm_remove_databases"]["descriptionde"]="Alle MariaDB-Datenbanken entfernen?
 Das Verzeichnis /var/lib/mysql mit den MariaDB-Datenbanken soll entfernt werden.
 .
 Falls geplant ist, nur eine höhere Version von MariaDB zu installieren oder ein anderes mariadb-server-Paket dieses bereits benutzt, sollten die Daten behalten werden.
";
$elem["mysql-server-5.5/postrm_remove_databases"]["descriptionfr"]="Faut-il supprimer toutes les bases de données MariaDB ?
...
$elem["mysql-server/error_setting_password"]["descriptionfr"]="Impossible de changer le mot de passe de l'utilisateur « root » de MariaDB
 ...
 .
 Veuillez consulter le fichier /usr/share/doc/mariadb-server-5.5/README.Debian pour plus d'informations.
";
...
";
$elem["mariadb-server/oneway_migration"]["descriptionde"]="";
