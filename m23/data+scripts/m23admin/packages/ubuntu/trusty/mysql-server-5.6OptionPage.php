...
$params = PKG_OptionPageHeader2("mysql-server-5.6");

$elem["mysql-server-5.6/really_downgrade"]["type"]="boolean";
$elem["mysql-server-5.6/really_downgrade"]["description"]="Really proceed with downgrade?
...
";
$elem["mysql-server-5.6/really_downgrade"]["descriptionde"]="Möchten Sie wirklich eine ältere Version einspielen?
...
";
$elem["mysql-server-5.6/really_downgrade"]["descriptionfr"]="Faut-il vraiment revenir à la version précédente ?
...
";
$elem["mysql-server-5.6/really_downgrade"]["default"]="false";
$elem["mysql-server-5.6/nis_warning"]["type"]="note";
$elem["mysql-server-5.6/nis_warning"]["description"]="Important note for NIS/YP users
...
";
$elem["mysql-server-5.6/nis_warning"]["descriptionde"]="Wichtige Anmerkung für NIS/YP-Benutzer!
 ...
 .
  /var/lib/mysql: drwxr-xr-x   mysql    mysql
";
$elem["mysql-server-5.6/nis_warning"]["descriptionfr"]="Note importante pour les utilisateurs NIS/YP
 ...
 .
  /var/lib/mysql: drwxr-xr-x   mysql    mysql
";
$elem["mysql-server-5.6/nis_warning"]["default"]="";
$elem["mysql-server-5.6/postrm_remove_databases"]["type"]="boolean";
$elem["mysql-server-5.6/postrm_remove_databases"]["description"]="Remove all MySQL databases?
...
";
$elem["mysql-server-5.6/postrm_remove_databases"]["descriptionde"]="Alle MySQL-Datenbanken entfernen?
...
";
$elem["mysql-server-5.6/postrm_remove_databases"]["descriptionfr"]="Faut-il supprimer toutes les bases de données MySQL ?
...
";
$elem["mysql-server-5.6/postrm_remove_databases"]["default"]="false";
$elem["mysql-server-5.6/start_on_boot"]["type"]="boolean";
$elem["mysql-server-5.6/start_on_boot"]["description"]="Start the MySQL server on boot?
 The MySQL server can be launched automatically at boot time or manually
 with the '/etc/init.d/mysql start' command.
";
$elem["mysql-server-5.6/start_on_boot"]["descriptionde"]="Soll der MySQL-Server automatisch beim Booten starten?
...
";
$elem["mysql-server-5.6/start_on_boot"]["descriptionfr"]="Faut-il lancer MySQL au démarrage ?
 MySQL peut être lancé soit au démarrage, soit en entrant la commande « /etc/init.d/mysql start ».
";
$elem["mysql-server-5.6/start_on_boot"]["default"]="true";
...
$elem["mysql-server/error_setting_password"]["descriptionde"]="Konnte für den MySQL-»root«-Benutzer kein Passwort setzen
 ...
 .
 Für weitere Informationen lesen Sie /usr/share/doc/mysql-server-5.6/README.Debian.
";
$elem["mysql-server/error_setting_password"]["descriptionfr"]="Impossible de changer le mot de passe de l'utilisateur « root » de MySQL
 ...
 .
 Veuillez consulter le fichier /usr/share/doc/mysql-server-5.6/README.Debian pour plus d'informations.
";
...
$elem["mysql-server/no_upgrade_when_using_ndb"]["descriptionde"]="NDB-Cluster scheint gerade benutzt zu werden
 MySQL-5.6 bietet keine NDB-Clusterunterstützung mehr. Bitte migrieren Sie Ihr System zum neuen »mysql-cluster-server«-Paket und entfernen Sie alle Zeilen, die mit »ndb« beginnen aus allen Konfigurationsdateien im Verzeichnis /etc/mysql/.
";
$elem["mysql-server/no_upgrade_when_using_ndb"]["descriptionfr"]="Abandon de la gestion de NDB
 La version 5.6 de MySQL ne gère plus les grappes NDB. Vous devriez utiliser le paquet mysql-cluster-server et supprimer toutes les lignes commençant par « ndb » des fichiers de configuration situés dans /etc/mysql.
";
