...
$elem["man-db/auto-update"]["type"]="boolean";
$elem["man-db/auto-update"]["description"]="for internal use; can be preseeded
 If true, automatically rebuild man-db's database when packages containing
 manual pages are installed.
";
$elem["man-db/auto-update"]["descriptionde"]="";
$elem["man-db/auto-update"]["descriptionfr"]="";
$elem["man-db/auto-update"]["default"]="true";
