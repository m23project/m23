...
$elem["liblemonldap-ng-conf-perl/domain"]["description"]="Lemonldap::NG DNS domain:
 ...
 You can modify this value later using the Lemonldap::NG manager.
";
$elem["liblemonldap-ng-conf-perl/domain"]["descriptionde"]="Lemonldap::NG DNS-Domain:
...
";
$elem["liblemonldap-ng-conf-perl/domain"]["descriptionfr"]="Domaine DNS pour Lemonldap::NG :
...
";
$elem["liblemonldap-ng-conf-perl/portal"]["descriptionfr"]="Portail de Lemonldap::NG :
...
";
$elem["liblemonldap-ng-conf-perl/managerDn"]["descriptionfr"]="Identifiant de connexion LDAP :
...
";
$elem["liblemonldap-ng-conf-perl/managerPassword"]["descriptionfr"]="Mot de passe de connexion LDAP :
...
$elem["liblemonldap-ng-conf-perl/migrate"]["type"]="boolean";
$elem["liblemonldap-ng-conf-perl/migrate"]["description"]="Lemonldap::NG configuration files have changed, try to migrate your files?
";
$elem["liblemonldap-ng-conf-perl/migrate"]["descriptionde"]="Lemonldap::NG-Konfigurationsdateien wurden geändert, soll versucht werden, die Dateien zu migrieren?
";
$elem["liblemonldap-ng-conf-perl/migrate"]["descriptionfr"]="Faut-il tenter une migration des fichiers de configuration de Lemonldap::NG ?
";
$elem["liblemonldap-ng-conf-perl/migrate"]["default"]="";
