...
";
$elem["debconf/frontend"]["descriptionde"]="Zu nutzende Schnittstellenoberfläche:
...
$elem["debconf-apt-progress/media-change"]["description"]="Media change
 ${MESSAGE}
";
$elem["debconf-apt-progress/media-change"]["descriptionde"]="Datenträgerwechsel
 ${MESSAGE}
";
$elem["debconf-apt-progress/media-change"]["descriptionfr"]="Changement de support
 ${MESSAGE}
";
