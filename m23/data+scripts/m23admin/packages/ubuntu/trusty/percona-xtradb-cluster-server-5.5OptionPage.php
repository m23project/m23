...
$params = PKG_OptionPageHeader2("percona-xtradb-cluster-server-5.5");

$elem["percona-xtradb-cluster-server-5.5/really_downgrade"]["type"]="boolean";
$elem["percona-xtradb-cluster-server-5.5/really_downgrade"]["description"]="Really proceed with downgrade?
...
";
$elem["percona-xtradb-cluster-server-5.5/really_downgrade"]["descriptionde"]="";
$elem["percona-xtradb-cluster-server-5.5/really_downgrade"]["descriptionfr"]="";
$elem["percona-xtradb-cluster-server-5.5/really_downgrade"]["default"]="false";
...
";
$elem["mysql-server-5.1/nis_warning"]["descriptionde"]="";
$elem["mysql-server-5.1/nis_warning"]["descriptionfr"]="";
$elem["mysql-server-5.1/nis_warning"]["default"]="";
$elem["mysql-server-5.1/postrm_remove_databases"]["type"]="boolean";
$elem["mysql-server-5.1/postrm_remove_databases"]["description"]="Remove all Percona Server databases?
...
";
$elem["mysql-server-5.1/postrm_remove_databases"]["descriptionde"]="";
$elem["mysql-server-5.1/postrm_remove_databases"]["descriptionfr"]="";
