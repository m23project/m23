...
$params = PKG_OptionPageHeader2("lcl-utils-1.0.10");

$elem["lcl-utils-1.0.10/rename_cfg"]["type"]="boolean";
$elem["lcl-utils-1.0.10/rename_cfg"]["description"]="Rename \"/etc/lazarus\" to \"/etc/lazarus.bak\"?
...
";
$elem["lcl-utils-1.0.10/rename_cfg"]["descriptionde"]="»/etc/lazarus« in »/etc/lazarus.bak« umbenennen?
...
";
$elem["lcl-utils-1.0.10/rename_cfg"]["descriptionfr"]="Faut-il renommer « /etc/lazarus » en « /etc/lazarus.bak » ?
...
";
$elem["lcl-utils-1.0.10/rename_cfg"]["default"]="true";
