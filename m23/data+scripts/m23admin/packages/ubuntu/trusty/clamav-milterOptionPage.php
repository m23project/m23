...
$elem["clamav-milter/Chroot"]["descriptionde"]="Chroot in Verzeichnis:
 Clamav-Milter kann in einem Chroot-Gefängnis (Jail) betrieben werden. Es wird in dieses eintreten, nachdem es die Konfigurationsdatei gelesen hat und bevor es die root-Privilegien aufgibt.
 .
...
$elem["clamav-milter/TemporaryDirectory"]["descriptionde"]="Temporärer Verzeichnispfad:
 Bitte geben Sie das Verzeichnis für die Dateien von Clamav-Milter an, welche für die Analyse temporär gepuffert werden. Wenn nicht angegeben, werden $TMPDIR und $TEMP berücksichtigt.
";
...
$elem["clamav-milter/LogClean"]["descriptionde"]="Informationen, die protokolliert werden, falls keine Gefahr erkannt wurde:
 Bitte wählen sie den Grad von Informationen, die protokolliert werden, wenn keine Gefahr in den analysierten Nachrichten erkannt wurde (dies ist für die Fehlersuche hilfreich, lässt aber auch die Größe des Logs drastisch anwachsen):
  - Aus:         keine Protokollierung 
  - Einfach:     minimale Informationen
  - Vollständig: Ausführliche Informationen
";
...
";
$elem["clamav-milter/SupportMultipleRecipients"]["descriptionde"]="";
$elem["clamav-milter/SupportMultipleRecipients"]["descriptionfr"]="";
