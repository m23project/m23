...
$elem["nullmailer/defaultdomain"]["type"]="string";
$elem["nullmailer/defaultdomain"]["description"]="The domain name to be appended to hostnames:
...
";
$elem["nullmailer/defaultdomain"]["descriptionde"]="The domain name to be appended to hostnames:
 This is the domain name which will be added to any hostnames that don't contain a dot (that is to say, which aren't already qualified by a domain).
";
$elem["nullmailer/defaultdomain"]["descriptionfr"]="The domain name to be appended to hostnames:
 This is the domain name which will be added to any hostnames that don't contain a dot (that is to say, which aren't already qualified by a domain).
";
$elem["nullmailer/defaultdomain"]["default"]="";
