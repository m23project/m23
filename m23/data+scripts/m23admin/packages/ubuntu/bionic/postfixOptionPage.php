...
$elem["postfix/relay_restrictions_warning"]["descriptionde"]="smtpd_relay_restrictions in main.cf für das Upgrade setzen?
 Postfix Version 2.10 fügt smtpd_relay_restrictions hinzu, um Weiterleitungs-von Empfänger-Beschränkungen zu trennen. Bei Ihnen liegt eine von der Vorgabe abweichende smtpd_recipient_restrictions vor.
 .
...
$elem["postfix/compat_conversion_warning"]["descriptionde"]="Um Warnungen zu Inkompatibiltäten zu vermeiden, die Konfiguration aktualisieren?
 Diese Aktualisierung von Postfix ändert einige Standardwerte der Konfiguration. Dazu gehört: (1) in master.cf wird »-« als Wert von chrooted-Komponenten durch »y« ersetzt. (2) myhostname wird, falls die Variable noch nicht die Anforderungen an einen voll-qualifizierten Domainnamen (FQDN) erfüllt, in eine solche überführt.
";
...
";
$elem["postfix/lmtp_retired_warning"]["descriptionde"]="Die Datei master.cf für ein lmtp/smtp-Kompilat aktualisieren?
 Mit diesem Upgrade entfällt der symbolische Verweis für lmtp. Er ist jedoch noch in Ihrer Konfigurationsdatei master.cf enthalten. Das Protokoll lmtp ist schon seit langem in smtp aufgegangen. Die Installation wird abgebrochen, falls Sie der Änderung nicht zustimmen.
";
...
$elem["postfix/main_cf_conversion_warning"]["descriptionde"]="main.cf für eine Änderung von daemon_directory aktualisieren?
 Dieses Upgrade von Postfix ändert den Speicherort der Daemons. Ihre Postfix-Konfiguration spezifiziert explizit den alten Ort. Die Installation wird abbrechen, falls Sie der Änderung nicht zustimmen.
";
...
$elem["postfix/dynamicmaps_conversion_warning"]["descriptionde"]="dynamicmaps.cf für 3.0 aktualisieren?
 Postfix Version 3.0 ändert die Auslieferung dynamischer Tabellen, jedoch wird dies durch Ihre dynamicmaps.cf nicht berücksichtigt. Akzeptieren Sie diese Option, um dynamicmaps.cf in die für 3.0 benötigte Version zu konvertieren.
";
...
$elem["postfix/sqlite_warning"]["descriptionde"]="»sqlite«-Eintrag zu dynamicmaps.cf hinzufügen?
 Postfix Version 2.9 fügt die Unterstützung von Sqlite zu Tabellen hinzu, aber dies wird in Ihrer dynamicmaps.cf nicht berücksichtigt. Akzeptieren Sie diese Option, um Unterstützung für Sqlite-Tabellen hinzuzufügen.
";
...
$elem["postfix/kernel_version_warning"]["descriptionde"]="Postfix trotz eines nicht-unterstützten Kernels installieren?
 Postfix verwendet Funktionen, die in Kernel-Versionen vor 2.6 nicht vorhanden sind. Falls Sie mit der Installation fortfahren, wird Postfix nicht funktionieren.
";
...
$elem["postfix/mailbox_limit"]["descriptionde"]="Maximale Postfach-Größe in Bytes:
 Bitte geben Sie eine Grenze für die Größe von Postfachdateien an, die Postfix zur Vermeidung von Softwarefehlern einhalten soll. Null (0) bedeutet: keine Grenze. Der Postfix-Standard der Originalautoren beträgt 51200000.
";
...
$elem["postfix/root_address"]["descriptionde"]="Empfänger von E-Mails an Root und Postmaster:
 ...
 .
 Falls Sie bereits eine /etc/aliases-Datei haben und diese über keinen Eintrag für »root« verfügt, dann sollten Sie diesen Eintrag hinzufügen. Lassen Sie dies leer, um keinen hinzuzufügen.
";
...
";
$elem["postfix/newaliases"]["descriptionde"]="";
$elem["postfix/newaliases"]["descriptionfr"]="";
