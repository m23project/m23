...
$params = PKG_OptionPageHeader2("igtf-policy-classic");

$elem["igtf-policy-classic/install_profile"]["type"]="boolean";
$elem["igtf-policy-classic/install_profile"]["description"]="Trust IGTF classic CAs by default?
...
";
$elem["igtf-policy-classic/install_profile"]["descriptionde"]="Als Voreinstellung den IGTF-classic-CAs vertrauen?
...
";
$elem["igtf-policy-classic/install_profile"]["descriptionfr"]="Faut-il toujours faire confiance aux certificats d'autorités IGTF classic ?
...
";
$elem["igtf-policy-classic/install_profile"]["default"]="true";
$elem["igtf-policy-classic/exclude_ca"]["type"]="multiselect";
$elem["igtf-policy-classic/exclude_ca"]["description"]="Certificates to explicitly exclude:
 Please select which certificates should not be installed in
 ${location}.
";
$elem["igtf-policy-classic/exclude_ca"]["descriptionde"]="Zertifikate, die ausdrücklich ausgeschlossen werden sollen:
 Bitte wählen Sie die Zertifikate aus, die nicht in ${location} installiert werden sollen.
";
$elem["igtf-policy-classic/exclude_ca"]["descriptionfr"]="Certificats à exclure explicitement :
 Veuillez choisir quels certificats ne doivent pas être installés dans ${location}.
";
$elem["igtf-policy-classic/exclude_ca"]["default"]="";
$elem["igtf-policy-classic/include_ca"]["type"]="multiselect";
$elem["igtf-policy-classic/include_ca"]["description"]="Certificates to explicitly include:
 Please select which certificates should be installed in
 ${location}.
";
$elem["igtf-policy-classic/include_ca"]["descriptionde"]="Zertifikate, die ausdrücklich berücksichtigt werden sollen:
 Bitte wählen Sie die Zertifikate aus, die in ${location} installiert werden sollen.
";
$elem["igtf-policy-classic/include_ca"]["descriptionfr"]="Certificats à inclure explicitement :
 Veuillez choisir quels certificats doivent être installés dans ${location}.
";
$elem["igtf-policy-classic/include_ca"]["default"]="";
