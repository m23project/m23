...
$params = PKG_OptionPageHeader2("ganeti-2.16");

$elem["ganeti-2.16/abort-removal"]["type"]="boolean";
$elem["ganeti-2.16/abort-removal"]["description"]="Abort ${package} removal?
 ...
 removing ${package}.
";
$elem["ganeti-2.16/abort-removal"]["descriptionde"]="Entfernen von ${package} abbrechen?
...
";
$elem["ganeti-2.16/abort-removal"]["descriptionfr"]="Faut-il abandonner la suppression de ${package} ?
...
";
$elem["ganeti-2.16/abort-removal"]["default"]="true";
