...
$params = PKG_OptionPageHeader2("ganeti-haskell-2.16");

$elem["ganeti-haskell-2.16/abort-removal"]["type"]="boolean";
$elem["ganeti-haskell-2.16/abort-removal"]["description"]="Abort ${package} removal?
 ...
 removing ${package}.
";
$elem["ganeti-haskell-2.16/abort-removal"]["descriptionde"]="Entfernen von ${package} abbrechen?
...
";
$elem["ganeti-haskell-2.16/abort-removal"]["descriptionfr"]="Faut-il abandonner la suppression de ${package} ?
...
";
$elem["ganeti-haskell-2.16/abort-removal"]["default"]="true";
