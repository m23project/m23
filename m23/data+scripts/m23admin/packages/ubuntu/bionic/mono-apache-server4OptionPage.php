...
";
$elem["monoserver4/monoserver2_upgrade_warning"]["descriptionfr"]="Prise en charge d'ASP.NET 2.0 supprimée
 Certains sites ASP.NET 2.0 semblent configurés dans /etc/mono-server. La prise en charge du profil 1.0 a été supprimée de Mono depuis la version 4.0, et les sites ASP.NET 2.0 ne peuvent plus être servis. XSP doit être reconfiguré pour servir ces sites en utilisant le profil 4.0, si les applications sont compatibles. Veuillez consulter mono-server4-admin(8) pour une explication sur la façon de remettre en place une configuration utilisable avec le profil 4.0.
";
