...
";
$elem["glare/configure_db"]["descriptionfr"]="Voulez-vous installer une base de données pour Glare ?
 Aucune base de données n’est configurée que Glare puisse utiliser. Avant de continuer, assurez-vous de disposer des informations suivantes :
 .
 ...
 .
 Si certains de ces prérequis sont manquants, ignorez cette option et exécutez l'application avec la prise en charge de SQLite standard.
 .
...
";
$elem["glare/auth-host"]["descriptionfr"]="Nom d'hôte du serveur d'authentification :
 Veuillez indiquer le nom d'hôte de votre serveur d'authentification. En général, c'est également le nom d'hôte de votre Service d'Identité d'OpenStack (Keystone).
";
...
";
$elem["glare/admin-tenant-name"]["descriptionfr"]="Nom du projet (« tenant ») sur le serveur d'authentification :
 Veuillez indiquer le nom du projet (« tenant ») sur le serveur d’authentification.
";
...
";
$elem["glare/admin-user"]["descriptionfr"]="Nom d'utilisateur pour le serveur d'authentification :
...
";
$elem["glare/admin-password"]["descriptionfr"]="Mot de passe pour le serveur d'authentification :
