...
$elem["strongswan/charon"]["type"]="boolean";
$elem["strongswan/charon"]["description"]="Start strongSwan's charon daemon?
 The charon daemon must be running to support the Internet Key
 Exchange protocol.
";
$elem["strongswan/charon"]["descriptionde"]="strongSwans Charon-Daemon starten?
 Der Charon-Daemon muss laufen, um das Internet-Key-Exchange-Protokoll zu unterstützen.
";
$elem["strongswan/charon"]["descriptionfr"]="Faut-il démarrer le démon charon de StrongSwan ?
 Le démon « charon » doit fonctionner pour que le protocole IKE (Internet Key Exchange) puisse être géré.
";
$elem["strongswan/charon"]["default"]="true";
