...
$params = PKG_OptionPageHeader2("libvpb1");

$elem["libvpb1/countrycode"]["type"]="string";
$elem["libvpb1/countrycode"]["description"]="ITU-T telephone code:
...
";
$elem["libvpb1/countrycode"]["descriptionde"]="ITU-T-Telefon-Code:
...
";
$elem["libvpb1/countrycode"]["descriptionfr"]="Préfixe de numérotation internationale UIT-T :
...
";
$elem["libvpb1/countrycode"]["default"]="61";
