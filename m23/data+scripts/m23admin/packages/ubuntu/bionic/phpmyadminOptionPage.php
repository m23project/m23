...
$elem["phpmyadmin/setup-username"]["descriptionde"]="Benutzername für die webbasierte Installation:
 Nach der Installation kann das Einrichtungssystem von phpMyAdmin unter http://localhost/phpmyadmin/setup/index.php verwendet werden.
 .
...
$elem["phpmyadmin/setup-username"]["descriptionfr"]="Identifiant pour la configuration par le Web :
 Le système de configuration de phpMyAdmin peut être utilisé, après l'installation, depuis l'adresse http://localhost/phpmyadmin/setup/index.php.
 .
 L'accès à la configuration nécessite un identifiant et un mot de passe.
 .
 Si ce champ est laissé vide, l'identifiant par défaut (« admin ») sera utilisé.
";
...
$elem["phpmyadmin/setup-password"]["descriptionfr"]="Mot de passe pour la configuration par le Web :
 ...
 L'accès à la configuration nécessite un identifiant et un mot de passe.
 .
 Les identifiants et mots de passe peuvent être gérés avec la commande « htpasswd » et sont stockés dans le fichier /etc/phpmyadmin/htpasswd.setup.
 .
