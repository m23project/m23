...
$elem["libnss-ldapd/nsswitch"]["choices"][1]="passwd";
$elem["libnss-ldapd/nsswitch"]["choices"][2]="group";
$elem["libnss-ldapd/nsswitch"]["choices"][3]="shadow";
$elem["libnss-ldapd/nsswitch"]["choices"][4]="hosts";
$elem["libnss-ldapd/nsswitch"]["choices"][5]="networks";
$elem["libnss-ldapd/nsswitch"]["choices"][6]="ethers";
$elem["libnss-ldapd/nsswitch"]["choices"][7]="protocols";
$elem["libnss-ldapd/nsswitch"]["choices"][8]="services";
$elem["libnss-ldapd/nsswitch"]["choices"][9]="rpc";
$elem["libnss-ldapd/nsswitch"]["choices"][10]="netgroup";
...
$elem["libnss-ldapd/nsswitch"]["descriptionde"]="Namensauflösungsdienste, die eingerichtet werden sollen:
 Damit dieses Paket funktioniert, müssen Sie Ihre Datei /etc/nsswitch.conf so verändern, dass die LDAP-Datenquelle verwendet wird.
 .
...
$elem["libnss-ldapd/nsswitch"]["descriptionfr"]="Services de nom à configurer :
 Le fichier /etc/nsswitch.conf doit être modifié (afin d'utiliser la source de données « ldap ») pour rendre ce paquet fonctionnel.
 .
...
$elem["libnss-ldapd/clean_nsswitch"]["descriptionfr"]="Faut-il supprimer LDAP de nsswitch.conf maintenant ?
 ...
 .
 Il est conseillé de supprimer les entrées si vous pensez ne plus utiliser LDAP pour la résolution de noms. Il est probable qu'omettre de supprimer LDAP dans nsswitch.conf soit sans conséquences pour la plupart des services, mais la résolution de noms peut être affectée de manière subtile.
 .
