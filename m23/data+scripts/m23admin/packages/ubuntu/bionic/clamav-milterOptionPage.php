...
";
$elem["clamav-milter/FixStaleSocket"]["descriptionde"]="Übrig gebliebenen Socket nach unsauberem Abschalten entfernen?
";
$elem["clamav-milter/FixStaleSocket"]["descriptionfr"]="Faut-il supprimer la « socket » résiduelle après un arrêt brutal ?
";
...
";
$elem["clamav-milter/MilterSocketMode"]["descriptionde"]="Erzeugungsmodus für den lokalen Clamav-Milter-(UNIX)-Socket:
";
...
";
$elem["clamav-milter/User"]["descriptionde"]="Benutzername, unter dem Clamav-Milter laufen soll:
...
";
$elem["clamav-milter/TemporaryDirectory"]["descriptionde"]="Temporärer Verzeichnispfad:
...
$elem["clamav-milter/LogClean"]["description"]="Information to log if no threat is found:
 ...
 increases the log size):
  ...
  - Full : verbose information.
";
$elem["clamav-milter/LogClean"]["descriptionde"]="Informationen, die protokolliert werden, falls keine Gefahr erkannt wurde:
...
$elem["clamav-milter/SupportMultipleRecipients"]["type"]="boolean";
$elem["clamav-milter/SupportMultipleRecipients"]["description"]="Do you want clamav-milter to support multiple recipients?
...
";
$elem["clamav-milter/SupportMultipleRecipients"]["descriptionde"]="Wollen Sie, dass clamav-milter mehrere Empfänger unterstützt?
...
";
$elem["clamav-milter/SupportMultipleRecipients"]["descriptionfr"]="Voulez-vous que clamav-milter gère plusieurs destinataires ?
...
";
$elem["clamav-milter/SupportMultipleRecipients"]["default"]="false";
$elem["clamav-milter/LogRotate"]["type"]="boolean";
$elem["clamav-milter/LogRotate"]["description"]="Do you want to enable log rotation?
";
$elem["clamav-milter/LogRotate"]["descriptionde"]="Soll das Rotieren der Protokolldateien aktiviert werden?
";
$elem["clamav-milter/LogRotate"]["descriptionfr"]="Souhaitez-vous activer la rotation des journaux ?
";
$elem["clamav-milter/LogRotate"]["default"]="true";
