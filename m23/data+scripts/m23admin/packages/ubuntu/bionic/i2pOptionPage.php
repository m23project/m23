...
";
$elem["i2p/daemon"]["descriptionfr"]="Lancer le routeur I2P au démarrage ?
 Le routeur I2P peut être exécuté comme un démon automatiquement quand l’ordinateur démarre. C'est la configuration recommandée.
";
...
";
$elem["i2p/user"]["descriptionfr"]="Utilisateur du démon d’I2P :
