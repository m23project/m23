...
";
$elem["clamav-freshclam/autoupdate_freshclam"]["descriptionde"]="Aktualisierungsmethode für die Virus-Datenbank:
 Bitte wählen Sie die Methode für Aktualisierungen der Virus-Datenbank.
 .
...
$elem["clamav-freshclam/local_mirror"]["choices"][248]="db.zw.clamav.net (Zimbabwe)";
$elem["clamav-freshclam/local_mirror"]["description"]="Local database mirror site:
 ...
 nearby mirror.
";
$elem["clamav-freshclam/local_mirror"]["descriptionde"]="Lokaler Datenbank-Spiegel-Server:
 Bitte wählen Sie den nächsten lokalen Spiegel-Server.
 .
...
";
$elem["clamav-freshclam/http_proxy"]["descriptionde"]="HTTP-Proxy-Informationen (leer lassen für keinen):
 Falls Sie einen HTTP-Proxy benutzen müssen, um Zugang zur Außenwelt zu erlangen, geben Sie hier die Daten dazu ein. Anderenfalls lassen Sie das Feld leer.
 .
...
$elem["clamav-freshclam/proxy_user"]["description"]="Proxy user information (leave blank for none):
 ...
 \"user:pass\".
";
$elem["clamav-freshclam/proxy_user"]["descriptionde"]="Proxy-Benutzerdaten (leer lassen für keine):
 Falls Sie für den Proxy einen Benutzernamen und ein Passwort benötigen, geben Sie diese hier ein. Anderenfalls lassen Sie das Feld leer.
 .
...
$elem["clamav-freshclam/internet_interface"]["descriptionde"]="Netzwerkschnittstelle, die mit dem Internet verbunden ist:
 Bitte geben Sie den Namen der Netzwerkschnittstelle ein, welche mit dem Internet verbunden ist. Beispiel: eth0.
 .
...
$elem["clamav-freshclam/NotifyClamd"]["descriptionde"]="Soll Clamd nach Aktualisierungen benachrichtigt werden?
 Bitte bestätigen Sie, ob Clamd nach erfolgreichen Aktualisierungen die Datenbank neu laden soll.
 .
...
$elem["clamav-freshclam/SafeBrowsing"]["type"]="boolean";
$elem["clamav-freshclam/SafeBrowsing"]["description"]="Do you want to enable support for Google Safe Browsing?
