...
";
$elem["glare/register-endpoint"]["descriptionfr"]="Voulez-vous enregistrer Glare dans le catalogue de points d'accès Keystone ?
 Chaque service d'OpenStack (chaque API) doit être enregistré pour être accessible. Cela peut être fait en utilisant « keystone service-create » et « keystone endpoint-create ». Cela peut être fait automatiquement maintenant.
 .
...
";
$elem["glare/keystone-ip"]["descriptionfr"]="Adresse IP du serveur Keystone :
 Veuillez indiquer l'adresse IP du serveur Keystone, pour que l'API de Glare puisse contacter Keystone pour établir le service Glare et créer un point d'accès.
";
...
$elem["glare/keystone-admin-name"]["descriptionfr"]="Nom de l'administrateur Keystone :
 Pour enregistrer le service de point d'accès, ce paquet a besoin de connaître le nom de connexion de l'administrateur, son nom, le nom du projet, ainsi que le mot de passe du serveur Keystone.
";
...
$elem["glare/keystone-project-name"]["descriptionfr"]="Nom du projet administrateur Keystone :
 Pour enregistrer le service de point d'accès, ce paquet a besoin de connaître le nom de connexion de l'administrateur, son nom, le nom du projet, ainsi que le mot de passe du serveur Keystone.
";
...
$elem["glare/keystone-admin-password"]["descriptionfr"]="Mot de passe administrateur Keystone :
 Pour enregistrer le service de point d'accès, ce paquet a besoin de connaître le nom de connexion de l'administrateur, son nom, le nom du projet, ainsi que le mot de passe du serveur Keystone.
";
...
";
$elem["glare/endpoint-ip"]["descriptionfr"]="Adresse IP du point d'accès Glare :
